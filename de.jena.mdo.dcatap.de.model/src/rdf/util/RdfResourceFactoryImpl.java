...
public class RdfResourceFactoryImpl extends ResourceFactoryImpl {
	...
	public Map<String, Object> getServiceProperties() {
		...
		properties.put(EMFNamespaces.EMF_RESOURCE_CONFIGURATOR_NAME, RdfPackage.eNAME);
		properties.put(EMFNamespaces.EMF_RESOURCE_CONFIGURATOR_FILE_EXT, "rdf");
		properties.put(EMFNamespaces.EMF_RESOURCE_CONFIGURATOR_CONTENT_TYPE, "dcat.rdf");
