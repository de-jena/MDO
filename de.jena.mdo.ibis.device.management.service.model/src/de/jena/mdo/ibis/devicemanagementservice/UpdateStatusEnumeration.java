...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Update Status Enumeration</b></em>',
 ...
 */
@ProviderType
public enum UpdateStatusEnumeration implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Update Status Enumeration</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final UpdateStatusEnumeration[] VALUES_ARRAY =
		new UpdateStatusEnumeration[] {
			UPDATE_RUNNING,
	...
	/**
	 * A public read-only list of all the '<em><b>Update Status Enumeration</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<UpdateStatusEnumeration> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Update Status Enumeration</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static UpdateStatusEnumeration get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			UpdateStatusEnumeration result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Update Status Enumeration</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static UpdateStatusEnumeration getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			UpdateStatusEnumeration result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Update Status Enumeration</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static UpdateStatusEnumeration get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private UpdateStatusEnumeration(int value, String name, String literal) {
		this.value = value;
		this.name = name;
