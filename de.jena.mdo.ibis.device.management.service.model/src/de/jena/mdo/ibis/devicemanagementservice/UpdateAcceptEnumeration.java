...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Update Accept Enumeration</b></em>',
 ...
 */
@ProviderType
public enum UpdateAcceptEnumeration implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Update Accept Enumeration</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final UpdateAcceptEnumeration[] VALUES_ARRAY =
		new UpdateAcceptEnumeration[] {
			UPDATE_ACCEPTED,
			URL_TYPE_UNKNOWN,
			NO_UPDATES_ALLOWED,
			TO_BE_POSTPONED,
	...
	/**
	 * A public read-only list of all the '<em><b>Update Accept Enumeration</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<UpdateAcceptEnumeration> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Update Accept Enumeration</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static UpdateAcceptEnumeration get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			UpdateAcceptEnumeration result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Update Accept Enumeration</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static UpdateAcceptEnumeration getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			UpdateAcceptEnumeration result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Update Accept Enumeration</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static UpdateAcceptEnumeration get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private UpdateAcceptEnumeration(int value, String name, String literal) {
		this.value = value;
		this.name = name;
