...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Finalize Update Response</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.jena.mdo.ibis.ibis_devicemanagementservice.impl.FinalizeUpdateResponseImpl#getUpdateStatus <em>Update Status</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FinalizeUpdateResponseImpl extends GeneralResponseImpl implements FinalizeUpdateResponse {
	 ...
	 * @generated
	 */
	protected FinalizeUpdateResponseImpl() {
		super();
	}
	...
	public void setUpdateStatus(UpdateStatusType newUpdateStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisDeviceManagementServicePackage.FINALIZE_UPDATE_RESPONSE__UPDATE_STATUS, oldUpdateStatus, updateStatus, !oldUpdateStatusESet));
	}
	...
	public void unsetUpdateStatus() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, IbisDeviceManagementServicePackage.FINALIZE_UPDATE_RESPONSE__UPDATE_STATUS, oldUpdateStatus, UPDATE_STATUS_EDEFAULT, oldUpdateStatusESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IbisDeviceManagementServicePackage.FINALIZE_UPDATE_RESPONSE__UPDATE_STATUS:
