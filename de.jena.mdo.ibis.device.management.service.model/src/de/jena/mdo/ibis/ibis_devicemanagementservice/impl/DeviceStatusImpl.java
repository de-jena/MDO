 ...
 * </p>
 * <ul>
 *   <li>{@link de.jena.mdo.ibis.ibis_devicemanagementservice.impl.DeviceStatusImpl#getDeviceStatusName <em>Device Status Name</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_devicemanagementservice.impl.DeviceStatusImpl#getDeviceStatusFlag <em>Device Status Flag</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_devicemanagementservice.impl.DeviceStatusImpl#getDeviceStatusImpact <em>Device Status Impact</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_devicemanagementservice.impl.DeviceStatusImpl#getDeviceStatusPriority <em>Device Status Priority</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DeviceStatusImpl extends MinimalEObjectImpl.Container implements DeviceStatus {
	...
	public NotificationChain basicSetDeviceStatusName(IBISIPString newDeviceStatusName, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisDeviceManagementServicePackage.DEVICE_STATUS__DEVICE_STATUS_NAME, oldDeviceStatusName, newDeviceStatusName);
	...
	public void setDeviceStatusName(IBISIPString newDeviceStatusName) {
		if (newDeviceStatusName != deviceStatusName) {
			...
			if (deviceStatusName != null)
				msgs = ((InternalEObject)deviceStatusName).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisDeviceManagementServicePackage.DEVICE_STATUS__DEVICE_STATUS_NAME, null, msgs);
			if (newDeviceStatusName != null)
				msgs = ((InternalEObject)newDeviceStatusName).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisDeviceManagementServicePackage.DEVICE_STATUS__DEVICE_STATUS_NAME, null, msgs);
			msgs = basicSetDeviceStatusName(newDeviceStatusName, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisDeviceManagementServicePackage.DEVICE_STATUS__DEVICE_STATUS_NAME, newDeviceStatusName, newDeviceStatusName));
	}
	...
	public NotificationChain basicSetDeviceStatusFlag(IBISIPBoolean newDeviceStatusFlag, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisDeviceManagementServicePackage.DEVICE_STATUS__DEVICE_STATUS_FLAG, oldDeviceStatusFlag, newDeviceStatusFlag);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setDeviceStatusFlag(IBISIPBoolean newDeviceStatusFlag) {
		if (newDeviceStatusFlag != deviceStatusFlag) {
			...
			if (deviceStatusFlag != null)
				msgs = ((InternalEObject)deviceStatusFlag).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisDeviceManagementServicePackage.DEVICE_STATUS__DEVICE_STATUS_FLAG, null, msgs);
			if (newDeviceStatusFlag != null)
				msgs = ((InternalEObject)newDeviceStatusFlag).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisDeviceManagementServicePackage.DEVICE_STATUS__DEVICE_STATUS_FLAG, null, msgs);
			msgs = basicSetDeviceStatusFlag(newDeviceStatusFlag, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisDeviceManagementServicePackage.DEVICE_STATUS__DEVICE_STATUS_FLAG, newDeviceStatusFlag, newDeviceStatusFlag));
	}
	...
	public void setDeviceStatusImpact(DeviceStateEnumeration newDeviceStatusImpact) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisDeviceManagementServicePackage.DEVICE_STATUS__DEVICE_STATUS_IMPACT, oldDeviceStatusImpact, deviceStatusImpact, !oldDeviceStatusImpactESet));
	}
	...
	public void unsetDeviceStatusImpact() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, IbisDeviceManagementServicePackage.DEVICE_STATUS__DEVICE_STATUS_IMPACT, oldDeviceStatusImpact, DEVICE_STATUS_IMPACT_EDEFAULT, oldDeviceStatusImpactESet));
	}
	...
	public NotificationChain basicSetDeviceStatusPriority(IBISIPInt newDeviceStatusPriority, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisDeviceManagementServicePackage.DEVICE_STATUS__DEVICE_STATUS_PRIORITY, oldDeviceStatusPriority, newDeviceStatusPriority);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setDeviceStatusPriority(IBISIPInt newDeviceStatusPriority) {
		if (newDeviceStatusPriority != deviceStatusPriority) {
			...
			if (deviceStatusPriority != null)
				msgs = ((InternalEObject)deviceStatusPriority).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisDeviceManagementServicePackage.DEVICE_STATUS__DEVICE_STATUS_PRIORITY, null, msgs);
			if (newDeviceStatusPriority != null)
				msgs = ((InternalEObject)newDeviceStatusPriority).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisDeviceManagementServicePackage.DEVICE_STATUS__DEVICE_STATUS_PRIORITY, null, msgs);
			msgs = basicSetDeviceStatusPriority(newDeviceStatusPriority, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisDeviceManagementServicePackage.DEVICE_STATUS__DEVICE_STATUS_PRIORITY, newDeviceStatusPriority, newDeviceStatusPriority));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case IbisDeviceManagementServicePackage.DEVICE_STATUS__DEVICE_STATUS_NAME:
				return basicSetDeviceStatusName(null, msgs);
			case IbisDeviceManagementServicePackage.DEVICE_STATUS__DEVICE_STATUS_FLAG:
				return basicSetDeviceStatusFlag(null, msgs);
			case IbisDeviceManagementServicePackage.DEVICE_STATUS__DEVICE_STATUS_PRIORITY:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case IbisDeviceManagementServicePackage.DEVICE_STATUS__DEVICE_STATUS_IMPACT:
