...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Update State Data</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.jena.mdo.ibis.ibis_devicemanagementservice.impl.UpdateStateDataImpl#getUpdateID <em>Update ID</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_devicemanagementservice.impl.UpdateStateDataImpl#getUpdateTimestamp <em>Update Timestamp</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_devicemanagementservice.impl.UpdateStateDataImpl#getUpdateStatus <em>Update Status</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_devicemanagementservice.impl.UpdateStateDataImpl#getUpdateDetails <em>Update Details</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UpdateStateDataImpl extends MinimalEObjectImpl.Container implements UpdateStateData {
	/**
	...
	protected EClass eStaticClass() {
		return IbisDeviceManagementServicePackage.Literals.UPDATE_STATE_DATA;
	}
	...
	public NotificationChain basicSetUpdateID(IBISIPNMTOKEN newUpdateID, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisDeviceManagementServicePackage.UPDATE_STATE_DATA__UPDATE_ID, oldUpdateID, newUpdateID);
	...
	public void setUpdateID(IBISIPNMTOKEN newUpdateID) {
		if (newUpdateID != updateID) {
			...
			if (updateID != null)
				msgs = ((InternalEObject)updateID).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisDeviceManagementServicePackage.UPDATE_STATE_DATA__UPDATE_ID, null, msgs);
			if (newUpdateID != null)
				msgs = ((InternalEObject)newUpdateID).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisDeviceManagementServicePackage.UPDATE_STATE_DATA__UPDATE_ID, null, msgs);
			msgs = basicSetUpdateID(newUpdateID, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisDeviceManagementServicePackage.UPDATE_STATE_DATA__UPDATE_ID, newUpdateID, newUpdateID));
	}
	...
	public NotificationChain basicSetUpdateTimestamp(IBISIPDateTime newUpdateTimestamp, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisDeviceManagementServicePackage.UPDATE_STATE_DATA__UPDATE_TIMESTAMP, oldUpdateTimestamp, newUpdateTimestamp);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setUpdateTimestamp(IBISIPDateTime newUpdateTimestamp) {
		if (newUpdateTimestamp != updateTimestamp) {
			...
			if (updateTimestamp != null)
				msgs = ((InternalEObject)updateTimestamp).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisDeviceManagementServicePackage.UPDATE_STATE_DATA__UPDATE_TIMESTAMP, null, msgs);
			if (newUpdateTimestamp != null)
				msgs = ((InternalEObject)newUpdateTimestamp).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisDeviceManagementServicePackage.UPDATE_STATE_DATA__UPDATE_TIMESTAMP, null, msgs);
			msgs = basicSetUpdateTimestamp(newUpdateTimestamp, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisDeviceManagementServicePackage.UPDATE_STATE_DATA__UPDATE_TIMESTAMP, newUpdateTimestamp, newUpdateTimestamp));
	}
	...
	public void setUpdateStatus(UpdateStatusType newUpdateStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisDeviceManagementServicePackage.UPDATE_STATE_DATA__UPDATE_STATUS, oldUpdateStatus, updateStatus, !oldUpdateStatusESet));
	}
	...
	public void unsetUpdateStatus() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, IbisDeviceManagementServicePackage.UPDATE_STATE_DATA__UPDATE_STATUS, oldUpdateStatus, UPDATE_STATUS_EDEFAULT, oldUpdateStatusESet));
	}
	...
	public NotificationChain basicSetUpdateDetails(IBISIPString newUpdateDetails, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisDeviceManagementServicePackage.UPDATE_STATE_DATA__UPDATE_DETAILS, oldUpdateDetails, newUpdateDetails);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setUpdateDetails(IBISIPString newUpdateDetails) {
		if (newUpdateDetails != updateDetails) {
			...
			if (updateDetails != null)
				msgs = ((InternalEObject)updateDetails).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisDeviceManagementServicePackage.UPDATE_STATE_DATA__UPDATE_DETAILS, null, msgs);
			if (newUpdateDetails != null)
				msgs = ((InternalEObject)newUpdateDetails).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisDeviceManagementServicePackage.UPDATE_STATE_DATA__UPDATE_DETAILS, null, msgs);
			msgs = basicSetUpdateDetails(newUpdateDetails, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisDeviceManagementServicePackage.UPDATE_STATE_DATA__UPDATE_DETAILS, newUpdateDetails, newUpdateDetails));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case IbisDeviceManagementServicePackage.UPDATE_STATE_DATA__UPDATE_ID:
				return basicSetUpdateID(null, msgs);
			case IbisDeviceManagementServicePackage.UPDATE_STATE_DATA__UPDATE_TIMESTAMP:
				return basicSetUpdateTimestamp(null, msgs);
			case IbisDeviceManagementServicePackage.UPDATE_STATE_DATA__UPDATE_DETAILS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case IbisDeviceManagementServicePackage.UPDATE_STATE_DATA__UPDATE_STATUS:
