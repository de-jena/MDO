...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Update State Data</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 ...
 * </p>
 * <ul>
 *   <li>{@link de.jena.mdo.ibis.ibis_devicemanagementservice.UpdateStateData#getUpdateID <em>Update ID</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_devicemanagementservice.UpdateStateData#getUpdateTimestamp <em>Update Timestamp</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_devicemanagementservice.UpdateStateData#getUpdateStatus <em>Update Status</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_devicemanagementservice.UpdateStateData#getUpdateDetails <em>Update Details</em>}</li>
 * </ul>
 *
 * @see de.jena.mdo.ibis.ibis_devicemanagementservice.IbisDeviceManagementServicePackage#getUpdateStateData()
 * @model extendedMetaData="name='DeviceManagementService.UpdateStateDataStructure' kind='elementOnly'"
 * @generated
 */
@ProviderType
public interface UpdateStateData extends EObject {
	/**
	 ...
	 * @see de.jena.mdo.ibis.ibis_devicemanagementservice.IbisDeviceManagementServicePackage#getUpdateStateData_UpdateID()
	...
	/**
	 * Sets the value of the '{@link de.jena.mdo.ibis.ibis_devicemanagementservice.UpdateStateData#getUpdateID <em>Update ID</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.jena.mdo.ibis.ibis_devicemanagementservice.IbisDeviceManagementServicePackage#getUpdateStateData_UpdateTimestamp()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link de.jena.mdo.ibis.ibis_devicemanagementservice.UpdateStateData#getUpdateTimestamp <em>Update Timestamp</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.jena.mdo.ibis.ibis_devicemanagementservice.IbisDeviceManagementServicePackage#getUpdateStateData_UpdateStatus()
	...
	/**
	 * Sets the value of the '{@link de.jena.mdo.ibis.ibis_devicemanagementservice.UpdateStateData#getUpdateStatus <em>Update Status</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link de.jena.mdo.ibis.ibis_devicemanagementservice.UpdateStateData#getUpdateStatus <em>Update Status</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetUpdateStatus()
	 * @see #getUpdateStatus()
	...
	/**
	 * Returns whether the value of the '{@link de.jena.mdo.ibis.ibis_devicemanagementservice.UpdateStateData#getUpdateStatus <em>Update Status</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.jena.mdo.ibis.ibis_devicemanagementservice.IbisDeviceManagementServicePackage#getUpdateStateData_UpdateDetails()
	...
	/**
	 * Sets the value of the '{@link de.jena.mdo.ibis.ibis_devicemanagementservice.UpdateStateData#getUpdateDetails <em>Update Details</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
