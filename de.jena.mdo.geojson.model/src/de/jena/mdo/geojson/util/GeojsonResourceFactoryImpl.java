...
public class GeojsonResourceFactoryImpl extends ResourceFactoryImpl {
	...
	public Map<String, Object> getServiceProperties() {
		...
		properties.put(EMFNamespaces.EMF_RESOURCE_CONFIGURATOR_NAME, GeojsonPackage.eNAME);
		properties.put(EMFNamespaces.EMF_RESOURCE_CONFIGURATOR_FILE_EXT, "geojson");
