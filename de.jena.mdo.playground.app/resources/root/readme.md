...
2. 
![installer_step1](eclipse/images/installer_step1.png)
3. 
![installer_step2](eclipse/images/installer_step2.png)
Sollte die Frage `Installer in permanenter Location halten?` kommen, bitte ja anklicken.
4. Den Anweisungen zur Installation des Installers folgen.
5. 
![installer_step3](eclipse/images/installer_step3.png) 
Auf das kleine `+`klicken
6. 
![installer_step4](eclipse/images/installer_step4.png)
Brows File System wählen und `<Installationsordner der App>\eclipse\MDP-Playground.setup` auswählen.
...
10. Installation mit finish starten. Bei der Erstinstallation kommen verschiedene Fenster bei denen gefragt wird, ob man Lizenzen akzeptiert  und quellen vertraut. Diese Rückfragen alle bestätigen.
11. Die IDE sollte automatisch starten, alternativ zum gewählten Installationsordner navigieren und die eclipse.exe starten.
12. 
![workspace](eclipse/images/workspace.png) 
Beim ersten Start der IDE fragt Eclipse nach einem Workspace. Hier zu `<Installationsordner der App>\workspace` navigieren. 
13. 
![error](eclipse/images/error.png)
...
14. 
![workspace2](eclipse/images/workspace2.png) 
Im cnf Projekt die Datei `targetplattform.target` per Doppelklick öffnen.
15.
![workspace3](eclipse/images/workspace3.png)
 `Set as Active Target Platform` anklicken. Der link in dem Editor ändert sich damit zu `Reload Target Platform`. 
16. Anschließend im Projekt `de.jena.models` `resources\example1\models\ProductMappings.xmi` öffnen und überprüfen, dass keine Fehlermeldung angezeigt wird. ![workspace4](eclipse/images/workspace4.png)
...
Im Browser http://localhost:8088/mdo/playground/rest/product/Product?mediaType=application/json aufrufen und überprüfen ob json Daten zurück kommen. Evtl. kann die Firewall den Zugriff blocken bzw. nachfragen ob man Java Vertrauen darf.
