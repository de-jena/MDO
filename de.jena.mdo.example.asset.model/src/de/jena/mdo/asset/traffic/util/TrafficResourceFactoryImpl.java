...
public class TrafficResourceFactoryImpl extends ResourceFactoryImpl {
	...
	public Map<String, Object> getServiceProperties() {
		...
		properties.put(EMFNamespaces.EMF_RESOURCE_CONFIGURATOR_NAME, TrafficPackage.eNAME);
		properties.put(EMFNamespaces.EMF_RESOURCE_CONFIGURATOR_FILE_EXT, "traffic");
