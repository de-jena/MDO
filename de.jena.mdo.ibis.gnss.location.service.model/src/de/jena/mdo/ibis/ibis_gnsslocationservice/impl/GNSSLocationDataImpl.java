...
import de.jena.mdo.ibis.ibis_enumerations.GNSSCoordinateSystemEnumeration;
import de.jena.mdo.ibis.ibis_enumerations.GNSSQualityEnumeration;
import de.jena.mdo.ibis.ibis_enumerations.GNSSTypeEnumeration;
 ...
 * </p>
 * <ul>
 *   <li>{@link de.jena.mdo.ibis.ibis_gnsslocationservice.impl.GNSSLocationDataImpl#getLatitude <em>Latitude</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_gnsslocationservice.impl.GNSSLocationDataImpl#getLongitude <em>Longitude</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_gnsslocationservice.impl.GNSSLocationDataImpl#getAltitude <em>Altitude</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_gnsslocationservice.impl.GNSSLocationDataImpl#getTime <em>Time</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_gnsslocationservice.impl.GNSSLocationDataImpl#getDate <em>Date</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_gnsslocationservice.impl.GNSSLocationDataImpl#getSpeedOverGround <em>Speed Over Ground</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_gnsslocationservice.impl.GNSSLocationDataImpl#getSignalQuality <em>Signal Quality</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_gnsslocationservice.impl.GNSSLocationDataImpl#getNumberOfSatellites <em>Number Of Satellites</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_gnsslocationservice.impl.GNSSLocationDataImpl#getHoriziontalDilutionOfPrecision <em>Horiziontal Dilution Of Precision</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_gnsslocationservice.impl.GNSSLocationDataImpl#getVerticalDilutionOfPrecision <em>Vertical Dilution Of Precision</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_gnsslocationservice.impl.GNSSLocationDataImpl#getTrackDegreeTrue <em>Track Degree True</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_gnsslocationservice.impl.GNSSLocationDataImpl#getTrackDegreeMagnetic <em>Track Degree Magnetic</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_gnsslocationservice.impl.GNSSLocationDataImpl#getGNSSType <em>GNSS Type</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_gnsslocationservice.impl.GNSSLocationDataImpl#getGNSSCoordinateSystem <em>GNSS Coordinate System</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GNSSLocationDataImpl extends MinimalEObjectImpl.Container implements GNSSLocationData {
	...
	public NotificationChain basicSetLatitude(GNSSCoordinate newLatitude, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisGNSSLocationServicePackage.GNSS_LOCATION_DATA__LATITUDE, oldLatitude, newLatitude);
	...
	public void setLatitude(GNSSCoordinate newLatitude) {
		if (newLatitude != latitude) {
			...
			if (latitude != null)
				msgs = ((InternalEObject)latitude).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisGNSSLocationServicePackage.GNSS_LOCATION_DATA__LATITUDE, null, msgs);
			if (newLatitude != null)
				msgs = ((InternalEObject)newLatitude).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisGNSSLocationServicePackage.GNSS_LOCATION_DATA__LATITUDE, null, msgs);
			msgs = basicSetLatitude(newLatitude, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisGNSSLocationServicePackage.GNSS_LOCATION_DATA__LATITUDE, newLatitude, newLatitude));
	}
	...
	public NotificationChain basicSetLongitude(GNSSCoordinate newLongitude, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisGNSSLocationServicePackage.GNSS_LOCATION_DATA__LONGITUDE, oldLongitude, newLongitude);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setLongitude(GNSSCoordinate newLongitude) {
		if (newLongitude != longitude) {
			NotificationChain msgs = null;
			if (longitude != null)
				msgs = ((InternalEObject)longitude).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisGNSSLocationServicePackage.GNSS_LOCATION_DATA__LONGITUDE, null, msgs);
			if (newLongitude != null)
				msgs = ((InternalEObject)newLongitude).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisGNSSLocationServicePackage.GNSS_LOCATION_DATA__LONGITUDE, null, msgs);
			msgs = basicSetLongitude(newLongitude, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisGNSSLocationServicePackage.GNSS_LOCATION_DATA__LONGITUDE, newLongitude, newLongitude));
	}
	...
	public NotificationChain basicSetAltitude(IBISIPDouble newAltitude, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisGNSSLocationServicePackage.GNSS_LOCATION_DATA__ALTITUDE, oldAltitude, newAltitude);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setAltitude(IBISIPDouble newAltitude) {
		if (newAltitude != altitude) {
			NotificationChain msgs = null;
			if (altitude != null)
				msgs = ((InternalEObject)altitude).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisGNSSLocationServicePackage.GNSS_LOCATION_DATA__ALTITUDE, null, msgs);
			if (newAltitude != null)
				msgs = ((InternalEObject)newAltitude).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisGNSSLocationServicePackage.GNSS_LOCATION_DATA__ALTITUDE, null, msgs);
			msgs = basicSetAltitude(newAltitude, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisGNSSLocationServicePackage.GNSS_LOCATION_DATA__ALTITUDE, newAltitude, newAltitude));
	}
	...
	public NotificationChain basicSetTime(IBISIPDateTime newTime, NotificationChain msgs) {
		...
		time = newTime;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisGNSSLocationServicePackage.GNSS_LOCATION_DATA__TIME, oldTime, newTime);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTime(IBISIPDateTime newTime) {
		if (newTime != time) {
			NotificationChain msgs = null;
			if (time != null)
				msgs = ((InternalEObject)time).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisGNSSLocationServicePackage.GNSS_LOCATION_DATA__TIME, null, msgs);
			if (newTime != null)
				msgs = ((InternalEObject)newTime).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisGNSSLocationServicePackage.GNSS_LOCATION_DATA__TIME, null, msgs);
			msgs = basicSetTime(newTime, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisGNSSLocationServicePackage.GNSS_LOCATION_DATA__TIME, newTime, newTime));
	}
	...
	public NotificationChain basicSetDate(IBISIPDate newDate, NotificationChain msgs) {
		...
		date = newDate;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisGNSSLocationServicePackage.GNSS_LOCATION_DATA__DATE, oldDate, newDate);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setDate(IBISIPDate newDate) {
		if (newDate != date) {
			NotificationChain msgs = null;
			if (date != null)
				msgs = ((InternalEObject)date).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisGNSSLocationServicePackage.GNSS_LOCATION_DATA__DATE, null, msgs);
			if (newDate != null)
				msgs = ((InternalEObject)newDate).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisGNSSLocationServicePackage.GNSS_LOCATION_DATA__DATE, null, msgs);
			msgs = basicSetDate(newDate, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisGNSSLocationServicePackage.GNSS_LOCATION_DATA__DATE, newDate, newDate));
	}
	...
	public NotificationChain basicSetSpeedOverGround(IBISIPDouble newSpeedOverGround, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisGNSSLocationServicePackage.GNSS_LOCATION_DATA__SPEED_OVER_GROUND, oldSpeedOverGround, newSpeedOverGround);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSpeedOverGround(IBISIPDouble newSpeedOverGround) {
		if (newSpeedOverGround != speedOverGround) {
			...
			if (speedOverGround != null)
				msgs = ((InternalEObject)speedOverGround).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisGNSSLocationServicePackage.GNSS_LOCATION_DATA__SPEED_OVER_GROUND, null, msgs);
			if (newSpeedOverGround != null)
				msgs = ((InternalEObject)newSpeedOverGround).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisGNSSLocationServicePackage.GNSS_LOCATION_DATA__SPEED_OVER_GROUND, null, msgs);
			msgs = basicSetSpeedOverGround(newSpeedOverGround, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisGNSSLocationServicePackage.GNSS_LOCATION_DATA__SPEED_OVER_GROUND, newSpeedOverGround, newSpeedOverGround));
	}
	...
	public void setSignalQuality(GNSSQualityEnumeration newSignalQuality) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisGNSSLocationServicePackage.GNSS_LOCATION_DATA__SIGNAL_QUALITY, oldSignalQuality, signalQuality, !oldSignalQualityESet));
	}
	...
	public void unsetSignalQuality() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, IbisGNSSLocationServicePackage.GNSS_LOCATION_DATA__SIGNAL_QUALITY, oldSignalQuality, SIGNAL_QUALITY_EDEFAULT, oldSignalQualityESet));
	}
	...
	public NotificationChain basicSetNumberOfSatellites(IBISIPInt newNumberOfSatellites, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisGNSSLocationServicePackage.GNSS_LOCATION_DATA__NUMBER_OF_SATELLITES, oldNumberOfSatellites, newNumberOfSatellites);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setNumberOfSatellites(IBISIPInt newNumberOfSatellites) {
		if (newNumberOfSatellites != numberOfSatellites) {
			...
			if (numberOfSatellites != null)
				msgs = ((InternalEObject)numberOfSatellites).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisGNSSLocationServicePackage.GNSS_LOCATION_DATA__NUMBER_OF_SATELLITES, null, msgs);
			if (newNumberOfSatellites != null)
				msgs = ((InternalEObject)newNumberOfSatellites).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisGNSSLocationServicePackage.GNSS_LOCATION_DATA__NUMBER_OF_SATELLITES, null, msgs);
			msgs = basicSetNumberOfSatellites(newNumberOfSatellites, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisGNSSLocationServicePackage.GNSS_LOCATION_DATA__NUMBER_OF_SATELLITES, newNumberOfSatellites, newNumberOfSatellites));
	}
	...
	public NotificationChain basicSetHoriziontalDilutionOfPrecision(IBISIPDouble newHoriziontalDilutionOfPrecision, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisGNSSLocationServicePackage.GNSS_LOCATION_DATA__HORIZIONTAL_DILUTION_OF_PRECISION, oldHoriziontalDilutionOfPrecision, newHoriziontalDilutionOfPrecision);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setHoriziontalDilutionOfPrecision(IBISIPDouble newHoriziontalDilutionOfPrecision) {
		if (newHoriziontalDilutionOfPrecision != horiziontalDilutionOfPrecision) {
			...
			if (horiziontalDilutionOfPrecision != null)
				msgs = ((InternalEObject)horiziontalDilutionOfPrecision).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisGNSSLocationServicePackage.GNSS_LOCATION_DATA__HORIZIONTAL_DILUTION_OF_PRECISION, null, msgs);
			if (newHoriziontalDilutionOfPrecision != null)
				msgs = ((InternalEObject)newHoriziontalDilutionOfPrecision).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisGNSSLocationServicePackage.GNSS_LOCATION_DATA__HORIZIONTAL_DILUTION_OF_PRECISION, null, msgs);
			msgs = basicSetHoriziontalDilutionOfPrecision(newHoriziontalDilutionOfPrecision, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisGNSSLocationServicePackage.GNSS_LOCATION_DATA__HORIZIONTAL_DILUTION_OF_PRECISION, newHoriziontalDilutionOfPrecision, newHoriziontalDilutionOfPrecision));
	}
	...
	public NotificationChain basicSetVerticalDilutionOfPrecision(IBISIPDouble newVerticalDilutionOfPrecision, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisGNSSLocationServicePackage.GNSS_LOCATION_DATA__VERTICAL_DILUTION_OF_PRECISION, oldVerticalDilutionOfPrecision, newVerticalDilutionOfPrecision);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setVerticalDilutionOfPrecision(IBISIPDouble newVerticalDilutionOfPrecision) {
		if (newVerticalDilutionOfPrecision != verticalDilutionOfPrecision) {
			...
			if (verticalDilutionOfPrecision != null)
				msgs = ((InternalEObject)verticalDilutionOfPrecision).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisGNSSLocationServicePackage.GNSS_LOCATION_DATA__VERTICAL_DILUTION_OF_PRECISION, null, msgs);
			if (newVerticalDilutionOfPrecision != null)
				msgs = ((InternalEObject)newVerticalDilutionOfPrecision).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisGNSSLocationServicePackage.GNSS_LOCATION_DATA__VERTICAL_DILUTION_OF_PRECISION, null, msgs);
			msgs = basicSetVerticalDilutionOfPrecision(newVerticalDilutionOfPrecision, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisGNSSLocationServicePackage.GNSS_LOCATION_DATA__VERTICAL_DILUTION_OF_PRECISION, newVerticalDilutionOfPrecision, newVerticalDilutionOfPrecision));
	}
	...
	public NotificationChain basicSetTrackDegreeTrue(IBISIPDouble newTrackDegreeTrue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisGNSSLocationServicePackage.GNSS_LOCATION_DATA__TRACK_DEGREE_TRUE, oldTrackDegreeTrue, newTrackDegreeTrue);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTrackDegreeTrue(IBISIPDouble newTrackDegreeTrue) {
		if (newTrackDegreeTrue != trackDegreeTrue) {
			...
			if (trackDegreeTrue != null)
				msgs = ((InternalEObject)trackDegreeTrue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisGNSSLocationServicePackage.GNSS_LOCATION_DATA__TRACK_DEGREE_TRUE, null, msgs);
			if (newTrackDegreeTrue != null)
				msgs = ((InternalEObject)newTrackDegreeTrue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisGNSSLocationServicePackage.GNSS_LOCATION_DATA__TRACK_DEGREE_TRUE, null, msgs);
			msgs = basicSetTrackDegreeTrue(newTrackDegreeTrue, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisGNSSLocationServicePackage.GNSS_LOCATION_DATA__TRACK_DEGREE_TRUE, newTrackDegreeTrue, newTrackDegreeTrue));
	}
	...
	public NotificationChain basicSetTrackDegreeMagnetic(IBISIPDouble newTrackDegreeMagnetic, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisGNSSLocationServicePackage.GNSS_LOCATION_DATA__TRACK_DEGREE_MAGNETIC, oldTrackDegreeMagnetic, newTrackDegreeMagnetic);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTrackDegreeMagnetic(IBISIPDouble newTrackDegreeMagnetic) {
		if (newTrackDegreeMagnetic != trackDegreeMagnetic) {
			...
			if (trackDegreeMagnetic != null)
				msgs = ((InternalEObject)trackDegreeMagnetic).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisGNSSLocationServicePackage.GNSS_LOCATION_DATA__TRACK_DEGREE_MAGNETIC, null, msgs);
			if (newTrackDegreeMagnetic != null)
				msgs = ((InternalEObject)newTrackDegreeMagnetic).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisGNSSLocationServicePackage.GNSS_LOCATION_DATA__TRACK_DEGREE_MAGNETIC, null, msgs);
			msgs = basicSetTrackDegreeMagnetic(newTrackDegreeMagnetic, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisGNSSLocationServicePackage.GNSS_LOCATION_DATA__TRACK_DEGREE_MAGNETIC, newTrackDegreeMagnetic, newTrackDegreeMagnetic));
	}
	...
	public void setGNSSType(GNSSTypeEnumeration newGNSSType) {
		...
		gNSSTypeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisGNSSLocationServicePackage.GNSS_LOCATION_DATA__GNSS_TYPE, oldGNSSType, gNSSType, !oldGNSSTypeESet));
	}
	...
	public void unsetGNSSType() {
		...
		gNSSTypeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, IbisGNSSLocationServicePackage.GNSS_LOCATION_DATA__GNSS_TYPE, oldGNSSType, GNSS_TYPE_EDEFAULT, oldGNSSTypeESet));
	}
	...
	public void setGNSSCoordinateSystem(GNSSCoordinateSystemEnumeration newGNSSCoordinateSystem) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisGNSSLocationServicePackage.GNSS_LOCATION_DATA__GNSS_COORDINATE_SYSTEM, oldGNSSCoordinateSystem, gNSSCoordinateSystem, !oldGNSSCoordinateSystemESet));
	}
	...
	public void unsetGNSSCoordinateSystem() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, IbisGNSSLocationServicePackage.GNSS_LOCATION_DATA__GNSS_COORDINATE_SYSTEM, oldGNSSCoordinateSystem, GNSS_COORDINATE_SYSTEM_EDEFAULT, oldGNSSCoordinateSystemESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case IbisGNSSLocationServicePackage.GNSS_LOCATION_DATA__LATITUDE:
				return basicSetLatitude(null, msgs);
			case IbisGNSSLocationServicePackage.GNSS_LOCATION_DATA__LONGITUDE:
				return basicSetLongitude(null, msgs);
			case IbisGNSSLocationServicePackage.GNSS_LOCATION_DATA__ALTITUDE:
				return basicSetAltitude(null, msgs);
			case IbisGNSSLocationServicePackage.GNSS_LOCATION_DATA__TIME:
				return basicSetTime(null, msgs);
			case IbisGNSSLocationServicePackage.GNSS_LOCATION_DATA__DATE:
				return basicSetDate(null, msgs);
			case IbisGNSSLocationServicePackage.GNSS_LOCATION_DATA__SPEED_OVER_GROUND:
				return basicSetSpeedOverGround(null, msgs);
			case IbisGNSSLocationServicePackage.GNSS_LOCATION_DATA__NUMBER_OF_SATELLITES:
				return basicSetNumberOfSatellites(null, msgs);
			case IbisGNSSLocationServicePackage.GNSS_LOCATION_DATA__HORIZIONTAL_DILUTION_OF_PRECISION:
				return basicSetHoriziontalDilutionOfPrecision(null, msgs);
			case IbisGNSSLocationServicePackage.GNSS_LOCATION_DATA__VERTICAL_DILUTION_OF_PRECISION:
				return basicSetVerticalDilutionOfPrecision(null, msgs);
			case IbisGNSSLocationServicePackage.GNSS_LOCATION_DATA__TRACK_DEGREE_TRUE:
				return basicSetTrackDegreeTrue(null, msgs);
			case IbisGNSSLocationServicePackage.GNSS_LOCATION_DATA__TRACK_DEGREE_MAGNETIC:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case IbisGNSSLocationServicePackage.GNSS_LOCATION_DATA__SIGNAL_QUALITY:
			...
			case IbisGNSSLocationServicePackage.GNSS_LOCATION_DATA__GNSS_TYPE:
				return getGNSSType();
			case IbisGNSSLocationServicePackage.GNSS_LOCATION_DATA__GNSS_COORDINATE_SYSTEM:
