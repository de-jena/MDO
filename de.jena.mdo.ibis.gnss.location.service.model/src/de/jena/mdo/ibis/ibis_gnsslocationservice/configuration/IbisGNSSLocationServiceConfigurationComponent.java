...
import de.jena.mdo.ibis.ibis_gnsslocationservice.impl.IbisGNSSLocationServicePackageImpl;
...
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"de.jena.mdo.ibis.ibis_gnsslocationservice.IbisGNSSLocationServiceFactory, org.eclipse.emf.ecore.EFactory\"" , "uses:=org.eclipse.emf.ecore,de.jena.mdo.ibis.ibis_gnsslocationservice" })
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"de.jena.mdo.ibis.ibis_gnsslocationservice.IbisGNSSLocationServicePackage, org.eclipse.emf.ecore.EPackage\"" , "uses:=org.eclipse.emf.ecore,de.jena.mdo.ibis.ibis_gnsslocationservice" })
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.gecko.emf.osgi.EPackageConfigurator\"" , "uses:=org.eclipse.emf.ecore,de.jena.mdo.ibis.ibis_gnsslocationservice" })
