...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Vehicle Data</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.jena.mdo.ibis.ibis_customerinformationservice.impl.VehicleDataImpl#getTimeStamp <em>Time Stamp</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_customerinformationservice.impl.VehicleDataImpl#getVehicleRef <em>Vehicle Ref</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_customerinformationservice.impl.VehicleDataImpl#getRouteDeviation <em>Route Deviation</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_customerinformationservice.impl.VehicleDataImpl#getDoorState <em>Door State</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_customerinformationservice.impl.VehicleDataImpl#getInPanic <em>In Panic</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_customerinformationservice.impl.VehicleDataImpl#getVehicleStopRequested <em>Vehicle Stop Requested</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_customerinformationservice.impl.VehicleDataImpl#getExitSide <em>Exit Side</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_customerinformationservice.impl.VehicleDataImpl#getMovingDirectionForward <em>Moving Direction Forward</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_customerinformationservice.impl.VehicleDataImpl#getVehicleMode <em>Vehicle Mode</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_customerinformationservice.impl.VehicleDataImpl#getMyOwnVehicleMode <em>My Own Vehicle Mode</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_customerinformationservice.impl.VehicleDataImpl#getSpeakerActive <em>Speaker Active</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_customerinformationservice.impl.VehicleDataImpl#getStopInformationActive <em>Stop Information Active</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_customerinformationservice.impl.VehicleDataImpl#getTripState <em>Trip State</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VehicleDataImpl extends MinimalEObjectImpl.Container implements VehicleData {
	...
	protected EClass eStaticClass() {
		return IbisCustomerInformationServicePackage.Literals.VEHICLE_DATA;
	}
	...
	public NotificationChain basicSetTimeStamp(IBISIPDateTime newTimeStamp, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisCustomerInformationServicePackage.VEHICLE_DATA__TIME_STAMP, oldTimeStamp, newTimeStamp);
	...
	public void setTimeStamp(IBISIPDateTime newTimeStamp) {
		if (newTimeStamp != timeStamp) {
			...
			if (timeStamp != null)
				msgs = ((InternalEObject)timeStamp).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisCustomerInformationServicePackage.VEHICLE_DATA__TIME_STAMP, null, msgs);
			if (newTimeStamp != null)
				msgs = ((InternalEObject)newTimeStamp).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisCustomerInformationServicePackage.VEHICLE_DATA__TIME_STAMP, null, msgs);
			msgs = basicSetTimeStamp(newTimeStamp, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCustomerInformationServicePackage.VEHICLE_DATA__TIME_STAMP, newTimeStamp, newTimeStamp));
	}
	...
	public NotificationChain basicSetVehicleRef(IBISIPNMTOKEN newVehicleRef, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisCustomerInformationServicePackage.VEHICLE_DATA__VEHICLE_REF, oldVehicleRef, newVehicleRef);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setVehicleRef(IBISIPNMTOKEN newVehicleRef) {
		if (newVehicleRef != vehicleRef) {
			NotificationChain msgs = null;
			if (vehicleRef != null)
				msgs = ((InternalEObject)vehicleRef).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisCustomerInformationServicePackage.VEHICLE_DATA__VEHICLE_REF, null, msgs);
			if (newVehicleRef != null)
				msgs = ((InternalEObject)newVehicleRef).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisCustomerInformationServicePackage.VEHICLE_DATA__VEHICLE_REF, null, msgs);
			msgs = basicSetVehicleRef(newVehicleRef, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCustomerInformationServicePackage.VEHICLE_DATA__VEHICLE_REF, newVehicleRef, newVehicleRef));
	}
	...
	public void setRouteDeviation(RouteDeviationEnumeration newRouteDeviation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCustomerInformationServicePackage.VEHICLE_DATA__ROUTE_DEVIATION, oldRouteDeviation, routeDeviation, !oldRouteDeviationESet));
	}
	...
	public void unsetRouteDeviation() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, IbisCustomerInformationServicePackage.VEHICLE_DATA__ROUTE_DEVIATION, oldRouteDeviation, ROUTE_DEVIATION_EDEFAULT, oldRouteDeviationESet));
	}
	...
	public void setDoorState(DoorOpenStateEnumeration newDoorState) {
		...
		doorStateESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCustomerInformationServicePackage.VEHICLE_DATA__DOOR_STATE, oldDoorState, doorState, !oldDoorStateESet));
	}
	...
	public void unsetDoorState() {
		...
		doorStateESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, IbisCustomerInformationServicePackage.VEHICLE_DATA__DOOR_STATE, oldDoorState, DOOR_STATE_EDEFAULT, oldDoorStateESet));
	}
	...
	public NotificationChain basicSetInPanic(IBISIPBoolean newInPanic, NotificationChain msgs) {
		...
		inPanic = newInPanic;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisCustomerInformationServicePackage.VEHICLE_DATA__IN_PANIC, oldInPanic, newInPanic);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setInPanic(IBISIPBoolean newInPanic) {
		if (newInPanic != inPanic) {
			NotificationChain msgs = null;
			if (inPanic != null)
				msgs = ((InternalEObject)inPanic).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisCustomerInformationServicePackage.VEHICLE_DATA__IN_PANIC, null, msgs);
			if (newInPanic != null)
				msgs = ((InternalEObject)newInPanic).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisCustomerInformationServicePackage.VEHICLE_DATA__IN_PANIC, null, msgs);
			msgs = basicSetInPanic(newInPanic, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCustomerInformationServicePackage.VEHICLE_DATA__IN_PANIC, newInPanic, newInPanic));
	}
	...
	public NotificationChain basicSetVehicleStopRequested(IBISIPBoolean newVehicleStopRequested, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisCustomerInformationServicePackage.VEHICLE_DATA__VEHICLE_STOP_REQUESTED, oldVehicleStopRequested, newVehicleStopRequested);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setVehicleStopRequested(IBISIPBoolean newVehicleStopRequested) {
		if (newVehicleStopRequested != vehicleStopRequested) {
			...
			if (vehicleStopRequested != null)
				msgs = ((InternalEObject)vehicleStopRequested).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisCustomerInformationServicePackage.VEHICLE_DATA__VEHICLE_STOP_REQUESTED, null, msgs);
			if (newVehicleStopRequested != null)
				msgs = ((InternalEObject)newVehicleStopRequested).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisCustomerInformationServicePackage.VEHICLE_DATA__VEHICLE_STOP_REQUESTED, null, msgs);
			msgs = basicSetVehicleStopRequested(newVehicleStopRequested, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCustomerInformationServicePackage.VEHICLE_DATA__VEHICLE_STOP_REQUESTED, newVehicleStopRequested, newVehicleStopRequested));
	}
	...
	public void setExitSide(ExitSideEnumeration newExitSide) {
		...
		exitSideESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCustomerInformationServicePackage.VEHICLE_DATA__EXIT_SIDE, oldExitSide, exitSide, !oldExitSideESet));
	}
	...
	public void unsetExitSide() {
		...
		exitSideESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, IbisCustomerInformationServicePackage.VEHICLE_DATA__EXIT_SIDE, oldExitSide, EXIT_SIDE_EDEFAULT, oldExitSideESet));
	}
	...
	public NotificationChain basicSetMovingDirectionForward(IBISIPBoolean newMovingDirectionForward, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisCustomerInformationServicePackage.VEHICLE_DATA__MOVING_DIRECTION_FORWARD, oldMovingDirectionForward, newMovingDirectionForward);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setMovingDirectionForward(IBISIPBoolean newMovingDirectionForward) {
		if (newMovingDirectionForward != movingDirectionForward) {
			...
			if (movingDirectionForward != null)
				msgs = ((InternalEObject)movingDirectionForward).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisCustomerInformationServicePackage.VEHICLE_DATA__MOVING_DIRECTION_FORWARD, null, msgs);
			if (newMovingDirectionForward != null)
				msgs = ((InternalEObject)newMovingDirectionForward).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisCustomerInformationServicePackage.VEHICLE_DATA__MOVING_DIRECTION_FORWARD, null, msgs);
			msgs = basicSetMovingDirectionForward(newMovingDirectionForward, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCustomerInformationServicePackage.VEHICLE_DATA__MOVING_DIRECTION_FORWARD, newMovingDirectionForward, newMovingDirectionForward));
	}
	...
	public void setVehicleMode(VehicleModeEnumeration newVehicleMode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCustomerInformationServicePackage.VEHICLE_DATA__VEHICLE_MODE, oldVehicleMode, vehicleMode, !oldVehicleModeESet));
	}
	...
	public void unsetVehicleMode() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, IbisCustomerInformationServicePackage.VEHICLE_DATA__VEHICLE_MODE, oldVehicleMode, VEHICLE_MODE_EDEFAULT, oldVehicleModeESet));
	}
	...
	public NotificationChain basicSetMyOwnVehicleMode(NetexMode newMyOwnVehicleMode, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisCustomerInformationServicePackage.VEHICLE_DATA__MY_OWN_VEHICLE_MODE, oldMyOwnVehicleMode, newMyOwnVehicleMode);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setMyOwnVehicleMode(NetexMode newMyOwnVehicleMode) {
		if (newMyOwnVehicleMode != myOwnVehicleMode) {
			...
			if (myOwnVehicleMode != null)
				msgs = ((InternalEObject)myOwnVehicleMode).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisCustomerInformationServicePackage.VEHICLE_DATA__MY_OWN_VEHICLE_MODE, null, msgs);
			if (newMyOwnVehicleMode != null)
				msgs = ((InternalEObject)newMyOwnVehicleMode).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisCustomerInformationServicePackage.VEHICLE_DATA__MY_OWN_VEHICLE_MODE, null, msgs);
			msgs = basicSetMyOwnVehicleMode(newMyOwnVehicleMode, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCustomerInformationServicePackage.VEHICLE_DATA__MY_OWN_VEHICLE_MODE, newMyOwnVehicleMode, newMyOwnVehicleMode));
	}
	...
	public NotificationChain basicSetSpeakerActive(IBISIPBoolean newSpeakerActive, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisCustomerInformationServicePackage.VEHICLE_DATA__SPEAKER_ACTIVE, oldSpeakerActive, newSpeakerActive);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSpeakerActive(IBISIPBoolean newSpeakerActive) {
		if (newSpeakerActive != speakerActive) {
			...
			if (speakerActive != null)
				msgs = ((InternalEObject)speakerActive).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisCustomerInformationServicePackage.VEHICLE_DATA__SPEAKER_ACTIVE, null, msgs);
			if (newSpeakerActive != null)
				msgs = ((InternalEObject)newSpeakerActive).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisCustomerInformationServicePackage.VEHICLE_DATA__SPEAKER_ACTIVE, null, msgs);
			msgs = basicSetSpeakerActive(newSpeakerActive, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCustomerInformationServicePackage.VEHICLE_DATA__SPEAKER_ACTIVE, newSpeakerActive, newSpeakerActive));
	}
	...
	public NotificationChain basicSetStopInformationActive(IBISIPBoolean newStopInformationActive, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisCustomerInformationServicePackage.VEHICLE_DATA__STOP_INFORMATION_ACTIVE, oldStopInformationActive, newStopInformationActive);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setStopInformationActive(IBISIPBoolean newStopInformationActive) {
		if (newStopInformationActive != stopInformationActive) {
			...
			if (stopInformationActive != null)
				msgs = ((InternalEObject)stopInformationActive).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisCustomerInformationServicePackage.VEHICLE_DATA__STOP_INFORMATION_ACTIVE, null, msgs);
			if (newStopInformationActive != null)
				msgs = ((InternalEObject)newStopInformationActive).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisCustomerInformationServicePackage.VEHICLE_DATA__STOP_INFORMATION_ACTIVE, null, msgs);
			msgs = basicSetStopInformationActive(newStopInformationActive, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCustomerInformationServicePackage.VEHICLE_DATA__STOP_INFORMATION_ACTIVE, newStopInformationActive, newStopInformationActive));
	}
	...
	public void setTripState(TripStateEnumeration newTripState) {
		...
		tripStateESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCustomerInformationServicePackage.VEHICLE_DATA__TRIP_STATE, oldTripState, tripState, !oldTripStateESet));
	}
	...
	public void unsetTripState() {
		...
		tripStateESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, IbisCustomerInformationServicePackage.VEHICLE_DATA__TRIP_STATE, oldTripState, TRIP_STATE_EDEFAULT, oldTripStateESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case IbisCustomerInformationServicePackage.VEHICLE_DATA__TIME_STAMP:
				return basicSetTimeStamp(null, msgs);
			case IbisCustomerInformationServicePackage.VEHICLE_DATA__VEHICLE_REF:
				return basicSetVehicleRef(null, msgs);
			case IbisCustomerInformationServicePackage.VEHICLE_DATA__IN_PANIC:
				return basicSetInPanic(null, msgs);
			case IbisCustomerInformationServicePackage.VEHICLE_DATA__VEHICLE_STOP_REQUESTED:
				return basicSetVehicleStopRequested(null, msgs);
			case IbisCustomerInformationServicePackage.VEHICLE_DATA__MOVING_DIRECTION_FORWARD:
				return basicSetMovingDirectionForward(null, msgs);
			case IbisCustomerInformationServicePackage.VEHICLE_DATA__MY_OWN_VEHICLE_MODE:
				return basicSetMyOwnVehicleMode(null, msgs);
			case IbisCustomerInformationServicePackage.VEHICLE_DATA__SPEAKER_ACTIVE:
				return basicSetSpeakerActive(null, msgs);
			case IbisCustomerInformationServicePackage.VEHICLE_DATA__STOP_INFORMATION_ACTIVE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case IbisCustomerInformationServicePackage.VEHICLE_DATA__ROUTE_DEVIATION:
				return getRouteDeviation();
			case IbisCustomerInformationServicePackage.VEHICLE_DATA__DOOR_STATE:
				return getDoorState();
			case IbisCustomerInformationServicePackage.VEHICLE_DATA__IN_PANIC:
				return getInPanic();
			case IbisCustomerInformationServicePackage.VEHICLE_DATA__VEHICLE_STOP_REQUESTED:
				return getVehicleStopRequested();
			case IbisCustomerInformationServicePackage.VEHICLE_DATA__EXIT_SIDE:
				return getExitSide();
			case IbisCustomerInformationServicePackage.VEHICLE_DATA__MOVING_DIRECTION_FORWARD:
				return getMovingDirectionForward();
			case IbisCustomerInformationServicePackage.VEHICLE_DATA__VEHICLE_MODE:
			...
			case IbisCustomerInformationServicePackage.VEHICLE_DATA__TRIP_STATE:
				return getTripState();
		}
