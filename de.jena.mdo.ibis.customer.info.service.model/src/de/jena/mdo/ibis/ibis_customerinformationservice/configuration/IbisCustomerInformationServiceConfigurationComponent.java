/*
 */
package de.jena.mdo.ibis.ibis_customerinformationservice.configuration;
...
import de.jena.mdo.ibis.ibis_customerinformationservice.impl.IbisCustomerInformationServicePackageImpl;
...
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"de.jena.mdo.ibis.ibis_customerinformationservice.IbisCustomerInformationServiceFactory, org.eclipse.emf.ecore.EFactory\"" , "uses:=org.eclipse.emf.ecore,de.jena.mdo.ibis.ibis_customerinformationservice" })
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"de.jena.mdo.ibis.ibis_customerinformationservice.IbisCustomerInformationServicePackage, org.eclipse.emf.ecore.EPackage\"" , "uses:=org.eclipse.emf.ecore,de.jena.mdo.ibis.ibis_customerinformationservice" })
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.gecko.emf.osgi.EPackageConfigurator\"" , "uses:=org.eclipse.emf.ecore,de.jena.mdo.ibis.ibis_customerinformationservice" })
