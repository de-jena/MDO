 ...
 * </p>
 * <ul>
 *   <li>{@link org.w3.ns.adms.impl.DocumentRootImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link org.w3.ns.adms.impl.DocumentRootImpl#getXMLNSPrefixMap <em>XMLNS Prefix Map</em>}</li>
 *   <li>{@link org.w3.ns.adms.impl.DocumentRootImpl#getXSISchemaLocation <em>XSI Schema Location</em>}</li>
 *   <li>{@link org.w3.ns.adms.impl.DocumentRootImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link org.w3.ns.adms.impl.DocumentRootImpl#getSample <em>Sample</em>}</li>
 *   <li>{@link org.w3.ns.adms.impl.DocumentRootImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link org.w3.ns.adms.impl.DocumentRootImpl#getVersionNotes <em>Version Notes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DocumentRootImpl extends MinimalEObjectImpl.Container implements DocumentRoot {
	...
	public EMap<String, String> getXMLNSPrefixMap() {
		if (xMLNSPrefixMap == null) {
			xMLNSPrefixMap = new EcoreEMap<String,String>((EClass) eStaticClass().getEStructuralFeature(AdmsPackage.DOCUMENT_ROOT__XMLNS_PREFIX_MAP).getEType(), EStringToStringMapEntryImpl.class, this, AdmsPackage.DOCUMENT_ROOT__XMLNS_PREFIX_MAP);
		}
	...
	public EMap<String, String> getXSISchemaLocation() {
		if (xSISchemaLocation == null) {
			xSISchemaLocation = new EcoreEMap<String,String>((EClass) eStaticClass().getEStructuralFeature(AdmsPackage.DOCUMENT_ROOT__XSI_SCHEMA_LOCATION).getEType(), EStringToStringMapEntryImpl.class, this, AdmsPackage.DOCUMENT_ROOT__XSI_SCHEMA_LOCATION);
		}
	 ...
	 */
	@Override
	public Distribution getSample() {
		return (Distribution)getMixed().get(AdmsPackage.Literals.DOCUMENT_ROOT__SAMPLE, true);
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetSample(Distribution newSample, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(AdmsPackage.Literals.DOCUMENT_ROOT__SAMPLE, newSample, msgs);
	}
	 ...
	 */
	@Override
	public void setSample(Distribution newSample) {
		((FeatureMap.Internal)getMixed()).set(AdmsPackage.Literals.DOCUMENT_ROOT__SAMPLE, newSample);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case AdmsPackage.DOCUMENT_ROOT__SAMPLE:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case AdmsPackage.DOCUMENT_ROOT__IDENTIFIER:
				...
				return;
			case AdmsPackage.DOCUMENT_ROOT__SAMPLE:
				setSample((Distribution)newValue);
				return;
			case AdmsPackage.DOCUMENT_ROOT__STATUS:
