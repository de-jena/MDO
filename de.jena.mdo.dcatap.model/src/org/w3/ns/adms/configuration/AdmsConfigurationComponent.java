/*
 */
package org.w3.ns.adms.configuration;
...
@ProvideEMFModel(name = AdmsPackage.eNAME, nsURI = { AdmsPackage.eNS_URI }, version = "1.0.0")
public class AdmsConfigurationComponent implements EPackageConfigurator {
	private ServiceRegistration<?> packageRegistration = null;
	
	@Activate
	public void activate(BundleContext ctx) {
		AdmsPackage p = AdmsPackageImpl.init();
		if(p == null){
			p= AdmsPackageImpl.eINSTANCE;
			EPackage.Registry.INSTANCE.put(AdmsPackage.eNS_URI,p);
		}
