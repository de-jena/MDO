 ...
 * </p>
 * <ul>
 *   <li>{@link org.w3.ns.rdf.impl.PredicateTypeImpl#getResource <em>Resource</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PredicateTypeImpl extends MinimalEObjectImpl.Container implements PredicateType {
	...
	public void setResource(String newResource) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RdfPackage.PREDICATE_TYPE__RESOURCE, oldResource, resource));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RdfPackage.PREDICATE_TYPE__RESOURCE:
				return getResource();
		}
