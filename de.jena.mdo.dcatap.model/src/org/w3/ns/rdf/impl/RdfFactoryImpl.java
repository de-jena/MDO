...
public class RdfFactoryImpl extends EFactoryImpl implements RdfFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case RdfPackage.CATALOG_ROOT: return createCatalogRoot();
			...
			case RdfPackage.DOCUMENT_ROOT: return createDocumentRoot();
			default:
	 ...
	 */
	@Override
	public CatalogRoot createCatalogRoot() {
		CatalogRootImpl catalogRoot = new CatalogRootImpl();
		return catalogRoot;
	}
