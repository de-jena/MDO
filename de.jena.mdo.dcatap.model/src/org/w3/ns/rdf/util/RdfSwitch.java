...
public class RdfSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case RdfPackage.CATALOG_ROOT: {
				CatalogRoot catalogRoot = (CatalogRoot)theEObject;
				T result = caseCatalogRoot(catalogRoot);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Catalog Root</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Catalog Root</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseCatalogRoot(CatalogRoot object) {
		return null;
	}
