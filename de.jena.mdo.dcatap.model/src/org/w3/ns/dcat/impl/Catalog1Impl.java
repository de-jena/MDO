...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Catalog1</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.w3.ns.dcat.impl.Catalog1Impl#getCatalog <em>Catalog</em>}</li>
 *   <li>{@link org.w3.ns.dcat.impl.Catalog1Impl#getRecord <em>Record</em>}</li>
 *   <li>{@link org.w3.ns.dcat.impl.Catalog1Impl#getDataset <em>Dataset</em>}</li>
 *   <li>{@link org.w3.ns.dcat.impl.Catalog1Impl#getService <em>Service</em>}</li>
 *   <li>{@link org.w3.ns.dcat.impl.Catalog1Impl#getThemeTaxonomy <em>Theme Taxonomy</em>}</li>
 *   <li>{@link org.w3.ns.dcat.impl.Catalog1Impl#getHasPart <em>Has Part</em>}</li>
 *   <li>{@link org.w3.ns.dcat.impl.Catalog1Impl#getHomepage <em>Homepage</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Catalog1Impl extends DatasetTypeImpl implements Catalog1 {
	/**
	...
	protected EClass eStaticClass() {
		return DcatPackage.Literals.CATALOG1;
	}
	...
	public EList<Catalog> getCatalog() {
		if (catalog == null) {
			catalog = new EObjectContainmentEList<Catalog>(Catalog.class, this, DcatPackage.CATALOG1__CATALOG);
		}
		return catalog;
	}
	...
	public EList<CatalogRecord> getRecord() {
		if (record == null) {
			record = new EObjectContainmentEList<CatalogRecord>(CatalogRecord.class, this, DcatPackage.CATALOG1__RECORD);
		}
		return record;
	}
	...
	public EList<Dataset> getDataset() {
		if (dataset == null) {
			dataset = new EObjectContainmentEList<Dataset>(Dataset.class, this, DcatPackage.CATALOG1__DATASET);
		}
		return dataset;
	}
	...
	public EList<Service> getService() {
		if (service == null) {
			service = new EObjectContainmentEList<Service>(Service.class, this, DcatPackage.CATALOG1__SERVICE);
		}
		return service;
	}
	...
	public EList<ConceptScheme> getThemeTaxonomy() {
		if (themeTaxonomy == null) {
			themeTaxonomy = new EObjectContainmentEList<ConceptScheme>(ConceptScheme.class, this, DcatPackage.CATALOG1__THEME_TAXONOMY);
		}
	...
	public EList<Resource> getHasPart() {
		if (hasPart == null) {
			hasPart = new EObjectContainmentEList<Resource>(Resource.class, this, DcatPackage.CATALOG1__HAS_PART);
		}
		return hasPart;
	}
	...
	public NotificationChain basicSetHomepage(Resource newHomepage, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DcatPackage.CATALOG1__HOMEPAGE, oldHomepage, newHomepage);
	...
	public void setHomepage(Resource newHomepage) {
		if (newHomepage != homepage) {
			...
			if (homepage != null)
				msgs = ((InternalEObject)homepage).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DcatPackage.CATALOG1__HOMEPAGE, null, msgs);
			if (newHomepage != null)
				msgs = ((InternalEObject)newHomepage).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DcatPackage.CATALOG1__HOMEPAGE, null, msgs);
			msgs = basicSetHomepage(newHomepage, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DcatPackage.CATALOG1__HOMEPAGE, newHomepage, newHomepage));
	}
