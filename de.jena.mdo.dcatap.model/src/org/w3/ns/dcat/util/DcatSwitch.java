...
public class DcatSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case DcatPackage.CATALOG1: {
				Catalog1 catalog1 = (Catalog1)theEObject;
				T result = caseCatalog1(catalog1);
				if (result == null) result = caseDatasetType(catalog1);
				if (result == null) result = caseResourceType(catalog1);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case DcatPackage.CATALOG_RECORD_TYPE: {
				CatalogRecordType catalogRecordType = (CatalogRecordType)theEObject;
				T result = caseCatalogRecordType(catalogRecordType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DcatPackage.DATA_SERVICE_TYPE: {
				DataServiceType dataServiceType = (DataServiceType)theEObject;
				T result = caseDataServiceType(dataServiceType);
				if (result == null) result = caseResourceType(dataServiceType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case DcatPackage.DOCUMENT_ROOT: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Catalog1</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Catalog1</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseCatalog1(Catalog1 object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Catalog Record Type</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Catalog Record Type</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseCatalogRecordType(CatalogRecordType object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Data Service Type</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Data Service Type</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDataServiceType(DataServiceType object) {
		return null;
	}
