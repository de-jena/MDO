 ...
 *   <li>{@link org.w3.ns.dcat.DatasetType#getContributorId <em>Contributor Id</em>}</li>
 * </ul>
 *
...
public interface DatasetType extends ResourceType {
	...
	/**
	 * Returns the value of the '<em><b>Contributor Id</b></em>' reference list.
	 * The list contents are of type {@link de.dcatde.dcatde.Contributor}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Contributor Id</em>' reference list.
	 * @see org.w3.ns.dcat.DcatPackage#getDatasetType_ContributorId()
	 * @model extendedMetaData="kind='element' name='contributorID' namespace='http://dcat-ap.de/def/dcatde/'"
	 * @generated
	 */
	EList<Contributor> getContributorId();
