/*
 */
package org.w3.ns.vcard.configuration;
...
public class VcardConfigurationComponent implements EPackageConfigurator {
	...
	public void activate(BundleContext ctx) {
		VcardPackage p = VcardPackageImpl.init();
		if(p == null){
			p= VcardPackageImpl.eINSTANCE;
			EPackage.Registry.INSTANCE.put(VcardPackage.eNS_URI,p);
		}
