 ...
 * </p>
 * <ul>
 *   <li>{@link com.xmlns.foaf.foaf.impl.AgentTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.xmlns.foaf.foaf.impl.AgentTypeImpl#getType <em>Type</em>}</li>
 *   <li>{@link com.xmlns.foaf.foaf.impl.AgentTypeImpl#getPhone <em>Phone</em>}</li>
 *   <li>{@link com.xmlns.foaf.foaf.impl.AgentTypeImpl#getMbox <em>Mbox</em>}</li>
 *   <li>{@link com.xmlns.foaf.foaf.impl.AgentTypeImpl#getAbout <em>About</em>}</li>
 *   <li>{@link com.xmlns.foaf.foaf.impl.AgentTypeImpl#getNodeID <em>Node ID</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AgentTypeImpl extends MinimalEObjectImpl.Container implements AgentType {
	/**
	...
	public void setAbout(String newAbout) {
		...
		about = newAbout;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FoafPackage.AGENT_TYPE__ABOUT, oldAbout, about));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case FoafPackage.AGENT_TYPE__MBOX:
				return getMbox();
			case FoafPackage.AGENT_TYPE__ABOUT:
				return getAbout();
