/*
 */
package com.xmlns.foaf.foaf.configuration;
...
public class FoafConfigurationComponent implements EPackageConfigurator {
	...
	public void activate(BundleContext ctx) {
		FoafPackage p = FoafPackageImpl.init();
		if(p == null){
			p= FoafPackageImpl.eINSTANCE;
			EPackage.Registry.INSTANCE.put(FoafPackage.eNS_URI,p);
		}
