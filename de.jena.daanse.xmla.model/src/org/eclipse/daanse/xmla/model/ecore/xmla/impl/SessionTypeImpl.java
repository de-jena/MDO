 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla.impl.SessionTypeImpl#getMustUnderstand <em>Must Understand</em>}</li>
 *   <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla.impl.SessionTypeImpl#getSessionId <em>Session Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SessionTypeImpl extends MinimalEObjectImpl.Container implements SessionType {
	/**
	...
	protected EClass eStaticClass() {
		return XmlaPackage.Literals.SESSION_TYPE;
	}
	...
	public void setMustUnderstand(int newMustUnderstand) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XmlaPackage.SESSION_TYPE__MUST_UNDERSTAND, oldMustUnderstand, mustUnderstand, !oldMustUnderstandESet));
	}
	...
	public void unsetMustUnderstand() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, XmlaPackage.SESSION_TYPE__MUST_UNDERSTAND, oldMustUnderstand, MUST_UNDERSTAND_EDEFAULT, oldMustUnderstandESet));
	}
	...
	public void setSessionId(String newSessionId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XmlaPackage.SESSION_TYPE__SESSION_ID, oldSessionId, sessionId));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case XmlaPackage.SESSION_TYPE__MUST_UNDERSTAND:
				return getMustUnderstand();
			case XmlaPackage.SESSION_TYPE__SESSION_ID:
				return getSessionId();
		}
