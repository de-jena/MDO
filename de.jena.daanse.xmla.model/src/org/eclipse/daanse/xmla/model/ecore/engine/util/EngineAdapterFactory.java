...
public class EngineAdapterFactory extends AdapterFactoryImpl {
	...
	protected EngineSwitch<Adapter> modelSwitch =
		new EngineSwitch<Adapter>() {
			...
			@Override
			public Adapter caseImpersonationInfo(ImpersonationInfo object) {
				return createImpersonationInfoAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.daanse.xmla.model.ecore.engine.DocumentRoot <em>Document Root</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.daanse.xmla.model.ecore.engine.ImpersonationInfo <em>Impersonation Info</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createImpersonationInfoAdapter() {
		return null;
	}
