...
import org.eclipse.daanse.xmla.model.ecore.engine.EngineFactory;
...
public class EnginePackageImpl extends EPackageImpl implements EnginePackage {
	 ...
	 * @generated
	 */
	private EClass impersonationInfoEClass = null;
	 ...
	 * @generated
	 */
	private EEnum impersonationInfoSecurityTypeEEnum = null;
	 ...
	 * @generated
	 */
	private EEnum impersonationModeTypeEEnum = null;
	 ...
	 * @generated
	 */
	private EDataType impersonationInfoSecurityTypeObjectEDataType = null;
	 ...
	 * @generated
	 */
	private EDataType impersonationModeTypeObjectEDataType = null;
	 ...
	 * @see org.eclipse.daanse.xmla.model.ecore.engine.EnginePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static EnginePackage init() {
		...
		EnginePackageImpl theEnginePackage = registeredEnginePackage instanceof EnginePackageImpl ? (EnginePackageImpl)registeredEnginePackage : new EnginePackageImpl();
		...
		Object registeredPackage = EPackage.Registry.INSTANCE.getEPackage(Engine100_100Package.eNS_URI);
	 ...
	 * @generated
	 */
	public EClass getImpersonationInfo() {
		return impersonationInfoEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getImpersonationInfo_ImpersonationMode() {
		return (EAttribute)impersonationInfoEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getImpersonationInfo_Account() {
		return (EAttribute)impersonationInfoEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EAttribute getImpersonationInfo_Password() {
		return (EAttribute)impersonationInfoEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EAttribute getImpersonationInfo_ImpersonationInfoSecurity() {
		return (EAttribute)impersonationInfoEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EEnum getImpersonationInfoSecurityType() {
		return impersonationInfoSecurityTypeEEnum;
	}
	 ...
	 * @generated
	 */
	public EEnum getImpersonationModeType() {
		return impersonationModeTypeEEnum;
	}
	 ...
	 * @generated
	 */
	public EDataType getImpersonationInfoSecurityTypeObject() {
		return impersonationInfoSecurityTypeObjectEDataType;
	}
	 ...
	 * @generated
	 */
	public EDataType getImpersonationModeTypeObject() {
		return impersonationModeTypeObjectEDataType;
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(documentRootEClass, DOCUMENT_ROOT__LAST_DATA_UPDATE);
		createEAttribute(documentRootEClass, DOCUMENT_ROOT__LAST_SCHEMA_UPDATE);

		impersonationInfoEClass = createEClass(IMPERSONATION_INFO);
		createEAttribute(impersonationInfoEClass, IMPERSONATION_INFO__IMPERSONATION_MODE);
		createEAttribute(impersonationInfoEClass, IMPERSONATION_INFO__ACCOUNT);
		createEAttribute(impersonationInfoEClass, IMPERSONATION_INFO__PASSWORD);
		createEAttribute(impersonationInfoEClass, IMPERSONATION_INFO__IMPERSONATION_INFO_SECURITY);

		// Create enums
		impersonationInfoSecurityTypeEEnum = createEEnum(IMPERSONATION_INFO_SECURITY_TYPE);
		impersonationModeTypeEEnum = createEEnum(IMPERSONATION_MODE_TYPE);

		// Create data types
		impersonationInfoSecurityTypeObjectEDataType = createEDataType(IMPERSONATION_INFO_SECURITY_TYPE_OBJECT);
		impersonationModeTypeObjectEDataType = createEDataType(IMPERSONATION_MODE_TYPE_OBJECT);
	}
	...
	public void initializePackageContents() {
		...
		initEAttribute(getDocumentRoot_LastDataUpdate(), theXMLTypePackage.getDateTime(), "lastDataUpdate", null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEAttribute(getDocumentRoot_LastSchemaUpdate(), theXMLTypePackage.getDateTime(), "lastSchemaUpdate", null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, IS_DERIVED, IS_ORDERED);

		initEClass(impersonationInfoEClass, ImpersonationInfo.class, "ImpersonationInfo", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getImpersonationInfo_ImpersonationMode(), this.getImpersonationModeType(), "impersonationMode", null, 1, 1, ImpersonationInfo.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getImpersonationInfo_Account(), theXMLTypePackage.getString(), "account", null, 0, 1, ImpersonationInfo.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getImpersonationInfo_Password(), theXMLTypePackage.getString(), "password", null, 0, 1, ImpersonationInfo.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getImpersonationInfo_ImpersonationInfoSecurity(), this.getImpersonationInfoSecurityType(), "impersonationInfoSecurity", null, 0, 1, ImpersonationInfo.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		// Initialize enums and add enum literals
		initEEnum(impersonationInfoSecurityTypeEEnum, ImpersonationInfoSecurityType.class, "ImpersonationInfoSecurityType");
		addEEnumLiteral(impersonationInfoSecurityTypeEEnum, ImpersonationInfoSecurityType.PASSWORD_REMOVED);
		addEEnumLiteral(impersonationInfoSecurityTypeEEnum, ImpersonationInfoSecurityType.UNCHANGED);

		initEEnum(impersonationModeTypeEEnum, ImpersonationModeType.class, "ImpersonationModeType");
		addEEnumLiteral(impersonationModeTypeEEnum, ImpersonationModeType.DEFAULT);
		addEEnumLiteral(impersonationModeTypeEEnum, ImpersonationModeType.IMPERSONATE_SERVICE_ACCOUNT);
		addEEnumLiteral(impersonationModeTypeEEnum, ImpersonationModeType.IMPERSONATE_ANONYMOUS);
		addEEnumLiteral(impersonationModeTypeEEnum, ImpersonationModeType.IMPERSONATE_CURRENT_USER);
		addEEnumLiteral(impersonationModeTypeEEnum, ImpersonationModeType.IMPERSONATE_ACCOUNT);

		// Initialize data types
		initEDataType(impersonationInfoSecurityTypeObjectEDataType, ImpersonationInfoSecurityType.class, "ImpersonationInfoSecurityTypeObject", IS_SERIALIZABLE, IS_GENERATED_INSTANCE_CLASS);
		initEDataType(impersonationModeTypeObjectEDataType, ImpersonationModeType.class, "ImpersonationModeTypeObject", IS_SERIALIZABLE, IS_GENERATED_INSTANCE_CLASS);
	...
	protected void createExtendedMetaDataAnnotations() {
		...
		addAnnotation
		  (getDocumentRoot_LastDataUpdate(),
		   source,
		   new String[] {
			   "kind", "element",
			   "name", "LastDataUpdate",
		...
		addAnnotation
		  (getDocumentRoot_LastSchemaUpdate(),
		   source,
		   new String[] {
			   "kind", "element",
		...
		addAnnotation
		  (getImpersonationInfo_ImpersonationMode(),
		   source,
		   new String[] {
			   "kind", "element",
		...
		addAnnotation
		  (getImpersonationInfo_ImpersonationInfoSecurity(),
		   source,
		   new String[] {
			   "kind", "element",
			   "name", "ImpersonationInfoSecurity"
		   });
		addAnnotation
		  (impersonationInfoSecurityTypeEEnum,
		   source,
		   new String[] {
			   "name", "ImpersonationInfoSecurity_._type"
		   });
		addAnnotation
		  (impersonationInfoSecurityTypeObjectEDataType,
		   source,
		   new String[] {
			   "name", "ImpersonationInfoSecurity_._type:Object",
			   "baseType", "ImpersonationInfoSecurity_._type"
		   });
		addAnnotation
		  (impersonationModeTypeEEnum,
		   source,
		   new String[] {
			   "name", "ImpersonationMode_._type"
		   });
		addAnnotation
		  (impersonationModeTypeObjectEDataType,
		   source,
		   new String[] {
			   "name", "ImpersonationMode_._type:Object",
			   "baseType", "ImpersonationMode_._type"
		   });
	}
