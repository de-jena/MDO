 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla.impl.ActionsTypeImpl#getAction <em>Action</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ActionsTypeImpl extends MinimalEObjectImpl.Container implements ActionsType {
	...
	protected EClass eStaticClass() {
		return XmlaPackage.Literals.ACTIONS_TYPE;
	}
	...
	public EList<Action> getAction() {
		if (action == null) {
			action = new EObjectContainmentEList<Action>(Action.class, this, XmlaPackage.ACTIONS_TYPE__ACTION);
		}
		return action;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case XmlaPackage.ACTIONS_TYPE__ACTION:
