 ...
 * <!-- end-user-doc -->
 * @see org.eclipse.daanse.xmla.model.ecore.xmla.XmlaPackage#getParameterType()
 * @model extendedMetaData="name='Parameter_._type'"
 * @generated
 */
public enum ParameterType implements Enumerator {
	/**
	 * The '<em><b>End Of Input Rowset</b></em>' literal object.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #END_OF_INPUT_ROWSET_VALUE
	 * @generated
	 * @ordered
	 */
	END_OF_INPUT_ROWSET(0, "EndOfInputRowset", "EndOfInputRowset");

	/**
	 * The '<em><b>End Of Input Rowset</b></em>' literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #END_OF_INPUT_ROWSET
	 * @model name="EndOfInputRowset"
	 * @generated
	 * @ordered
	 */
	public static final int END_OF_INPUT_ROWSET_VALUE = 0;
	...
	public static ParameterType get(int value) {
		switch (value) {
			case END_OF_INPUT_ROWSET_VALUE: return END_OF_INPUT_ROWSET;
		}
		return null;
	}
