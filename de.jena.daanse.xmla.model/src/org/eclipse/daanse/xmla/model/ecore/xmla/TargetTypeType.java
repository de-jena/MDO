...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Target Type Type</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.eclipse.daanse.xmla.model.ecore.xmla.XmlaPackage#getTargetTypeType()
 * @model extendedMetaData="name='TargetType_._type'"
 * @generated
 */
public enum TargetTypeType implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Target Type Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final TargetTypeType[] VALUES_ARRAY =
		new TargetTypeType[] {
			CUBE,
			CELLS,
			SET,
	...
	/**
	 * A public read-only list of all the '<em><b>Target Type Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<TargetTypeType> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Target Type Type</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static TargetTypeType get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			TargetTypeType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Target Type Type</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static TargetTypeType getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			TargetTypeType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Target Type Type</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static TargetTypeType get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private TargetTypeType(int value, String name, String literal) {
		this.value = value;
		this.name = name;
