 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla.impl.GroupsTypeImpl#getGroup <em>Group</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GroupsTypeImpl extends MinimalEObjectImpl.Container implements GroupsType {
	...
	protected EClass eStaticClass() {
		return XmlaPackage.Literals.GROUPS_TYPE;
	}
	...
	public EList<Group> getGroup() {
		if (group == null) {
			group = new EObjectContainmentEList<Group>(Group.class, this, XmlaPackage.GROUPS_TYPE__GROUP);
		}
		return group;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case XmlaPackage.GROUPS_TYPE__GROUP:
