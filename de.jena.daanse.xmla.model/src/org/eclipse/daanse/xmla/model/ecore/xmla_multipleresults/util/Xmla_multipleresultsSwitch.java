 ...
 * @generated
 */
public class Xmla_multipleresultsSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public Xmla_multipleresultsSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Xmla_multipleresultsPackage.RESULTS_TYPE: {
				ResultsType resultsType = (ResultsType)theEObject;
				T result = caseResultsType(resultsType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Xmla_multipleresultsPackage.DOCUMENT_ROOT: {
