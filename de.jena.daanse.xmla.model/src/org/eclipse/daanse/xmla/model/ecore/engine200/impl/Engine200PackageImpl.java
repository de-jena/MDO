...
import org.eclipse.daanse.xmla.model.ecore.engine200.Engine200Factory;
 ...
 * @generated
 */
public class Engine200PackageImpl extends EPackageImpl implements Engine200Package {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @generated
	 */
	private EClass warningColumnTypeEClass = null;
	 ...
	 * @generated
	 */
	private EClass warningLocationObjectEClass = null;
	 ...
	 * @generated
	 */
	private EClass warningMeasureTypeEClass = null;
	 ...
	 * @generated
	 */
	private EEnum calculationErrorTypeEEnum = null;
	 ...
	 * @generated
	 */
	private EDataType calculationErrorTypeObjectEDataType = null;
	 ...
	 * @see org.eclipse.daanse.xmla.model.ecore.engine200.Engine200Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Engine200PackageImpl() {
		super(eNS_URI, Engine200Factory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link Engine200Package#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static Engine200Package init() {
		if (isInited) return (Engine200Package)EPackage.Registry.INSTANCE.getEPackage(Engine200Package.eNS_URI);

		// Obtain or create and register package
		Object registeredEngine200Package = EPackage.Registry.INSTANCE.get(eNS_URI);
		Engine200PackageImpl theEngine200Package = registeredEngine200Package instanceof Engine200PackageImpl ? (Engine200PackageImpl)registeredEngine200Package : new Engine200PackageImpl();
		...
		theEngine200Package.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Engine200Package.eNS_URI, theEngine200Package);
		return theEngine200Package;
	}
	 ...
	 * @generated
	 */
	public EAttribute getDocumentRoot_CalculationError() {
	 ...
	 * @generated
	 */
	public EAttribute getDocumentRoot_CompatibilityLevel() {
	 ...
	 * @generated
	 */
	public EReference getDocumentRoot_WarningColumn() {
	 ...
	 * @generated
	 */
	public EReference getDocumentRoot_WarningMeasure() {
	 ...
	 * @generated
	 */
	public EClass getWarningColumnType() {
		return warningColumnTypeEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getWarningColumnType_Dimension() {
		return (EAttribute)warningColumnTypeEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getWarningColumnType_Attribute() {
		return (EAttribute)warningColumnTypeEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EClass getWarningLocationObject() {
		return warningLocationObjectEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getWarningLocationObject_WarningColumn() {
		return (EReference)warningLocationObjectEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getWarningLocationObject_WarningMeasure() {
		return (EReference)warningLocationObjectEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EClass getWarningMeasureType() {
		return warningMeasureTypeEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getWarningMeasureType_Cube() {
		return (EAttribute)warningMeasureTypeEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getWarningMeasureType_MeasureGroup() {
		return (EAttribute)warningMeasureTypeEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EAttribute getWarningMeasureType_MeasureName() {
		return (EAttribute)warningMeasureTypeEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EEnum getCalculationErrorType() {
		return calculationErrorTypeEEnum;
	}
	 ...
	 * @generated
	 */
	public EDataType getCalculationErrorTypeObject() {
		return calculationErrorTypeObjectEDataType;
	}
	 ...
	 * @generated
	 */
	public Engine200Factory getEngine200Factory() {
		return (Engine200Factory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(documentRootEClass, DOCUMENT_ROOT__CALCULATION_ERROR);
		createEAttribute(documentRootEClass, DOCUMENT_ROOT__COMPATIBILITY_LEVEL);
		createEReference(documentRootEClass, DOCUMENT_ROOT__WARNING_COLUMN);
		createEReference(documentRootEClass, DOCUMENT_ROOT__WARNING_MEASURE);

		warningColumnTypeEClass = createEClass(WARNING_COLUMN_TYPE);
		createEAttribute(warningColumnTypeEClass, WARNING_COLUMN_TYPE__DIMENSION);
		createEAttribute(warningColumnTypeEClass, WARNING_COLUMN_TYPE__ATTRIBUTE);

		warningLocationObjectEClass = createEClass(WARNING_LOCATION_OBJECT);
		createEReference(warningLocationObjectEClass, WARNING_LOCATION_OBJECT__WARNING_COLUMN);
		createEReference(warningLocationObjectEClass, WARNING_LOCATION_OBJECT__WARNING_MEASURE);

		warningMeasureTypeEClass = createEClass(WARNING_MEASURE_TYPE);
		createEAttribute(warningMeasureTypeEClass, WARNING_MEASURE_TYPE__CUBE);
		createEAttribute(warningMeasureTypeEClass, WARNING_MEASURE_TYPE__MEASURE_GROUP);
		createEAttribute(warningMeasureTypeEClass, WARNING_MEASURE_TYPE__MEASURE_NAME);

		// Create enums
		calculationErrorTypeEEnum = createEEnum(CALCULATION_ERROR_TYPE);

		// Create data types
		calculationErrorTypeObjectEDataType = createEDataType(CALCULATION_ERROR_TYPE_OBJECT);
	}
	...
	public void initializePackageContents() {
		...
		initEAttribute(getDocumentRoot_CalculationError(), this.getCalculationErrorType(), "calculationError", null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEAttribute(getDocumentRoot_CompatibilityLevel(), theXMLTypePackage.getInteger(), "compatibilityLevel", null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEReference(getDocumentRoot_WarningColumn(), this.getWarningColumnType(), null, "warningColumn", null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEReference(getDocumentRoot_WarningMeasure(), this.getWarningMeasureType(), null, "warningMeasure", null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);

		initEClass(warningColumnTypeEClass, WarningColumnType.class, "WarningColumnType", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getWarningColumnType_Dimension(), theXMLTypePackage.getString(), "dimension", null, 1, 1, WarningColumnType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getWarningColumnType_Attribute(), theXMLTypePackage.getString(), "attribute", null, 1, 1, WarningColumnType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(warningLocationObjectEClass, WarningLocationObject.class, "WarningLocationObject", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getWarningLocationObject_WarningColumn(), this.getWarningColumnType(), null, "warningColumn", null, 0, 1, WarningLocationObject.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getWarningLocationObject_WarningMeasure(), this.getWarningMeasureType(), null, "warningMeasure", null, 0, 1, WarningLocationObject.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(warningMeasureTypeEClass, WarningMeasureType.class, "WarningMeasureType", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getWarningMeasureType_Cube(), theXMLTypePackage.getString(), "cube", null, 1, 1, WarningMeasureType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getWarningMeasureType_MeasureGroup(), theXMLTypePackage.getString(), "measureGroup", null, 1, 1, WarningMeasureType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getWarningMeasureType_MeasureName(), theXMLTypePackage.getString(), "measureName", null, 1, 1, WarningMeasureType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		// Initialize enums and add enum literals
		initEEnum(calculationErrorTypeEEnum, CalculationErrorType.class, "CalculationErrorType");
		addEEnumLiteral(calculationErrorTypeEEnum, CalculationErrorType.IGNORE_ERROR);
		addEEnumLiteral(calculationErrorTypeEEnum, CalculationErrorType.REPORT_AND_STOP);

		// Initialize data types
		initEDataType(calculationErrorTypeObjectEDataType, CalculationErrorType.class, "CalculationErrorTypeObject", IS_SERIALIZABLE, IS_GENERATED_INSTANCE_CLASS);
	...
	protected void createExtendedMetaDataAnnotations() {
		...
		addAnnotation
		  (calculationErrorTypeEEnum,
		   source,
		   new String[] {
			   "name", "CalculationError_._type"
		   });
		addAnnotation
		  (calculationErrorTypeObjectEDataType,
		   source,
		   new String[] {
			   "name", "CalculationError_._type:Object",
			   "baseType", "CalculationError_._type"
		   });
		addAnnotation
		  (documentRootEClass,
		   source,
		...
		addAnnotation
		  (getDocumentRoot_CalculationError(),
		   source,
		   new String[] {
			   "kind", "element",
		...
		addAnnotation
		  (getDocumentRoot_CompatibilityLevel(),
		   source,
		   new String[] {
			   "kind", "element",
		...
		addAnnotation
		  (getDocumentRoot_WarningMeasure(),
		   source,
		   new String[] {
			   "kind", "element",
			   "name", "WarningMeasure",
		...
		addAnnotation
		  (warningColumnTypeEClass,
		   source,
		   new String[] {
			   "name", "WarningColumn_._type",
			   "kind", "elementOnly"
		   });
		addAnnotation
		  (getWarningColumnType_Dimension(),
		   source,
		   new String[] {
			   "kind", "element",
			   "name", "Dimension"
		...
		addAnnotation
		  (getWarningColumnType_Attribute(),
		   source,
		   new String[] {
			   "kind", "element",
			   "name", "Attribute"
		...
		addAnnotation
		  (warningLocationObjectEClass,
		   source,
		   new String[] {
			   "name", "WarningLocationObject",
			   "kind", "elementOnly"
		   });
		addAnnotation
		  (getWarningLocationObject_WarningColumn(),
		   source,
		   new String[] {
			   "kind", "element",
			   "name", "WarningColumn",
		...
		addAnnotation
		  (getWarningLocationObject_WarningMeasure(),
		   source,
		   new String[] {
			   "kind", "element",
			   "name", "WarningMeasure",
		...
		addAnnotation
		  (warningMeasureTypeEClass,
		   source,
		   new String[] {
			   "name", "WarningMeasure_._type",
			   "kind", "elementOnly"
		   });
		addAnnotation
		  (getWarningMeasureType_Cube(),
		   source,
		   new String[] {
			   "kind", "element",
			   "name", "Cube"
		...
		addAnnotation
		  (getWarningMeasureType_MeasureGroup(),
		   source,
		   new String[] {
			   "kind", "element",
			   "name", "MeasureGroup"
		...
		addAnnotation
		  (getWarningMeasureType_MeasureName(),
		   source,
		   new String[] {
			   "kind", "element",
			   "name", "MeasureName"
