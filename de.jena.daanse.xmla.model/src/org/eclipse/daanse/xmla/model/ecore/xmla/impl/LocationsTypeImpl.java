 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla.impl.LocationsTypeImpl#getLocation <em>Location</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LocationsTypeImpl extends MinimalEObjectImpl.Container implements LocationsType {
	...
	protected EClass eStaticClass() {
		return XmlaPackage.Literals.LOCATIONS_TYPE;
	}
	...
	public EList<Location> getLocation() {
		if (location == null) {
			location = new EObjectContainmentEList<Location>(Location.class, this, XmlaPackage.LOCATIONS_TYPE__LOCATION);
		}
		return location;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case XmlaPackage.LOCATIONS_TYPE__LOCATION:
