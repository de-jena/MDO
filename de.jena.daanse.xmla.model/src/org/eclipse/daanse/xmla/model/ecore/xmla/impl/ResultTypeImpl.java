 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla.impl.ResultTypeImpl#getResultId <em>Result Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ResultTypeImpl extends MinimalEObjectImpl.Container implements ResultType {
	...
	protected EClass eStaticClass() {
		return XmlaPackage.Literals.RESULT_TYPE;
	}
	...
	public void setResultId(String newResultId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XmlaPackage.RESULT_TYPE__RESULT_ID, oldResultId, resultId));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case XmlaPackage.RESULT_TYPE__RESULT_ID:
				return getResultId();
		}
