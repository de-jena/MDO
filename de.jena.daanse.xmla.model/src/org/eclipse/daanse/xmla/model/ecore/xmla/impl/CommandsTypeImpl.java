 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla.impl.CommandsTypeImpl#getCommand <em>Command</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CommandsTypeImpl extends MinimalEObjectImpl.Container implements CommandsType {
	...
	protected EClass eStaticClass() {
		return XmlaPackage.Literals.COMMANDS_TYPE;
	}
	...
	public EList<Command> getCommand() {
		if (command == null) {
			command = new EObjectContainmentEList<Command>(Command.class, this, XmlaPackage.COMMANDS_TYPE__COMMAND);
		}
		return command;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case XmlaPackage.COMMANDS_TYPE__COMMAND:
