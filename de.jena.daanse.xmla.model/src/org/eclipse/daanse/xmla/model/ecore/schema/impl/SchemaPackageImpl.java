...
import org.eclipse.daanse.xmla.model.ecore.schema.AllNNIMember1;
import org.eclipse.daanse.xmla.model.ecore.schema.Annotated;
...
import org.eclipse.daanse.xmla.model.ecore.schema.Attribute;
import org.eclipse.daanse.xmla.model.ecore.schema.AttributeGroup;
import org.eclipse.daanse.xmla.model.ecore.schema.AttributeGroupRef;
import org.eclipse.daanse.xmla.model.ecore.schema.BlockSetMember0;
import org.eclipse.daanse.xmla.model.ecore.schema.BlockSetMember1Item;
import org.eclipse.daanse.xmla.model.ecore.schema.ComplexContentType;
import org.eclipse.daanse.xmla.model.ecore.schema.ComplexRestrictionType;
import org.eclipse.daanse.xmla.model.ecore.schema.ComplexType;
import org.eclipse.daanse.xmla.model.ecore.schema.DerivationControl;
import org.eclipse.daanse.xmla.model.ecore.schema.DerivationSetMember0;
...
import org.eclipse.daanse.xmla.model.ecore.schema.Element;
import org.eclipse.daanse.xmla.model.ecore.schema.ExplicitGroup;
import org.eclipse.daanse.xmla.model.ecore.schema.ExtensionType;
import org.eclipse.daanse.xmla.model.ecore.schema.Facet;
import org.eclipse.daanse.xmla.model.ecore.schema.FieldType;
import org.eclipse.daanse.xmla.model.ecore.schema.FormChoice;
import org.eclipse.daanse.xmla.model.ecore.schema.FullDerivationSetMember0;
import org.eclipse.daanse.xmla.model.ecore.schema.Group;
import org.eclipse.daanse.xmla.model.ecore.schema.GroupRef;
...
import org.eclipse.daanse.xmla.model.ecore.schema.LocalComplexType;
import org.eclipse.daanse.xmla.model.ecore.schema.LocalElement;
import org.eclipse.daanse.xmla.model.ecore.schema.LocalSimpleType;
...
import org.eclipse.daanse.xmla.model.ecore.schema.NamespaceListMember0;
import org.eclipse.daanse.xmla.model.ecore.schema.NamespaceListMember1ItemMember1;
import org.eclipse.daanse.xmla.model.ecore.schema.NarrowMaxMin;
...
import org.eclipse.daanse.xmla.model.ecore.schema.OpenAttrs;
import org.eclipse.daanse.xmla.model.ecore.schema.PatternType;
import org.eclipse.daanse.xmla.model.ecore.schema.ProcessContentsType;
import org.eclipse.daanse.xmla.model.ecore.schema.RealGroup;
import org.eclipse.daanse.xmla.model.ecore.schema.RedefineType;
import org.eclipse.daanse.xmla.model.ecore.schema.ReducedDerivationControl;
import org.eclipse.daanse.xmla.model.ecore.schema.RestrictionType;
import org.eclipse.daanse.xmla.model.ecore.schema.RestrictionType1;
import org.eclipse.daanse.xmla.model.ecore.schema.SchemaFactory;
...
import org.eclipse.daanse.xmla.model.ecore.schema.SimpleDerivationSetMember0;
import org.eclipse.daanse.xmla.model.ecore.schema.SimpleDerivationSetMember1Item;
import org.eclipse.daanse.xmla.model.ecore.schema.SimpleExplicitGroup;
import org.eclipse.daanse.xmla.model.ecore.schema.SimpleExtensionType;
import org.eclipse.daanse.xmla.model.ecore.schema.SimpleRestrictionType;
import org.eclipse.daanse.xmla.model.ecore.schema.SimpleType;
...
import org.eclipse.daanse.xmla.model.ecore.schema.TypeDerivationControl;
import org.eclipse.daanse.xmla.model.ecore.schema.UnionType;
import org.eclipse.daanse.xmla.model.ecore.schema.UseType;
...
import org.eclipse.daanse.xmla.model.ecore.schema.util.SchemaValidator;
...
public class SchemaPackageImpl extends EPackageImpl implements SchemaPackage {
	 ...
	 * @see org.eclipse.daanse.xmla.model.ecore.schema.SchemaPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEAttribute(getComplexContentType_Mixed(), theXMLTypePackage.getBoolean(), "mixed", null, 0, 1, ComplexContentType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getComplexType_Mixed(), theXMLTypePackage.getBoolean(), "mixed", "false", 0, 1, ComplexType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getElement_Nillable(), theXMLTypePackage.getBoolean(), "nillable", "false", 0, 1, Element.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getElement_SubstitutionGroup(), theXMLTypePackage.getQName(), "substitutionGroup", null, 0, 1, Element.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getKeybase_Name(), theXMLTypePackage.getNCName(), "name", null, 1, 1, Keybase.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(keyrefTypeEClass, KeyrefType.class, "KeyrefType", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getKeyrefType_Refer(), theXMLTypePackage.getQName(), "refer", null, 1, 1, KeyrefType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
