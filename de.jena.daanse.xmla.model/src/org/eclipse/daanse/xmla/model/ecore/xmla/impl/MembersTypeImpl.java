 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla.impl.MembersTypeImpl#getMember <em>Member</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MembersTypeImpl extends MinimalEObjectImpl.Container implements MembersType {
	...
	protected EClass eStaticClass() {
		return XmlaPackage.Literals.MEMBERS_TYPE;
	}
	...
	public EList<String> getMember() {
		if (member == null) {
			member = new EDataTypeEList<String>(String.class, this, XmlaPackage.MEMBERS_TYPE__MEMBER);
		}
		return member;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case XmlaPackage.MEMBERS_TYPE__MEMBER:
				return getMember();
		}
