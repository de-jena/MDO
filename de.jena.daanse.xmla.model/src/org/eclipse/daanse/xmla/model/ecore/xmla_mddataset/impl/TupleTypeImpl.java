 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla_mddataset.impl.TupleTypeImpl#getMember <em>Member</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TupleTypeImpl extends MinimalEObjectImpl.Container implements TupleType {
	...
	protected EClass eStaticClass() {
		return Xmla_mddatasetPackage.Literals.TUPLE_TYPE;
	}
	...
	public EList<MemberType> getMember() {
		if (member == null) {
			member = new EObjectContainmentEList<MemberType>(MemberType.class, this, Xmla_mddatasetPackage.TUPLE_TYPE__MEMBER);
		}
		return member;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Xmla_mddatasetPackage.TUPLE_TYPE__MEMBER:
