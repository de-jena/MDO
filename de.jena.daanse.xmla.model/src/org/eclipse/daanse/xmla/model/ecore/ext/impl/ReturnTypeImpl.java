 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.daanse.xmla.model.ecore.ext.impl.ReturnTypeImpl#getSspiHandshake <em>Sspi Handshake</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReturnTypeImpl extends MinimalEObjectImpl.Container implements ReturnType {
	...
	protected EClass eStaticClass() {
		return ExtPackage.Literals.RETURN_TYPE;
	}
	...
	public void setSspiHandshake(byte[] newSspiHandshake) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExtPackage.RETURN_TYPE__SSPI_HANDSHAKE, oldSspiHandshake, sspiHandshake));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ExtPackage.RETURN_TYPE__SSPI_HANDSHAKE:
