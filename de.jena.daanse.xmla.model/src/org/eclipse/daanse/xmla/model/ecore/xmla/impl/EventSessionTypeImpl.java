...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Event Session Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla.impl.EventSessionTypeImpl#getTemplateCategory <em>Template Category</em>}</li>
 *   <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla.impl.EventSessionTypeImpl#getTemplateName <em>Template Name</em>}</li>
 *   <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla.impl.EventSessionTypeImpl#getTemplateDescription <em>Template Description</em>}</li>
 *   <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla.impl.EventSessionTypeImpl#getEvent <em>Event</em>}</li>
 *   <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla.impl.EventSessionTypeImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla.impl.EventSessionTypeImpl#getDispatchLatency <em>Dispatch Latency</em>}</li>
 *   <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla.impl.EventSessionTypeImpl#getEventRetentionMode <em>Event Retention Mode</em>}</li>
 *   <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla.impl.EventSessionTypeImpl#getMaxEventSize <em>Max Event Size</em>}</li>
 *   <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla.impl.EventSessionTypeImpl#getMaxMemory <em>Max Memory</em>}</li>
 *   <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla.impl.EventSessionTypeImpl#getMemoryPartitionMode <em>Memory Partition Mode</em>}</li>
 *   <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla.impl.EventSessionTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla.impl.EventSessionTypeImpl#isTrackCausality <em>Track Causality</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EventSessionTypeImpl extends MinimalEObjectImpl.Container implements EventSessionType {
	/**
	 ...
	 * @generated
	 */
	protected EventSessionTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return XmlaPackage.Literals.EVENT_SESSION_TYPE;
	}
	...
	public void setTemplateCategory(String newTemplateCategory) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XmlaPackage.EVENT_SESSION_TYPE__TEMPLATE_CATEGORY, oldTemplateCategory, templateCategory));
	}
	...
	public void setTemplateName(String newTemplateName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XmlaPackage.EVENT_SESSION_TYPE__TEMPLATE_NAME, oldTemplateName, templateName));
	}
	...
	public void setTemplateDescription(String newTemplateDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XmlaPackage.EVENT_SESSION_TYPE__TEMPLATE_DESCRIPTION, oldTemplateDescription, templateDescription));
	}
	...
	public EList<EObject> getEvent() {
		if (event == null) {
			event = new EObjectContainmentEList<EObject>(EObject.class, this, XmlaPackage.EVENT_SESSION_TYPE__EVENT);
		}
		return event;
	}
	...
	public EList<EObject> getTarget() {
		if (target == null) {
			target = new EObjectContainmentEList<EObject>(EObject.class, this, XmlaPackage.EVENT_SESSION_TYPE__TARGET);
		}
		return target;
	}
	...
	public void setDispatchLatency(long newDispatchLatency) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XmlaPackage.EVENT_SESSION_TYPE__DISPATCH_LATENCY, oldDispatchLatency, dispatchLatency, !oldDispatchLatencyESet));
	}
	...
	public void unsetDispatchLatency() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, XmlaPackage.EVENT_SESSION_TYPE__DISPATCH_LATENCY, oldDispatchLatency, DISPATCH_LATENCY_EDEFAULT, oldDispatchLatencyESet));
	}
	...
	public void setEventRetentionMode(RetentionModes newEventRetentionMode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XmlaPackage.EVENT_SESSION_TYPE__EVENT_RETENTION_MODE, oldEventRetentionMode, eventRetentionMode, !oldEventRetentionModeESet));
	}
	...
	public void unsetEventRetentionMode() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, XmlaPackage.EVENT_SESSION_TYPE__EVENT_RETENTION_MODE, oldEventRetentionMode, EVENT_RETENTION_MODE_EDEFAULT, oldEventRetentionModeESet));
	}
	...
	public void setMaxEventSize(long newMaxEventSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XmlaPackage.EVENT_SESSION_TYPE__MAX_EVENT_SIZE, oldMaxEventSize, maxEventSize, !oldMaxEventSizeESet));
	}
	...
	public void unsetMaxEventSize() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, XmlaPackage.EVENT_SESSION_TYPE__MAX_EVENT_SIZE, oldMaxEventSize, MAX_EVENT_SIZE_EDEFAULT, oldMaxEventSizeESet));
	}
	...
	public void setMaxMemory(BigInteger newMaxMemory) {
		...
		maxMemoryESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XmlaPackage.EVENT_SESSION_TYPE__MAX_MEMORY, oldMaxMemory, maxMemory, !oldMaxMemoryESet));
	}
	...
	public void unsetMaxMemory() {
		...
		maxMemoryESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, XmlaPackage.EVENT_SESSION_TYPE__MAX_MEMORY, oldMaxMemory, MAX_MEMORY_EDEFAULT, oldMaxMemoryESet));
	}
	...
	public void setMemoryPartitionMode(PartitionModes newMemoryPartitionMode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XmlaPackage.EVENT_SESSION_TYPE__MEMORY_PARTITION_MODE, oldMemoryPartitionMode, memoryPartitionMode, !oldMemoryPartitionModeESet));
	}
	...
	public void unsetMemoryPartitionMode() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, XmlaPackage.EVENT_SESSION_TYPE__MEMORY_PARTITION_MODE, oldMemoryPartitionMode, MEMORY_PARTITION_MODE_EDEFAULT, oldMemoryPartitionModeESet));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XmlaPackage.EVENT_SESSION_TYPE__NAME, oldName, name));
	}
	...
	public void setTrackCausality(boolean newTrackCausality) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XmlaPackage.EVENT_SESSION_TYPE__TRACK_CAUSALITY, oldTrackCausality, trackCausality, !oldTrackCausalityESet));
	}
	...
	public void unsetTrackCausality() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, XmlaPackage.EVENT_SESSION_TYPE__TRACK_CAUSALITY, oldTrackCausality, TRACK_CAUSALITY_EDEFAULT, oldTrackCausalityESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case XmlaPackage.EVENT_SESSION_TYPE__EVENT:
				return ((InternalEList<?>)getEvent()).basicRemove(otherEnd, msgs);
			case XmlaPackage.EVENT_SESSION_TYPE__TARGET:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case XmlaPackage.EVENT_SESSION_TYPE__TEMPLATE_CATEGORY:
				return getTemplateCategory();
			case XmlaPackage.EVENT_SESSION_TYPE__TEMPLATE_NAME:
				return getTemplateName();
			case XmlaPackage.EVENT_SESSION_TYPE__TEMPLATE_DESCRIPTION:
				return getTemplateDescription();
			case XmlaPackage.EVENT_SESSION_TYPE__EVENT:
				return getEvent();
			case XmlaPackage.EVENT_SESSION_TYPE__TARGET:
				return getTarget();
			case XmlaPackage.EVENT_SESSION_TYPE__DISPATCH_LATENCY:
				return getDispatchLatency();
			case XmlaPackage.EVENT_SESSION_TYPE__EVENT_RETENTION_MODE:
				return getEventRetentionMode();
			case XmlaPackage.EVENT_SESSION_TYPE__MAX_EVENT_SIZE:
				return getMaxEventSize();
			case XmlaPackage.EVENT_SESSION_TYPE__MAX_MEMORY:
				return getMaxMemory();
			case XmlaPackage.EVENT_SESSION_TYPE__MEMORY_PARTITION_MODE:
				return getMemoryPartitionMode();
			case XmlaPackage.EVENT_SESSION_TYPE__NAME:
				return getName();
			case XmlaPackage.EVENT_SESSION_TYPE__TRACK_CAUSALITY:
