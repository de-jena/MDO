...
import org.eclipse.daanse.xmla.model.ecore.engine400.Engine400Factory;
 ...
 * @generated
 */
public class Engine400PackageImpl extends EPackageImpl implements Engine400Package {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see org.eclipse.daanse.xmla.model.ecore.engine400.Engine400Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Engine400PackageImpl() {
		super(eNS_URI, Engine400Factory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link Engine400Package#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static Engine400Package init() {
		if (isInited) return (Engine400Package)EPackage.Registry.INSTANCE.getEPackage(Engine400Package.eNS_URI);

		// Obtain or create and register package
		Object registeredEngine400Package = EPackage.Registry.INSTANCE.get(eNS_URI);
		Engine400PackageImpl theEngine400Package = registeredEngine400Package instanceof Engine400PackageImpl ? (Engine400PackageImpl)registeredEngine400Package : new Engine400PackageImpl();
		...
		theEngine400Package.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Engine400Package.eNS_URI, theEngine400Package);
		return theEngine400Package;
	}
	 ...
	 * @generated
	 */
	public EAttribute getDocumentRoot_DefaultCompatibilityLevel() {
	 ...
	 * @generated
	 */
	public Engine400Factory getEngine400Factory() {
		return (Engine400Factory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(documentRootEClass, DOCUMENT_ROOT__DEFAULT_COMPATIBILITY_LEVEL);
	}
	...
	public void initializePackageContents() {
		...
		initEAttribute(getDocumentRoot_DefaultCompatibilityLevel(), theXMLTypePackage.getLong(), "defaultCompatibilityLevel", null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, IS_DERIVED, IS_ORDERED);
	...
	protected void createExtendedMetaDataAnnotations() {
		...
		addAnnotation
		  (getDocumentRoot_DefaultCompatibilityLevel(),
		   source,
		   new String[] {
			   "kind", "element",
