...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Request Type Type</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.eclipse.daanse.xmla.model.ecore.xmla.XmlaPackage#getRequestTypeType()
 * @model extendedMetaData="name='RequestType_._type'"
 * @generated
 */
public enum RequestTypeType implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Request Type Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final RequestTypeType[] VALUES_ARRAY =
		new RequestTypeType[] {
			DBSCHEMACATALOGS,
			MDSCHEMACUBES,
			MDSCHEMADIMENSIONS,
	...
	/**
	 * A public read-only list of all the '<em><b>Request Type Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<RequestTypeType> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Request Type Type</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static RequestTypeType get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			RequestTypeType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Request Type Type</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static RequestTypeType getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			RequestTypeType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Request Type Type</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static RequestTypeType get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private RequestTypeType(int value, String name, String literal) {
		this.value = value;
		this.name = name;
