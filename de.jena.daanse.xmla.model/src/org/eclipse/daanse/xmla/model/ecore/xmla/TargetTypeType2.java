...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Target Type Type2</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.eclipse.daanse.xmla.model.ecore.xmla.XmlaPackage#getTargetTypeType2()
 * @model extendedMetaData="name='TargetType_._2_._type'"
 * @generated
 */
public enum TargetTypeType2 implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Target Type Type2</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final TargetTypeType2[] VALUES_ARRAY =
		new TargetTypeType2[] {
			CUBE,
			CELLS,
			SET,
	...
	/**
	 * A public read-only list of all the '<em><b>Target Type Type2</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<TargetTypeType2> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Target Type Type2</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static TargetTypeType2 get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			TargetTypeType2 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Target Type Type2</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static TargetTypeType2 getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			TargetTypeType2 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Target Type Type2</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static TargetTypeType2 get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private TargetTypeType2(int value, String name, String literal) {
		this.value = value;
		this.name = name;
