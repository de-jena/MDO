 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla.impl.TranslationsTypeImpl#getTranslation <em>Translation</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TranslationsTypeImpl extends MinimalEObjectImpl.Container implements TranslationsType {
	...
	protected EClass eStaticClass() {
		return XmlaPackage.Literals.TRANSLATIONS_TYPE;
	}
	...
	public EList<Translation> getTranslation() {
		if (translation == null) {
			translation = new EObjectContainmentEList<Translation>(Translation.class, this, XmlaPackage.TRANSLATIONS_TYPE__TRANSLATION);
		}
		return translation;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case XmlaPackage.TRANSLATIONS_TYPE__TRANSLATION:
