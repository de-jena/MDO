...
import org.eclipse.daanse.xmla.model.ecore.engine600.Engine600Factory;
 ...
 * @generated
 */
public class Engine600PackageImpl extends EPackageImpl implements Engine600Package {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see org.eclipse.daanse.xmla.model.ecore.engine600.Engine600Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Engine600PackageImpl() {
		super(eNS_URI, Engine600Factory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link Engine600Package#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static Engine600Package init() {
		if (isInited) return (Engine600Package)EPackage.Registry.INSTANCE.getEPackage(Engine600Package.eNS_URI);

		// Obtain or create and register package
		Object registeredEngine600Package = EPackage.Registry.INSTANCE.get(eNS_URI);
		Engine600PackageImpl theEngine600Package = registeredEngine600Package instanceof Engine600PackageImpl ? (Engine600PackageImpl)registeredEngine600Package : new Engine600PackageImpl();
		...
		theEngine600Package.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Engine600Package.eNS_URI, theEngine600Package);
		return theEngine600Package;
	}
	 ...
	 * @generated
	 */
	public EAttribute getDocumentRoot_SupportedCompatibilityLevels() {
	 ...
	 * @generated
	 */
	public Engine600Factory getEngine600Factory() {
		return (Engine600Factory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(documentRootEClass, DOCUMENT_ROOT__SUPPORTED_COMPATIBILITY_LEVELS);
	}
	...
	public void initializePackageContents() {
		...
		initEAttribute(getDocumentRoot_SupportedCompatibilityLevels(), theXMLTypePackage.getString(), "supportedCompatibilityLevels", null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, IS_DERIVED, IS_ORDERED);
	...
	protected void createExtendedMetaDataAnnotations() {
		...
		addAnnotation
		  (getDocumentRoot_SupportedCompatibilityLevels(),
		   source,
		   new String[] {
			   "kind", "element",
