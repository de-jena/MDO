 ...
 * <!-- end-user-doc -->
 * @see org.eclipse.daanse.xmla.model.ecore.xmla.XmlaPackage#getTypeType()
...
public enum TypeType implements Enumerator {
	...
	/**
	 * The '<em><b>Writeback</b></em>' literal object.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #WRITEBACK_VALUE
	 * @generated
	 * @ordered
	 */
	WRITEBACK(1, "Writeback", "Writeback");
	...
	/**
	 * The '<em><b>Writeback</b></em>' literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #WRITEBACK
	 ...
	 * @ordered
	 */
	public static final int WRITEBACK_VALUE = 1;
	...
	public static TypeType get(int value) {
		switch (value) {
			...
			case WRITEBACK_VALUE: return WRITEBACK;
		}
		return null;
	}
