...
import org.eclipse.daanse.xmla.model.ecore.xmla_empty.Xmla_emptyFactory;
 ...
 * @generated
 */
public class Xmla_emptyPackageImpl extends EPackageImpl implements Xmla_emptyPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see org.eclipse.daanse.xmla.model.ecore.xmla_empty.Xmla_emptyPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Xmla_emptyPackageImpl() {
		super(eNS_URI, Xmla_emptyFactory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link Xmla_emptyPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static Xmla_emptyPackage init() {
		if (isInited) return (Xmla_emptyPackage)EPackage.Registry.INSTANCE.getEPackage(Xmla_emptyPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredXmla_emptyPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		Xmla_emptyPackageImpl theXmla_emptyPackage = registeredXmla_emptyPackage instanceof Xmla_emptyPackageImpl ? (Xmla_emptyPackageImpl)registeredXmla_emptyPackage : new Xmla_emptyPackageImpl();
		...
		theXmla_emptyPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Xmla_emptyPackage.eNS_URI, theXmla_emptyPackage);
		return theXmla_emptyPackage;
	}
	 ...
	 * @generated
	 */
	public EReference getEmptyresult_Exception() {
		return (EReference)emptyresultEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getEmptyresult_Messages() {
		return (EReference)emptyresultEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public Xmla_emptyFactory getXmla_emptyFactory() {
		return (Xmla_emptyFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		emptyresultEClass = createEClass(EMPTYRESULT);
		createEReference(emptyresultEClass, EMPTYRESULT__EXCEPTION);
		createEReference(emptyresultEClass, EMPTYRESULT__MESSAGES);
	...
	public void initializePackageContents() {
		...
		initEClass(emptyresultEClass, Emptyresult.class, "Emptyresult", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getEmptyresult_Exception(), theXmla_exceptionPackage.getException(), null, "exception", null, 0, 1, Emptyresult.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getEmptyresult_Messages(), theXmla_exceptionPackage.getMessages(), null, "messages", null, 0, 1, Emptyresult.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getDocumentRoot_Root(), this.getEmptyresult(), null, "root", null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
