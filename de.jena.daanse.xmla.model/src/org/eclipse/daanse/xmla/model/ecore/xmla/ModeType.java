 ...
 * <!-- end-user-doc -->
 * @see org.eclipse.daanse.xmla.model.ecore.xmla.XmlaPackage#getModeType()
 * @model extendedMetaData="name='Mode_._type'"
 * @generated
 */
public enum ModeType implements Enumerator {
	/**
	 * The '<em><b>Commit Shared</b></em>' literal object.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #COMMIT_SHARED_VALUE
	 * @generated
	 * @ordered
	 */
	COMMIT_SHARED(0, "CommitShared", "CommitShared"),

	/**
	 * The '<em><b>Commit Exclusive</b></em>' literal object.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #COMMIT_EXCLUSIVE_VALUE
	 * @generated
	 * @ordered
	 */
	COMMIT_EXCLUSIVE(1, "CommitExclusive", "CommitExclusive");

	/**
	 * The '<em><b>Commit Shared</b></em>' literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #COMMIT_SHARED
	 * @model name="CommitShared"
	 * @generated
	 * @ordered
	 */
	public static final int COMMIT_SHARED_VALUE = 0;

	/**
	 * The '<em><b>Commit Exclusive</b></em>' literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #COMMIT_EXCLUSIVE
	 * @model name="CommitExclusive"
	 * @generated
	 * @ordered
	 */
	public static final int COMMIT_EXCLUSIVE_VALUE = 1;
	...
	public static ModeType get(int value) {
		switch (value) {
			case COMMIT_SHARED_VALUE: return COMMIT_SHARED;
			case COMMIT_EXCLUSIVE_VALUE: return COMMIT_EXCLUSIVE;
		}
		return null;
	}
