 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.daanse.xmla.model.ecore.xmla.impl.PropertiesTypeImpl#getPropertyList <em>Property List</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PropertiesTypeImpl extends MinimalEObjectImpl.Container implements PropertiesType {
	...
	protected EClass eStaticClass() {
		return XmlaPackage.Literals.PROPERTIES_TYPE;
	}
	...
	public NotificationChain basicSetPropertyList(PropertyList newPropertyList, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XmlaPackage.PROPERTIES_TYPE__PROPERTY_LIST, oldPropertyList, newPropertyList);
	...
	public void setPropertyList(PropertyList newPropertyList) {
		if (newPropertyList != propertyList) {
			...
			if (propertyList != null)
				msgs = ((InternalEObject)propertyList).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - XmlaPackage.PROPERTIES_TYPE__PROPERTY_LIST, null, msgs);
			if (newPropertyList != null)
				msgs = ((InternalEObject)newPropertyList).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - XmlaPackage.PROPERTIES_TYPE__PROPERTY_LIST, null, msgs);
			msgs = basicSetPropertyList(newPropertyList, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XmlaPackage.PROPERTIES_TYPE__PROPERTY_LIST, newPropertyList, newPropertyList));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case XmlaPackage.PROPERTIES_TYPE__PROPERTY_LIST:
