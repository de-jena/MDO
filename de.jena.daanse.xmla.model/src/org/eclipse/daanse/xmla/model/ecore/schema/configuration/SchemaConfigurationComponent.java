/*
 */
package org.eclipse.daanse.xmla.model.ecore.schema.configuration;
 ...
 * @generated
 */
@Component(name="SchemaConfigurator", service= EPackageConfigurator.class)
@EMFModel(name=SchemaPackage.eNAME, nsURI={SchemaPackage.eNS_URI}, version="1.0.0")
@ProvideEMFModel(name = SchemaPackage.eNAME, nsURI = { SchemaPackage.eNS_URI }, version = "1.0.0")
public class SchemaConfigurationComponent implements EPackageConfigurator {
	private ServiceRegistration<?> packageRegistration = null;
	
	@Activate
	public void activate(BundleContext ctx) {
		SchemaPackage p = SchemaPackageImpl.init();
		if(p == null){
			p= SchemaPackageImpl.eINSTANCE;
			EPackage.Registry.INSTANCE.put(SchemaPackage.eNS_URI,p);
		}
		Dictionary<String, Object> properties = new Hashtable<String, Object>();
		properties.put(EMFNamespaces.EMF_MODEL_NAME, SchemaPackage.eNAME);
