 ...
 * </p>
 * <ul>
 *   <li>{@link de.jena.piveau.dcat.Dataset#getDistribution <em>Distribution</em>}</li>
 *   <li>{@link de.jena.piveau.dcat.Dataset#getSpatialResolutionInMeters <em>Spatial Resolution In Meters</em>}</li>
 *   <li>{@link de.jena.piveau.dcat.Dataset#getTemporalResolution <em>Temporal Resolution</em>}</li>
 *   <li>{@link de.jena.piveau.dcat.Dataset#getAccrualPeriodicity <em>Accrual Periodicity</em>}</li>
 *   <li>{@link de.jena.piveau.dcat.Dataset#getSpatial <em>Spatial</em>}</li>
 *   <li>{@link de.jena.piveau.dcat.Dataset#getTemporal <em>Temporal</em>}</li>
 *   <li>{@link de.jena.piveau.dcat.Dataset#getWasGeneratedBy <em>Was Generated By</em>}</li>
 *   <li>{@link de.jena.piveau.dcat.Dataset#getContributorID <em>Contributor ID</em>}</li>
 * </ul>
 *
 * @see de.jena.piveau.dcat.DcatPackage#getDataset()
...
public interface Dataset extends DcatResource {
	 ...
	 * @see de.jena.piveau.dcat.DcatPackage#getDataset_Distribution()
	 ...
	 * @see de.jena.piveau.dcat.DcatPackage#getDataset_SpatialResolutionInMeters()
	 ...
	 * @see de.jena.piveau.dcat.DcatPackage#getDataset_TemporalResolution()
	 ...
	 * @see de.jena.piveau.dcat.DcatPackage#getDataset_AccrualPeriodicity()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link de.jena.piveau.dcat.Dataset#getAccrualPeriodicity <em>Accrual Periodicity</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link de.jena.piveau.terms.Location}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Spatial</em>' containment reference list.
	 * @see de.jena.piveau.dcat.DcatPackage#getDataset_Spatial()
	 * @model containment="true"
	 ...
	 * The list contents are of type {@link de.jena.piveau.terms.PeriodOfTime}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Temporal</em>' containment reference list.
	 * @see de.jena.piveau.dcat.DcatPackage#getDataset_Temporal()
	 * @model containment="true"
	 ...
	 * @see de.jena.piveau.dcat.DcatPackage#getDataset_WasGeneratedBy()
	 ...
	 * @see de.jena.piveau.dcat.DcatPackage#getDataset_ContributorID()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link de.jena.piveau.dcat.Dataset#getContributorID <em>Contributor ID</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
