 ...
 * </p>
 * <ul>
 *   <li>{@link de.jena.piveau.dcat.impl.DistributionImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link de.jena.piveau.dcat.impl.DistributionImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link de.jena.piveau.dcat.impl.DistributionImpl#getAccessService <em>Access Service</em>}</li>
 *   <li>{@link de.jena.piveau.dcat.impl.DistributionImpl#getFormat <em>Format</em>}</li>
 *   <li>{@link de.jena.piveau.dcat.impl.DistributionImpl#getMediaType <em>Media Type</em>}</li>
 *   <li>{@link de.jena.piveau.dcat.impl.DistributionImpl#getPackageFormat <em>Package Format</em>}</li>
 *   <li>{@link de.jena.piveau.dcat.impl.DistributionImpl#getByteSize <em>Byte Size</em>}</li>
 *   <li>{@link de.jena.piveau.dcat.impl.DistributionImpl#getCompressFormat <em>Compress Format</em>}</li>
 *   <li>{@link de.jena.piveau.dcat.impl.DistributionImpl#getSpatialResolutionInMeters <em>Spatial Resolution In Meters</em>}</li>
 *   <li>{@link de.jena.piveau.dcat.impl.DistributionImpl#getTemporalResolution <em>Temporal Resolution</em>}</li>
 *   <li>{@link de.jena.piveau.dcat.impl.DistributionImpl#getAccessRights <em>Access Rights</em>}</li>
 *   <li>{@link de.jena.piveau.dcat.impl.DistributionImpl#getLicense <em>License</em>}</li>
 *   <li>{@link de.jena.piveau.dcat.impl.DistributionImpl#getConformsTo <em>Conforms To</em>}</li>
 *   <li>{@link de.jena.piveau.dcat.impl.DistributionImpl#getRights <em>Rights</em>}</li>
 *   <li>{@link de.jena.piveau.dcat.impl.DistributionImpl#getHasPolicy <em>Has Policy</em>}</li>
 *   <li>{@link de.jena.piveau.dcat.impl.DistributionImpl#getIssued <em>Issued</em>}</li>
 *   <li>{@link de.jena.piveau.dcat.impl.DistributionImpl#getModified <em>Modified</em>}</li>
 *   <li>{@link de.jena.piveau.dcat.impl.DistributionImpl#getNodeID <em>Node ID</em>}</li>
 *   <li>{@link de.jena.piveau.dcat.impl.DistributionImpl#getDownloadURL <em>Download URL</em>}</li>
 *   <li>{@link de.jena.piveau.dcat.impl.DistributionImpl#getAccessURL <em>Access URL</em>}</li>
 *   <li>{@link de.jena.piveau.dcat.impl.DistributionImpl#getLicenseAttributionByText <em>License Attribution By Text</em>}</li>
 * </ul>
 *
 * @generated
 */
