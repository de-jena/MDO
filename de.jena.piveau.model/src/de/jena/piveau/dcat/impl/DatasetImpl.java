 ...
 * </p>
 * <ul>
 *   <li>{@link de.jena.piveau.dcat.impl.DatasetImpl#getDistribution <em>Distribution</em>}</li>
 *   <li>{@link de.jena.piveau.dcat.impl.DatasetImpl#getSpatialResolutionInMeters <em>Spatial Resolution In Meters</em>}</li>
 *   <li>{@link de.jena.piveau.dcat.impl.DatasetImpl#getTemporalResolution <em>Temporal Resolution</em>}</li>
 *   <li>{@link de.jena.piveau.dcat.impl.DatasetImpl#getAccrualPeriodicity <em>Accrual Periodicity</em>}</li>
 *   <li>{@link de.jena.piveau.dcat.impl.DatasetImpl#getSpatial <em>Spatial</em>}</li>
 *   <li>{@link de.jena.piveau.dcat.impl.DatasetImpl#getTemporal <em>Temporal</em>}</li>
 *   <li>{@link de.jena.piveau.dcat.impl.DatasetImpl#getWasGeneratedBy <em>Was Generated By</em>}</li>
 *   <li>{@link de.jena.piveau.dcat.impl.DatasetImpl#getContributorID <em>Contributor ID</em>}</li>
 * </ul>
 *
 * @generated
 */
