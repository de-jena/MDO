...
import de.jena.piveau.dcat.DcatResource;
 ...
 * </p>
 * <ul>
 *   <li>{@link de.jena.piveau.dcat.impl.DcatResourceImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link de.jena.piveau.dcat.impl.DcatResourceImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link de.jena.piveau.dcat.impl.DcatResourceImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link de.jena.piveau.dcat.impl.DcatResourceImpl#getTheme <em>Theme</em>}</li>
 *   <li>{@link de.jena.piveau.dcat.impl.DcatResourceImpl#getKeyword <em>Keyword</em>}</li>
 *   <li>{@link de.jena.piveau.dcat.impl.DcatResourceImpl#getType <em>Type</em>}</li>
 *   <li>{@link de.jena.piveau.dcat.impl.DcatResourceImpl#getContactPoint <em>Contact Point</em>}</li>
 *   <li>{@link de.jena.piveau.dcat.impl.DcatResourceImpl#getCreator <em>Creator</em>}</li>
 *   <li>{@link de.jena.piveau.dcat.impl.DcatResourceImpl#getPublisher <em>Publisher</em>}</li>
 *   <li>{@link de.jena.piveau.dcat.impl.DcatResourceImpl#getIssued <em>Issued</em>}</li>
 *   <li>{@link de.jena.piveau.dcat.impl.DcatResourceImpl#getModified <em>Modified</em>}</li>
 *   <li>{@link de.jena.piveau.dcat.impl.DcatResourceImpl#getLandingPage <em>Landing Page</em>}</li>
 *   <li>{@link de.jena.piveau.dcat.impl.DcatResourceImpl#getAccessRights <em>Access Rights</em>}</li>
 *   <li>{@link de.jena.piveau.dcat.impl.DcatResourceImpl#getConformsTo <em>Conforms To</em>}</li>
 *   <li>{@link de.jena.piveau.dcat.impl.DcatResourceImpl#getLicense <em>License</em>}</li>
 *   <li>{@link de.jena.piveau.dcat.impl.DcatResourceImpl#getRights <em>Rights</em>}</li>
 *   <li>{@link de.jena.piveau.dcat.impl.DcatResourceImpl#getHasPolicy <em>Has Policy</em>}</li>
 *   <li>{@link de.jena.piveau.dcat.impl.DcatResourceImpl#getQualifiedAttribution <em>Qualified Attribution</em>}</li>
 *   <li>{@link de.jena.piveau.dcat.impl.DcatResourceImpl#getRelation <em>Relation</em>}</li>
 *   <li>{@link de.jena.piveau.dcat.impl.DcatResourceImpl#getQualifiedRelation <em>Qualified Relation</em>}</li>
 *   <li>{@link de.jena.piveau.dcat.impl.DcatResourceImpl#getIsReferencedBy <em>Is Referenced By</em>}</li>
 *   <li>{@link de.jena.piveau.dcat.impl.DcatResourceImpl#getLanguage <em>Language</em>}</li>
 * </ul>
 *
 * @generated
 */
