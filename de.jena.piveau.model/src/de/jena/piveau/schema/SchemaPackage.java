 ...
 */
@ProviderType
@EPackage(uri = SchemaPackage.eNS_URI, genModel = "/model/dcatap.genmodel", genModelSourceLocations = {"model/dcatap.genmodel","de.jena.piveau.model/model/dcatap.genmodel"}, ecore="/model/schema.ecore", ecoreSourceLocations="/model/schema.ecore")
