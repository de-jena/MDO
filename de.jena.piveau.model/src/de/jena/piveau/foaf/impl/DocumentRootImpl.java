...
import de.jena.piveau.foaf.DocumentRoot;
 ...
 * </p>
 * <ul>
 *   <li>{@link de.jena.piveau.foaf.impl.DocumentRootImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link de.jena.piveau.foaf.impl.DocumentRootImpl#getXMLNSPrefixMap <em>XMLNS Prefix Map</em>}</li>
 *   <li>{@link de.jena.piveau.foaf.impl.DocumentRootImpl#getXSISchemaLocation <em>XSI Schema Location</em>}</li>
 *   <li>{@link de.jena.piveau.foaf.impl.DocumentRootImpl#getHomepage <em>Homepage</em>}</li>
 *   <li>{@link de.jena.piveau.foaf.impl.DocumentRootImpl#getMbox <em>Mbox</em>}</li>
 *   <li>{@link de.jena.piveau.foaf.impl.DocumentRootImpl#getName <em>Name</em>}</li>
 *   <li>{@link de.jena.piveau.foaf.impl.DocumentRootImpl#getPage <em>Page</em>}</li>
 *   <li>{@link de.jena.piveau.foaf.impl.DocumentRootImpl#getPhone <em>Phone</em>}</li>
 *   <li>{@link de.jena.piveau.foaf.impl.DocumentRootImpl#getPrimaryTopic <em>Primary Topic</em>}</li>
 *   <li>{@link de.jena.piveau.foaf.impl.DocumentRootImpl#getOrganisation <em>Organisation</em>}</li>
 *   <li>{@link de.jena.piveau.foaf.impl.DocumentRootImpl#getPerson <em>Person</em>}</li>
 * </ul>
 *
 * @generated
 */
