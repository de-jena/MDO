 ...
 * </p>
 * <ul>
 *   <li>{@link de.jena.piveau.vcard.impl.OrganizationTypeImpl#getFn <em>Fn</em>}</li>
 *   <li>{@link de.jena.piveau.vcard.impl.OrganizationTypeImpl#getOrganizationName <em>Organization Name</em>}</li>
 *   <li>{@link de.jena.piveau.vcard.impl.OrganizationTypeImpl#getHasAddress <em>Has Address</em>}</li>
 *   <li>{@link de.jena.piveau.vcard.impl.OrganizationTypeImpl#getHasEmail <em>Has Email</em>}</li>
 *   <li>{@link de.jena.piveau.vcard.impl.OrganizationTypeImpl#getHasURL <em>Has URL</em>}</li>
 *   <li>{@link de.jena.piveau.vcard.impl.OrganizationTypeImpl#getHasTelephone <em>Has Telephone</em>}</li>
 *   <li>{@link de.jena.piveau.vcard.impl.OrganizationTypeImpl#getAbout <em>About</em>}</li>
 *   <li>{@link de.jena.piveau.vcard.impl.OrganizationTypeImpl#getNodeID <em>Node ID</em>}</li>
 * </ul>
 *
 * @generated
 */
