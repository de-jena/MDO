 ...
 * </p>
 * <ul>
 *   <li>{@link de.jena.piveau.vcard.AddressType#getStreetAddress <em>Street Address</em>}</li>
 *   <li>{@link de.jena.piveau.vcard.AddressType#getLocality <em>Locality</em>}</li>
 *   <li>{@link de.jena.piveau.vcard.AddressType#getPostalCode <em>Postal Code</em>}</li>
 *   <li>{@link de.jena.piveau.vcard.AddressType#getCountryName <em>Country Name</em>}</li>
 *   <li>{@link de.jena.piveau.vcard.AddressType#getAbout <em>About</em>}</li>
 *   <li>{@link de.jena.piveau.vcard.AddressType#getNodeID <em>Node ID</em>}</li>
 * </ul>
 *
 * @see de.jena.piveau.vcard.VcardPackage#getAddressType()
...
public interface AddressType extends EObject {
	 ...
	 * @see de.jena.piveau.vcard.VcardPackage#getAddressType_StreetAddress()
	...
	/**
	 * Sets the value of the '{@link de.jena.piveau.vcard.AddressType#getStreetAddress <em>Street Address</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.jena.piveau.vcard.VcardPackage#getAddressType_Locality()
	 * @model dataType="org.eclipse.emf.ecore.xml.type.String" required="true"
	...
	/**
	 * Sets the value of the '{@link de.jena.piveau.vcard.AddressType#getLocality <em>Locality</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.jena.piveau.vcard.VcardPackage#getAddressType_PostalCode()
	 * @model dataType="org.eclipse.emf.ecore.xml.type.String" required="true"
	...
	/**
	 * Sets the value of the '{@link de.jena.piveau.vcard.AddressType#getPostalCode <em>Postal Code</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.jena.piveau.vcard.VcardPackage#getAddressType_CountryName()
	...
	/**
	 * Sets the value of the '{@link de.jena.piveau.vcard.AddressType#getCountryName <em>Country Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setAbout(String)
	 * @see de.jena.piveau.vcard.VcardPackage#getAddressType_About()
	...
	/**
	 * Sets the value of the '{@link de.jena.piveau.vcard.AddressType#getAbout <em>About</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.jena.piveau.vcard.VcardPackage#getAddressType_NodeID()
	...
	/**
	 * Sets the value of the '{@link de.jena.piveau.vcard.AddressType#getNodeID <em>Node ID</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
