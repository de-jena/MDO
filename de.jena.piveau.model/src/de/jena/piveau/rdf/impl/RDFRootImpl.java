 ...
 * </p>
 * <ul>
 *   <li>{@link de.jena.piveau.rdf.impl.RDFRootImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link de.jena.piveau.rdf.impl.RDFRootImpl#getXMLNSPrefixMap <em>XMLNS Prefix Map</em>}</li>
 *   <li>{@link de.jena.piveau.rdf.impl.RDFRootImpl#getXSISchemaLocation <em>XSI Schema Location</em>}</li>
 *   <li>{@link de.jena.piveau.rdf.impl.RDFRootImpl#getType <em>Type</em>}</li>
 *   <li>{@link de.jena.piveau.rdf.impl.RDFRootImpl#getAbout <em>About</em>}</li>
 *   <li>{@link de.jena.piveau.rdf.impl.RDFRootImpl#getDatatype <em>Datatype</em>}</li>
 *   <li>{@link de.jena.piveau.rdf.impl.RDFRootImpl#getNodeID <em>Node ID</em>}</li>
 *   <li>{@link de.jena.piveau.rdf.impl.RDFRootImpl#getResource <em>Resource</em>}</li>
 *   <li>{@link de.jena.piveau.rdf.impl.RDFRootImpl#getRDF <em>RDF</em>}</li>
 * </ul>
 *
 * @generated
 */
