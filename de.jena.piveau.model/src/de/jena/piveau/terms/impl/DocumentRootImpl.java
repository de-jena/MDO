...
import de.jena.piveau.terms.DocumentRoot;
import de.jena.piveau.terms.LicenseDocument;
import de.jena.piveau.terms.Location;
import de.jena.piveau.terms.PeriodOfTime;
import de.jena.piveau.terms.ProvenanceStatement;
 ...
 * </p>
 * <ul>
 *   <li>{@link de.jena.piveau.terms.impl.DocumentRootImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link de.jena.piveau.terms.impl.DocumentRootImpl#getXMLNSPrefixMap <em>XMLNS Prefix Map</em>}</li>
 *   <li>{@link de.jena.piveau.terms.impl.DocumentRootImpl#getXSISchemaLocation <em>XSI Schema Location</em>}</li>
 *   <li>{@link de.jena.piveau.terms.impl.DocumentRootImpl#getAbstract <em>Abstract</em>}</li>
 *   <li>{@link de.jena.piveau.terms.impl.DocumentRootImpl#getAccessRights <em>Access Rights</em>}</li>
 *   <li>{@link de.jena.piveau.terms.impl.DocumentRootImpl#getAccrualMethod <em>Accrual Method</em>}</li>
 *   <li>{@link de.jena.piveau.terms.impl.DocumentRootImpl#getAccrualPeriodicity <em>Accrual Periodicity</em>}</li>
 *   <li>{@link de.jena.piveau.terms.impl.DocumentRootImpl#getAccrualPolicy <em>Accrual Policy</em>}</li>
 *   <li>{@link de.jena.piveau.terms.impl.DocumentRootImpl#getAlternative <em>Alternative</em>}</li>
 *   <li>{@link de.jena.piveau.terms.impl.DocumentRootImpl#getAudience <em>Audience</em>}</li>
 *   <li>{@link de.jena.piveau.terms.impl.DocumentRootImpl#getAvailable <em>Available</em>}</li>
 *   <li>{@link de.jena.piveau.terms.impl.DocumentRootImpl#getBibliographicCitation <em>Bibliographic Citation</em>}</li>
 *   <li>{@link de.jena.piveau.terms.impl.DocumentRootImpl#getConformsTo <em>Conforms To</em>}</li>
 *   <li>{@link de.jena.piveau.terms.impl.DocumentRootImpl#getCreated <em>Created</em>}</li>
 *   <li>{@link de.jena.piveau.terms.impl.DocumentRootImpl#getCreator <em>Creator</em>}</li>
 *   <li>{@link de.jena.piveau.terms.impl.DocumentRootImpl#getDateAccepted <em>Date Accepted</em>}</li>
 *   <li>{@link de.jena.piveau.terms.impl.DocumentRootImpl#getDateCopyrighted <em>Date Copyrighted</em>}</li>
 *   <li>{@link de.jena.piveau.terms.impl.DocumentRootImpl#getDateSubmitted <em>Date Submitted</em>}</li>
 *   <li>{@link de.jena.piveau.terms.impl.DocumentRootImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link de.jena.piveau.terms.impl.DocumentRootImpl#getEducationLevel <em>Education Level</em>}</li>
 *   <li>{@link de.jena.piveau.terms.impl.DocumentRootImpl#getExtent <em>Extent</em>}</li>
 *   <li>{@link de.jena.piveau.terms.impl.DocumentRootImpl#getFormat <em>Format</em>}</li>
 *   <li>{@link de.jena.piveau.terms.impl.DocumentRootImpl#getHasFormat <em>Has Format</em>}</li>
 *   <li>{@link de.jena.piveau.terms.impl.DocumentRootImpl#getHasPart <em>Has Part</em>}</li>
 *   <li>{@link de.jena.piveau.terms.impl.DocumentRootImpl#getHasVersion <em>Has Version</em>}</li>
 *   <li>{@link de.jena.piveau.terms.impl.DocumentRootImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link de.jena.piveau.terms.impl.DocumentRootImpl#getInstructionalMethod <em>Instructional Method</em>}</li>
 *   <li>{@link de.jena.piveau.terms.impl.DocumentRootImpl#getIsFormatOf <em>Is Format Of</em>}</li>
 *   <li>{@link de.jena.piveau.terms.impl.DocumentRootImpl#getIsPartOf <em>Is Part Of</em>}</li>
 *   <li>{@link de.jena.piveau.terms.impl.DocumentRootImpl#getIsReferencedBy <em>Is Referenced By</em>}</li>
 *   <li>{@link de.jena.piveau.terms.impl.DocumentRootImpl#getIsReplacedBy <em>Is Replaced By</em>}</li>
 *   <li>{@link de.jena.piveau.terms.impl.DocumentRootImpl#getIsRequiredBy <em>Is Required By</em>}</li>
 *   <li>{@link de.jena.piveau.terms.impl.DocumentRootImpl#getIssued <em>Issued</em>}</li>
 *   <li>{@link de.jena.piveau.terms.impl.DocumentRootImpl#getIsVersionOf <em>Is Version Of</em>}</li>
 *   <li>{@link de.jena.piveau.terms.impl.DocumentRootImpl#getLanguage <em>Language</em>}</li>
 *   <li>{@link de.jena.piveau.terms.impl.DocumentRootImpl#getLicense <em>License</em>}</li>
 *   <li>{@link de.jena.piveau.terms.impl.DocumentRootImpl#getMediator <em>Mediator</em>}</li>
 *   <li>{@link de.jena.piveau.terms.impl.DocumentRootImpl#getMedium <em>Medium</em>}</li>
 *   <li>{@link de.jena.piveau.terms.impl.DocumentRootImpl#getModified <em>Modified</em>}</li>
 *   <li>{@link de.jena.piveau.terms.impl.DocumentRootImpl#getProvenance <em>Provenance</em>}</li>
 *   <li>{@link de.jena.piveau.terms.impl.DocumentRootImpl#getPublisher <em>Publisher</em>}</li>
 *   <li>{@link de.jena.piveau.terms.impl.DocumentRootImpl#getReferences <em>References</em>}</li>
 *   <li>{@link de.jena.piveau.terms.impl.DocumentRootImpl#getRelation <em>Relation</em>}</li>
 *   <li>{@link de.jena.piveau.terms.impl.DocumentRootImpl#getReplaces <em>Replaces</em>}</li>
 *   <li>{@link de.jena.piveau.terms.impl.DocumentRootImpl#getRequires <em>Requires</em>}</li>
 *   <li>{@link de.jena.piveau.terms.impl.DocumentRootImpl#getRights <em>Rights</em>}</li>
 *   <li>{@link de.jena.piveau.terms.impl.DocumentRootImpl#getRightsHolder <em>Rights Holder</em>}</li>
 *   <li>{@link de.jena.piveau.terms.impl.DocumentRootImpl#getSource <em>Source</em>}</li>
 *   <li>{@link de.jena.piveau.terms.impl.DocumentRootImpl#getSpatial <em>Spatial</em>}</li>
 *   <li>{@link de.jena.piveau.terms.impl.DocumentRootImpl#getTableOfContents <em>Table Of Contents</em>}</li>
 *   <li>{@link de.jena.piveau.terms.impl.DocumentRootImpl#getTemporal <em>Temporal</em>}</li>
 *   <li>{@link de.jena.piveau.terms.impl.DocumentRootImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link de.jena.piveau.terms.impl.DocumentRootImpl#getType <em>Type</em>}</li>
 *   <li>{@link de.jena.piveau.terms.impl.DocumentRootImpl#getValid <em>Valid</em>}</li>
 * </ul>
 *
 * @generated
 */
