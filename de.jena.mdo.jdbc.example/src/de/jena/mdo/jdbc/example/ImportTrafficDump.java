...
public class ImportTrafficDump extends AbstractImportDump implements DerbyDataImporter {
	 ...
	 * (non-Javadoc)
	 *
	 * @see de.jena.mdo.jdbc.example.AbstractImportDump#executeStatement(java.sql.
	 * Connection)
	 */
	@Override
	 ...
	 *
	 * @see
	 * de.jena.mdo.jdbc.example.AbstractImportDump#createTables(java.sql.Connection)
	 */
	@Override
	void createTables(Connection derby) throws SQLException {
		...
		derby.createStatement().execute("CREATE TABLE \"EDGE\" (\n" + "	\"ID\"	INTEGER,\n"
				+ "	\"FROMPOINTID\"	INTEGER,\n" + "	\"TOPOINTID\"	INTEGER,\n" + "	PRIMARY KEY(\"ID\")\n" + ")");
		derby.createStatement()
				.execute("CREATE TABLE \"EDGEITEM\" (\n" + "	\"EDGEID\"	INTEGER,\n" + "	\"INDEX\"	INTEGER,\n"
