...
public class GithubSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case GithubPackage.GITHUB_WEBHOOK: {
				GithubWebhook githubWebhook = (GithubWebhook)theEObject;
				T result = caseGithubWebhook(githubWebhook);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GithubPackage.PAYLOAD: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Webhook</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Webhook</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseGithubWebhook(GithubWebhook object) {
		return null;
	}
