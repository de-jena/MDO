...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Short Trip Stop Structure</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.jena.mdo.ibis.common.impl.ShortTripStopStructureImpl#getJourneyStopInformation <em>Journey Stop Information</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.common.impl.ShortTripStopStructureImpl#getFareZoneInformation <em>Fare Zone Information</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ShortTripStopStructureImpl extends MinimalEObjectImpl.Container implements ShortTripStopStructure {
	/**
	 ...
	 * @generated
	 */
	protected ShortTripStopStructureImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return IbisCommonPackage.eINSTANCE.getShortTripStopStructure();
	}
	...
	public NotificationChain basicSetJourneyStopInformation(JourneyStopInformationStructure newJourneyStopInformation, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisCommonPackage.SHORT_TRIP_STOP_STRUCTURE__JOURNEY_STOP_INFORMATION, oldJourneyStopInformation, newJourneyStopInformation);
	...
	public void setJourneyStopInformation(JourneyStopInformationStructure newJourneyStopInformation) {
		if (newJourneyStopInformation != journeyStopInformation) {
			...
			if (journeyStopInformation != null)
				msgs = ((InternalEObject)journeyStopInformation).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.SHORT_TRIP_STOP_STRUCTURE__JOURNEY_STOP_INFORMATION, null, msgs);
			if (newJourneyStopInformation != null)
				msgs = ((InternalEObject)newJourneyStopInformation).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.SHORT_TRIP_STOP_STRUCTURE__JOURNEY_STOP_INFORMATION, null, msgs);
			msgs = basicSetJourneyStopInformation(newJourneyStopInformation, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCommonPackage.SHORT_TRIP_STOP_STRUCTURE__JOURNEY_STOP_INFORMATION, newJourneyStopInformation, newJourneyStopInformation));
	}
	...
	public NotificationChain basicSetFareZoneInformation(FareZoneInformationStructure newFareZoneInformation, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisCommonPackage.SHORT_TRIP_STOP_STRUCTURE__FARE_ZONE_INFORMATION, oldFareZoneInformation, newFareZoneInformation);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setFareZoneInformation(FareZoneInformationStructure newFareZoneInformation) {
		if (newFareZoneInformation != fareZoneInformation) {
			...
			if (fareZoneInformation != null)
				msgs = ((InternalEObject)fareZoneInformation).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.SHORT_TRIP_STOP_STRUCTURE__FARE_ZONE_INFORMATION, null, msgs);
			if (newFareZoneInformation != null)
				msgs = ((InternalEObject)newFareZoneInformation).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.SHORT_TRIP_STOP_STRUCTURE__FARE_ZONE_INFORMATION, null, msgs);
			msgs = basicSetFareZoneInformation(newFareZoneInformation, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCommonPackage.SHORT_TRIP_STOP_STRUCTURE__FARE_ZONE_INFORMATION, newFareZoneInformation, newFareZoneInformation));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case IbisCommonPackage.SHORT_TRIP_STOP_STRUCTURE__JOURNEY_STOP_INFORMATION:
				return basicSetJourneyStopInformation(null, msgs);
			case IbisCommonPackage.SHORT_TRIP_STOP_STRUCTURE__FARE_ZONE_INFORMATION:
