 ...
 * </p>
 * <ul>
 *   <li>{@link de.jena.mdo.ibis.common.impl.NetexModeImpl#getPtMainMode <em>Pt Main Mode</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.common.impl.NetexModeImpl#getPrivateMainMode <em>Private Main Mode</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.common.impl.NetexModeImpl#getAirSubmode <em>Air Submode</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.common.impl.NetexModeImpl#getBusSubmode <em>Bus Submode</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.common.impl.NetexModeImpl#getCoachSubmode <em>Coach Submode</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.common.impl.NetexModeImpl#getFunicularSubmode <em>Funicular Submode</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.common.impl.NetexModeImpl#getMetroSubmode <em>Metro Submode</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.common.impl.NetexModeImpl#getTramSubmode <em>Tram Submode</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.common.impl.NetexModeImpl#getTelecabinSubmode <em>Telecabin Submode</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.common.impl.NetexModeImpl#getRailSubmode <em>Rail Submode</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.common.impl.NetexModeImpl#getWaterSubmode <em>Water Submode</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.common.impl.NetexModeImpl#getTaxiSubmode <em>Taxi Submode</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.common.impl.NetexModeImpl#getSelfDriveSubmode <em>Self Drive Submode</em>}</li>
 * </ul>
 *
 * @generated
 */
