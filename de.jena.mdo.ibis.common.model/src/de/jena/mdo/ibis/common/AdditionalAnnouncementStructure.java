...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Additional Announcement Structure</b></em>'.
 * <!-- end-user-doc -->
 *
 * <!-- begin-model-doc -->
 ...
 * </p>
 * <ul>
 *   <li>{@link de.jena.mdo.ibis.common.AdditionalAnnouncementStructure#getAnnouncementRef <em>Announcement Ref</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.common.AdditionalAnnouncementStructure#getAnnouncementText <em>Announcement Text</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.common.AdditionalAnnouncementStructure#getAnnouncementTTSText <em>Announcement TTS Text</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.common.AdditionalAnnouncementStructure#getImmediateInformation <em>Immediate Information</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.common.AdditionalAnnouncementStructure#getPeriodicalInformation <em>Periodical Information</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.common.AdditionalAnnouncementStructure#getSpecificPoint <em>Specific Point</em>}</li>
 * </ul>
 *
 * @see de.jena.mdo.ibis.common.IbisCommonPackage#getAdditionalAnnouncementStructure()
 * @model extendedMetaData="name='AdditionalAnnouncementStructure' kind='elementOnly'"
 * @generated
 */
@ProviderType
public interface AdditionalAnnouncementStructure extends EObject {
	/**
	 ...
	 * @see de.jena.mdo.ibis.common.IbisCommonPackage#getAdditionalAnnouncementStructure_AnnouncementRef()
	...
	/**
	 * Sets the value of the '{@link de.jena.mdo.ibis.common.AdditionalAnnouncementStructure#getAnnouncementRef <em>Announcement Ref</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.jena.mdo.ibis.common.IbisCommonPackage#getAdditionalAnnouncementStructure_AnnouncementText()
	 ...
	 * @see de.jena.mdo.ibis.common.IbisCommonPackage#getAdditionalAnnouncementStructure_AnnouncementTTSText()
	 * @model containment="true"
	 ...
	 * @see de.jena.mdo.ibis.common.IbisCommonPackage#getAdditionalAnnouncementStructure_ImmediateInformation()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link de.jena.mdo.ibis.common.AdditionalAnnouncementStructure#getImmediateInformation <em>Immediate Information</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.jena.mdo.ibis.common.IbisCommonPackage#getAdditionalAnnouncementStructure_PeriodicalInformation()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link de.jena.mdo.ibis.common.AdditionalAnnouncementStructure#getPeriodicalInformation <em>Periodical Information</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setSpecificPoint(SpecificPointStructure)
	 * @see de.jena.mdo.ibis.common.IbisCommonPackage#getAdditionalAnnouncementStructure_SpecificPoint()
	 * @model containment="true"
	 *        extendedMetaData="kind='element' name='SpecificPoint' namespace='##targetNamespace'"
	 * @generated
	 */
	SpecificPointStructure getSpecificPoint();

	/**
	 * Sets the value of the '{@link de.jena.mdo.ibis.common.AdditionalAnnouncementStructure#getSpecificPoint <em>Specific Point</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	void setSpecificPoint(SpecificPointStructure value);

} // AdditionalAnnouncementStructure
