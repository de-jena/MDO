...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Via Point Structure</b></em>'.
 * <!-- end-user-doc -->
 *
 * <!-- begin-model-doc -->
 ...
 * </p>
 * <ul>
 *   <li>{@link de.jena.mdo.ibis.common.ViaPointStructure#getViaPointRef <em>Via Point Ref</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.common.ViaPointStructure#getPlaceRef <em>Place Ref</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.common.ViaPointStructure#getPlaceName <em>Place Name</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.common.ViaPointStructure#getPlaceShortName <em>Place Short Name</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.common.ViaPointStructure#getViaPointDisplayPriority <em>Via Point Display Priority</em>}</li>
 * </ul>
 *
 * @see de.jena.mdo.ibis.common.IbisCommonPackage#getViaPointStructure()
 * @model extendedMetaData="name='ViaPointStructure' kind='elementOnly'"
 * @generated
 */
@ProviderType
public interface ViaPointStructure extends EObject {
	/**
	 ...
	 * @see de.jena.mdo.ibis.common.IbisCommonPackage#getViaPointStructure_ViaPointRef()
	...
	/**
	 * Sets the value of the '{@link de.jena.mdo.ibis.common.ViaPointStructure#getViaPointRef <em>Via Point Ref</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.jena.mdo.ibis.common.IbisCommonPackage#getViaPointStructure_PlaceRef()
	...
	/**
	 * Sets the value of the '{@link de.jena.mdo.ibis.common.ViaPointStructure#getPlaceRef <em>Place Ref</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.jena.mdo.ibis.common.IbisCommonPackage#getViaPointStructure_PlaceName()
	 * @model containment="true"
	 ...
	 * @see de.jena.mdo.ibis.common.IbisCommonPackage#getViaPointStructure_PlaceShortName()
	 * @model containment="true"
	 ...
	 * @see de.jena.mdo.ibis.common.IbisCommonPackage#getViaPointStructure_ViaPointDisplayPriority()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link de.jena.mdo.ibis.common.ViaPointStructure#getViaPointDisplayPriority <em>Via Point Display Priority</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
