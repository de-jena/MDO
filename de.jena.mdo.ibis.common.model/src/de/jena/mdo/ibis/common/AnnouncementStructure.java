...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Announcement Structure</b></em>'.
 * <!-- end-user-doc -->
 *
 * <!-- begin-model-doc -->
 ...
 * </p>
 * <ul>
 *   <li>{@link de.jena.mdo.ibis.common.AnnouncementStructure#getAnnouncementRef <em>Announcement Ref</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.common.AnnouncementStructure#getAnnouncementText <em>Announcement Text</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.common.AnnouncementStructure#getAnnouncementTTSText <em>Announcement TTS Text</em>}</li>
 * </ul>
 *
 * @see de.jena.mdo.ibis.common.IbisCommonPackage#getAnnouncementStructure()
 * @model extendedMetaData="name='AnnouncementStructure' kind='elementOnly'"
 * @generated
 */
@ProviderType
public interface AnnouncementStructure extends EObject {
	/**
	 ...
	 * @see de.jena.mdo.ibis.common.IbisCommonPackage#getAnnouncementStructure_AnnouncementRef()
	...
	/**
	 * Sets the value of the '{@link de.jena.mdo.ibis.common.AnnouncementStructure#getAnnouncementRef <em>Announcement Ref</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.jena.mdo.ibis.common.IbisCommonPackage#getAnnouncementStructure_AnnouncementText()
	 ...
	 * @see de.jena.mdo.ibis.common.IbisCommonPackage#getAnnouncementStructure_AnnouncementTTSText()
	 * @model containment="true"
