...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>TSP Point</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 ...
 * </p>
 * <ul>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.TSPPoint#getTSPPointRef <em>TSP Point Ref</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.TSPPoint#getTSPCode <em>TSP Code</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.TSPPoint#getShortName <em>Short Name</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.TSPPoint#getDesciption <em>Desciption</em>}</li>
 * </ul>
 *
 * @see de.jena.mdo.ibis.ibis_common.IbisCommonPackage#getTSPPoint()
 * @model extendedMetaData="name='TSPPointStructure' kind='elementOnly'"
 * @generated
 */
@ProviderType
public interface TSPPoint extends EObject {
	/**
	 ...
	 * @see de.jena.mdo.ibis.ibis_common.IbisCommonPackage#getTSPPoint_TSPPointRef()
	...
	/**
	 * Sets the value of the '{@link de.jena.mdo.ibis.ibis_common.TSPPoint#getTSPPointRef <em>TSP Point Ref</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.jena.mdo.ibis.ibis_common.IbisCommonPackage#getTSPPoint_TSPCode()
	...
	/**
	 * Sets the value of the '{@link de.jena.mdo.ibis.ibis_common.TSPPoint#getTSPCode <em>TSP Code</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.jena.mdo.ibis.ibis_common.IbisCommonPackage#getTSPPoint_ShortName()
	 * @model containment="true"
	 ...
	 * @see de.jena.mdo.ibis.ibis_common.IbisCommonPackage#getTSPPoint_Desciption()
	 * @model containment="true"
