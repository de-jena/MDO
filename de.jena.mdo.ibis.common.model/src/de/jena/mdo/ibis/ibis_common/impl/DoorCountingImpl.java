...
import de.jena.mdo.ibis.ibis_enumerations.DoorCountingObjectClassEnumeration;
import de.jena.mdo.ibis.ibis_enumerations.DoorCountingQualityEnumeration;
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Door Counting</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.DoorCountingImpl#getObjectClass <em>Object Class</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.DoorCountingImpl#getIn <em>In</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.DoorCountingImpl#getOut <em>Out</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.DoorCountingImpl#getCountQuality <em>Count Quality</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DoorCountingImpl extends MinimalEObjectImpl.Container implements DoorCounting {
	...
	public void setObjectClass(DoorCountingObjectClassEnumeration newObjectClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCommonPackage.DOOR_COUNTING__OBJECT_CLASS, oldObjectClass, objectClass, !oldObjectClassESet));
	}
	...
	public void unsetObjectClass() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, IbisCommonPackage.DOOR_COUNTING__OBJECT_CLASS, oldObjectClass, OBJECT_CLASS_EDEFAULT, oldObjectClassESet));
	}
	...
	public NotificationChain basicSetIn(IBISIPInt newIn, NotificationChain msgs) {
		...
		in = newIn;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisCommonPackage.DOOR_COUNTING__IN, oldIn, newIn);
	...
	public void setIn(IBISIPInt newIn) {
		if (newIn != in) {
			...
			if (in != null)
				msgs = ((InternalEObject)in).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.DOOR_COUNTING__IN, null, msgs);
			if (newIn != null)
				msgs = ((InternalEObject)newIn).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.DOOR_COUNTING__IN, null, msgs);
			msgs = basicSetIn(newIn, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCommonPackage.DOOR_COUNTING__IN, newIn, newIn));
	}
	...
	public NotificationChain basicSetOut(IBISIPInt newOut, NotificationChain msgs) {
		...
		out = newOut;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisCommonPackage.DOOR_COUNTING__OUT, oldOut, newOut);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setOut(IBISIPInt newOut) {
		if (newOut != out) {
			NotificationChain msgs = null;
			if (out != null)
				msgs = ((InternalEObject)out).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.DOOR_COUNTING__OUT, null, msgs);
			if (newOut != null)
				msgs = ((InternalEObject)newOut).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.DOOR_COUNTING__OUT, null, msgs);
			msgs = basicSetOut(newOut, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCommonPackage.DOOR_COUNTING__OUT, newOut, newOut));
	}
	...
	public void setCountQuality(DoorCountingQualityEnumeration newCountQuality) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCommonPackage.DOOR_COUNTING__COUNT_QUALITY, oldCountQuality, countQuality, !oldCountQualityESet));
	}
	...
	public void unsetCountQuality() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, IbisCommonPackage.DOOR_COUNTING__COUNT_QUALITY, oldCountQuality, COUNT_QUALITY_EDEFAULT, oldCountQualityESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case IbisCommonPackage.DOOR_COUNTING__IN:
				return basicSetIn(null, msgs);
			case IbisCommonPackage.DOOR_COUNTING__OUT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IbisCommonPackage.DOOR_COUNTING__OBJECT_CLASS:
				return getObjectClass();
			case IbisCommonPackage.DOOR_COUNTING__IN:
				return getIn();
			case IbisCommonPackage.DOOR_COUNTING__OUT:
				return getOut();
			case IbisCommonPackage.DOOR_COUNTING__COUNT_QUALITY:
