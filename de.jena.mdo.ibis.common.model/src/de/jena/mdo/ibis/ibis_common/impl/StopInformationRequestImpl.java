...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Stop Information Request</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.StopInformationRequestImpl#getStopIndex <em>Stop Index</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.StopInformationRequestImpl#getStopRef <em>Stop Ref</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.StopInformationRequestImpl#getStopName <em>Stop Name</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.StopInformationRequestImpl#getDisplayContent <em>Display Content</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.StopInformationRequestImpl#getStopAnnouncement <em>Stop Announcement</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.StopInformationRequestImpl#getArrivalScheduled <em>Arrival Scheduled</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.StopInformationRequestImpl#getDepartureScheduled <em>Departure Scheduled</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.StopInformationRequestImpl#getRecordedArrivalTime <em>Recorded Arrival Time</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.StopInformationRequestImpl#getDistanceToNextStop <em>Distance To Next Stop</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.StopInformationRequestImpl#getConnection <em>Connection</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.StopInformationRequestImpl#getFareZone <em>Fare Zone</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StopInformationRequestImpl extends MinimalEObjectImpl.Container implements StopInformationRequest {
	 ...
	 * @generated
	 */
	protected StopInformationRequestImpl() {
		super();
	}
	...
	public NotificationChain basicSetStopIndex(IBISIPInt newStopIndex, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisCommonPackage.STOP_INFORMATION_REQUEST__STOP_INDEX, oldStopIndex, newStopIndex);
	...
	public void setStopIndex(IBISIPInt newStopIndex) {
		if (newStopIndex != stopIndex) {
			...
			if (stopIndex != null)
				msgs = ((InternalEObject)stopIndex).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.STOP_INFORMATION_REQUEST__STOP_INDEX, null, msgs);
			if (newStopIndex != null)
				msgs = ((InternalEObject)newStopIndex).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.STOP_INFORMATION_REQUEST__STOP_INDEX, null, msgs);
			msgs = basicSetStopIndex(newStopIndex, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCommonPackage.STOP_INFORMATION_REQUEST__STOP_INDEX, newStopIndex, newStopIndex));
	}
	...
	public NotificationChain basicSetStopRef(IBISIPNMTOKEN newStopRef, NotificationChain msgs) {
		...
		stopRef = newStopRef;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisCommonPackage.STOP_INFORMATION_REQUEST__STOP_REF, oldStopRef, newStopRef);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setStopRef(IBISIPNMTOKEN newStopRef) {
		if (newStopRef != stopRef) {
			NotificationChain msgs = null;
			if (stopRef != null)
				msgs = ((InternalEObject)stopRef).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.STOP_INFORMATION_REQUEST__STOP_REF, null, msgs);
			if (newStopRef != null)
				msgs = ((InternalEObject)newStopRef).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.STOP_INFORMATION_REQUEST__STOP_REF, null, msgs);
			msgs = basicSetStopRef(newStopRef, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCommonPackage.STOP_INFORMATION_REQUEST__STOP_REF, newStopRef, newStopRef));
	}
	...
	public EList<InternationalTextType> getStopName() {
		if (stopName == null) {
			stopName = new EObjectContainmentEList<InternationalTextType>(InternationalTextType.class, this, IbisCommonPackage.STOP_INFORMATION_REQUEST__STOP_NAME);
		}
		return stopName;
	}
	...
	public EList<DisplayContent> getDisplayContent() {
		if (displayContent == null) {
			displayContent = new EObjectContainmentEList<DisplayContent>(DisplayContent.class, this, IbisCommonPackage.STOP_INFORMATION_REQUEST__DISPLAY_CONTENT);
		}
	...
	public EList<Announcement> getStopAnnouncement() {
		if (stopAnnouncement == null) {
			stopAnnouncement = new EObjectContainmentEList<Announcement>(Announcement.class, this, IbisCommonPackage.STOP_INFORMATION_REQUEST__STOP_ANNOUNCEMENT);
		}
	...
	public NotificationChain basicSetArrivalScheduled(IBISIPDateTime newArrivalScheduled, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisCommonPackage.STOP_INFORMATION_REQUEST__ARRIVAL_SCHEDULED, oldArrivalScheduled, newArrivalScheduled);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setArrivalScheduled(IBISIPDateTime newArrivalScheduled) {
		if (newArrivalScheduled != arrivalScheduled) {
			...
			if (arrivalScheduled != null)
				msgs = ((InternalEObject)arrivalScheduled).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.STOP_INFORMATION_REQUEST__ARRIVAL_SCHEDULED, null, msgs);
			if (newArrivalScheduled != null)
				msgs = ((InternalEObject)newArrivalScheduled).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.STOP_INFORMATION_REQUEST__ARRIVAL_SCHEDULED, null, msgs);
			msgs = basicSetArrivalScheduled(newArrivalScheduled, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCommonPackage.STOP_INFORMATION_REQUEST__ARRIVAL_SCHEDULED, newArrivalScheduled, newArrivalScheduled));
	}
	...
	public NotificationChain basicSetDepartureScheduled(IBISIPDateTime newDepartureScheduled, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisCommonPackage.STOP_INFORMATION_REQUEST__DEPARTURE_SCHEDULED, oldDepartureScheduled, newDepartureScheduled);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setDepartureScheduled(IBISIPDateTime newDepartureScheduled) {
		if (newDepartureScheduled != departureScheduled) {
			...
			if (departureScheduled != null)
				msgs = ((InternalEObject)departureScheduled).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.STOP_INFORMATION_REQUEST__DEPARTURE_SCHEDULED, null, msgs);
			if (newDepartureScheduled != null)
				msgs = ((InternalEObject)newDepartureScheduled).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.STOP_INFORMATION_REQUEST__DEPARTURE_SCHEDULED, null, msgs);
			msgs = basicSetDepartureScheduled(newDepartureScheduled, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCommonPackage.STOP_INFORMATION_REQUEST__DEPARTURE_SCHEDULED, newDepartureScheduled, newDepartureScheduled));
	}
	...
	public NotificationChain basicSetRecordedArrivalTime(IBISIPDateTime newRecordedArrivalTime, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisCommonPackage.STOP_INFORMATION_REQUEST__RECORDED_ARRIVAL_TIME, oldRecordedArrivalTime, newRecordedArrivalTime);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setRecordedArrivalTime(IBISIPDateTime newRecordedArrivalTime) {
		if (newRecordedArrivalTime != recordedArrivalTime) {
			...
			if (recordedArrivalTime != null)
				msgs = ((InternalEObject)recordedArrivalTime).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.STOP_INFORMATION_REQUEST__RECORDED_ARRIVAL_TIME, null, msgs);
			if (newRecordedArrivalTime != null)
				msgs = ((InternalEObject)newRecordedArrivalTime).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.STOP_INFORMATION_REQUEST__RECORDED_ARRIVAL_TIME, null, msgs);
			msgs = basicSetRecordedArrivalTime(newRecordedArrivalTime, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCommonPackage.STOP_INFORMATION_REQUEST__RECORDED_ARRIVAL_TIME, newRecordedArrivalTime, newRecordedArrivalTime));
	}
	...
	public NotificationChain basicSetDistanceToNextStop(IBISIPInt newDistanceToNextStop, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisCommonPackage.STOP_INFORMATION_REQUEST__DISTANCE_TO_NEXT_STOP, oldDistanceToNextStop, newDistanceToNextStop);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setDistanceToNextStop(IBISIPInt newDistanceToNextStop) {
		if (newDistanceToNextStop != distanceToNextStop) {
			...
			if (distanceToNextStop != null)
				msgs = ((InternalEObject)distanceToNextStop).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.STOP_INFORMATION_REQUEST__DISTANCE_TO_NEXT_STOP, null, msgs);
			if (newDistanceToNextStop != null)
				msgs = ((InternalEObject)newDistanceToNextStop).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.STOP_INFORMATION_REQUEST__DISTANCE_TO_NEXT_STOP, null, msgs);
			msgs = basicSetDistanceToNextStop(newDistanceToNextStop, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCommonPackage.STOP_INFORMATION_REQUEST__DISTANCE_TO_NEXT_STOP, newDistanceToNextStop, newDistanceToNextStop));
	}
	...
	public EList<Connection> getConnection() {
		if (connection == null) {
			connection = new EObjectContainmentEList<Connection>(Connection.class, this, IbisCommonPackage.STOP_INFORMATION_REQUEST__CONNECTION);
		}
		return connection;
	}
	...
	public EList<IBISIPNMTOKEN> getFareZone() {
		if (fareZone == null) {
			fareZone = new EObjectContainmentEList<IBISIPNMTOKEN>(IBISIPNMTOKEN.class, this, IbisCommonPackage.STOP_INFORMATION_REQUEST__FARE_ZONE);
		}
		return fareZone;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case IbisCommonPackage.STOP_INFORMATION_REQUEST__STOP_INDEX:
				return basicSetStopIndex(null, msgs);
			case IbisCommonPackage.STOP_INFORMATION_REQUEST__STOP_REF:
				return basicSetStopRef(null, msgs);
			case IbisCommonPackage.STOP_INFORMATION_REQUEST__STOP_NAME:
				return ((InternalEList<?>)getStopName()).basicRemove(otherEnd, msgs);
			case IbisCommonPackage.STOP_INFORMATION_REQUEST__DISPLAY_CONTENT:
				return ((InternalEList<?>)getDisplayContent()).basicRemove(otherEnd, msgs);
			case IbisCommonPackage.STOP_INFORMATION_REQUEST__STOP_ANNOUNCEMENT:
				return ((InternalEList<?>)getStopAnnouncement()).basicRemove(otherEnd, msgs);
			case IbisCommonPackage.STOP_INFORMATION_REQUEST__ARRIVAL_SCHEDULED:
				return basicSetArrivalScheduled(null, msgs);
			case IbisCommonPackage.STOP_INFORMATION_REQUEST__DEPARTURE_SCHEDULED:
				return basicSetDepartureScheduled(null, msgs);
			case IbisCommonPackage.STOP_INFORMATION_REQUEST__RECORDED_ARRIVAL_TIME:
				return basicSetRecordedArrivalTime(null, msgs);
			case IbisCommonPackage.STOP_INFORMATION_REQUEST__DISTANCE_TO_NEXT_STOP:
				return basicSetDistanceToNextStop(null, msgs);
			case IbisCommonPackage.STOP_INFORMATION_REQUEST__CONNECTION:
				return ((InternalEList<?>)getConnection()).basicRemove(otherEnd, msgs);
			case IbisCommonPackage.STOP_INFORMATION_REQUEST__FARE_ZONE:
