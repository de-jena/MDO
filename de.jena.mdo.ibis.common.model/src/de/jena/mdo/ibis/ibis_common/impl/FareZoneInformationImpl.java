...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Fare Zone Information</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.FareZoneInformationImpl#getFareZoneID <em>Fare Zone ID</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.FareZoneInformationImpl#getFareZoneType <em>Fare Zone Type</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.FareZoneInformationImpl#getFareZoneLongName <em>Fare Zone Long Name</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.FareZoneInformationImpl#getFareZoneShortName <em>Fare Zone Short Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FareZoneInformationImpl extends MinimalEObjectImpl.Container implements FareZoneInformation {
	/**
	 ...
	 * @generated
	 */
	protected FareZoneInformationImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return IbisCommonPackage.Literals.FARE_ZONE_INFORMATION;
	}
	...
	public NotificationChain basicSetFareZoneID(IBISIPNMTOKEN newFareZoneID, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisCommonPackage.FARE_ZONE_INFORMATION__FARE_ZONE_ID, oldFareZoneID, newFareZoneID);
	...
	public void setFareZoneID(IBISIPNMTOKEN newFareZoneID) {
		if (newFareZoneID != fareZoneID) {
			...
			if (fareZoneID != null)
				msgs = ((InternalEObject)fareZoneID).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.FARE_ZONE_INFORMATION__FARE_ZONE_ID, null, msgs);
			if (newFareZoneID != null)
				msgs = ((InternalEObject)newFareZoneID).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.FARE_ZONE_INFORMATION__FARE_ZONE_ID, null, msgs);
			msgs = basicSetFareZoneID(newFareZoneID, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCommonPackage.FARE_ZONE_INFORMATION__FARE_ZONE_ID, newFareZoneID, newFareZoneID));
	}
	...
	public NotificationChain basicSetFareZoneType(ZoneType newFareZoneType, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisCommonPackage.FARE_ZONE_INFORMATION__FARE_ZONE_TYPE, oldFareZoneType, newFareZoneType);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setFareZoneType(ZoneType newFareZoneType) {
		if (newFareZoneType != fareZoneType) {
			...
			if (fareZoneType != null)
				msgs = ((InternalEObject)fareZoneType).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.FARE_ZONE_INFORMATION__FARE_ZONE_TYPE, null, msgs);
			if (newFareZoneType != null)
				msgs = ((InternalEObject)newFareZoneType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.FARE_ZONE_INFORMATION__FARE_ZONE_TYPE, null, msgs);
			msgs = basicSetFareZoneType(newFareZoneType, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCommonPackage.FARE_ZONE_INFORMATION__FARE_ZONE_TYPE, newFareZoneType, newFareZoneType));
	}
	...
	public EList<InternationalTextType> getFareZoneLongName() {
		if (fareZoneLongName == null) {
			fareZoneLongName = new EObjectContainmentEList<InternationalTextType>(InternationalTextType.class, this, IbisCommonPackage.FARE_ZONE_INFORMATION__FARE_ZONE_LONG_NAME);
		}
	...
	public EList<InternationalTextType> getFareZoneShortName() {
		if (fareZoneShortName == null) {
			fareZoneShortName = new EObjectContainmentEList<InternationalTextType>(InternationalTextType.class, this, IbisCommonPackage.FARE_ZONE_INFORMATION__FARE_ZONE_SHORT_NAME);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case IbisCommonPackage.FARE_ZONE_INFORMATION__FARE_ZONE_ID:
				return basicSetFareZoneID(null, msgs);
			case IbisCommonPackage.FARE_ZONE_INFORMATION__FARE_ZONE_TYPE:
				return basicSetFareZoneType(null, msgs);
			case IbisCommonPackage.FARE_ZONE_INFORMATION__FARE_ZONE_LONG_NAME:
				return ((InternalEList<?>)getFareZoneLongName()).basicRemove(otherEnd, msgs);
			case IbisCommonPackage.FARE_ZONE_INFORMATION__FARE_ZONE_SHORT_NAME:
