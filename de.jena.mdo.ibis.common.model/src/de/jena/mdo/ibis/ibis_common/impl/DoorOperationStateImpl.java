...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Door Operation State</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.DoorOperationStateImpl#getValue <em>Value</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.DoorOperationStateImpl#getErrorCode <em>Error Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DoorOperationStateImpl extends MinimalEObjectImpl.Container implements DoorOperationState {
	/**
	 ...
	 * @generated
	 */
	protected DoorOperationStateImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return IbisCommonPackage.Literals.DOOR_OPERATION_STATE;
	}
	...
	public void setValue(DoorOperationStateEnumeration newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCommonPackage.DOOR_OPERATION_STATE__VALUE, oldValue, value, !oldValueESet));
	}
	...
	public void unsetValue() {
		...
		valueESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, IbisCommonPackage.DOOR_OPERATION_STATE__VALUE, oldValue, VALUE_EDEFAULT, oldValueESet));
	}
	...
	public void setErrorCode(ErrorCodeEnumeration newErrorCode) {
		...
		errorCodeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCommonPackage.DOOR_OPERATION_STATE__ERROR_CODE, oldErrorCode, errorCode, !oldErrorCodeESet));
	}
	...
	public void unsetErrorCode() {
		...
		errorCodeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, IbisCommonPackage.DOOR_OPERATION_STATE__ERROR_CODE, oldErrorCode, ERROR_CODE_EDEFAULT, oldErrorCodeESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IbisCommonPackage.DOOR_OPERATION_STATE__VALUE:
				return getValue();
			case IbisCommonPackage.DOOR_OPERATION_STATE__ERROR_CODE:
				return getErrorCode();
		}
