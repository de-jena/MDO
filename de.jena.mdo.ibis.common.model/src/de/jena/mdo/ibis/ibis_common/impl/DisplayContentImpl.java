...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Display Content</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.DisplayContentImpl#getDisplayContentRef <em>Display Content Ref</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.DisplayContentImpl#getLineInformation <em>Line Information</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.DisplayContentImpl#getDestination <em>Destination</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.DisplayContentImpl#getViaPoint <em>Via Point</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.DisplayContentImpl#getAdditionalInformation <em>Additional Information</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.DisplayContentImpl#getAdditionalInformation1 <em>Additional Information1</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.DisplayContentImpl#getAdditionalInformation2 <em>Additional Information2</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.DisplayContentImpl#getAdditionalInformation3 <em>Additional Information3</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.DisplayContentImpl#getAdditionalInformation4 <em>Additional Information4</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.DisplayContentImpl#getAdditionalInformation5 <em>Additional Information5</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.DisplayContentImpl#getAdditionalInformation6 <em>Additional Information6</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.DisplayContentImpl#getAdditionalInformation7 <em>Additional Information7</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.DisplayContentImpl#getAdditionalInformation8 <em>Additional Information8</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.DisplayContentImpl#getAdditionalInformation9 <em>Additional Information9</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.DisplayContentImpl#getRunNumber <em>Run Number</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.DisplayContentImpl#getPriority <em>Priority</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.DisplayContentImpl#getPeriodDuration <em>Period Duration</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.DisplayContentImpl#getDuration <em>Duration</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DisplayContentImpl extends MinimalEObjectImpl.Container implements DisplayContent {
	...
	public NotificationChain basicSetDisplayContentRef(IBISIPNMTOKEN newDisplayContentRef, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisCommonPackage.DISPLAY_CONTENT__DISPLAY_CONTENT_REF, oldDisplayContentRef, newDisplayContentRef);
	...
	public void setDisplayContentRef(IBISIPNMTOKEN newDisplayContentRef) {
		if (newDisplayContentRef != displayContentRef) {
			...
			if (displayContentRef != null)
				msgs = ((InternalEObject)displayContentRef).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.DISPLAY_CONTENT__DISPLAY_CONTENT_REF, null, msgs);
			if (newDisplayContentRef != null)
				msgs = ((InternalEObject)newDisplayContentRef).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.DISPLAY_CONTENT__DISPLAY_CONTENT_REF, null, msgs);
			msgs = basicSetDisplayContentRef(newDisplayContentRef, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCommonPackage.DISPLAY_CONTENT__DISPLAY_CONTENT_REF, newDisplayContentRef, newDisplayContentRef));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetLineInformation(LineInformation newLineInformation, NotificationChain msgs) {
		LineInformation oldLineInformation = lineInformation;
		lineInformation = newLineInformation;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisCommonPackage.DISPLAY_CONTENT__LINE_INFORMATION, oldLineInformation, newLineInformation);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	 ...
	 */
	@Override
	public void setLineInformation(LineInformation newLineInformation) {
		if (newLineInformation != lineInformation) {
			NotificationChain msgs = null;
			if (lineInformation != null)
				msgs = ((InternalEObject)lineInformation).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.DISPLAY_CONTENT__LINE_INFORMATION, null, msgs);
			if (newLineInformation != null)
				msgs = ((InternalEObject)newLineInformation).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.DISPLAY_CONTENT__LINE_INFORMATION, null, msgs);
			msgs = basicSetLineInformation(newLineInformation, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCommonPackage.DISPLAY_CONTENT__LINE_INFORMATION, newLineInformation, newLineInformation));
	}
	...
	public NotificationChain basicSetDestination(Destination newDestination, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisCommonPackage.DISPLAY_CONTENT__DESTINATION, oldDestination, newDestination);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setDestination(Destination newDestination) {
		if (newDestination != destination) {
			NotificationChain msgs = null;
			if (destination != null)
				msgs = ((InternalEObject)destination).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.DISPLAY_CONTENT__DESTINATION, null, msgs);
			if (newDestination != null)
				msgs = ((InternalEObject)newDestination).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.DISPLAY_CONTENT__DESTINATION, null, msgs);
			msgs = basicSetDestination(newDestination, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCommonPackage.DISPLAY_CONTENT__DESTINATION, newDestination, newDestination));
	}
	...
	public EList<ViaPoint> getViaPoint() {
		if (viaPoint == null) {
			viaPoint = new EObjectContainmentEList<ViaPoint>(ViaPoint.class, this, IbisCommonPackage.DISPLAY_CONTENT__VIA_POINT);
		}
		return viaPoint;
	}
	...
	public EList<InternationalTextType> getAdditionalInformation() {
		if (additionalInformation == null) {
			additionalInformation = new EObjectContainmentEList<InternationalTextType>(InternationalTextType.class, this, IbisCommonPackage.DISPLAY_CONTENT__ADDITIONAL_INFORMATION);
		}
	...
	public EList<InternationalTextType> getAdditionalInformation1() {
		if (additionalInformation1 == null) {
			additionalInformation1 = new EObjectContainmentEList<InternationalTextType>(InternationalTextType.class, this, IbisCommonPackage.DISPLAY_CONTENT__ADDITIONAL_INFORMATION1);
		}
	...
	public EList<InternationalTextType> getAdditionalInformation2() {
		if (additionalInformation2 == null) {
			additionalInformation2 = new EObjectContainmentEList<InternationalTextType>(InternationalTextType.class, this, IbisCommonPackage.DISPLAY_CONTENT__ADDITIONAL_INFORMATION2);
		}
	...
	public EList<InternationalTextType> getAdditionalInformation3() {
		if (additionalInformation3 == null) {
			additionalInformation3 = new EObjectContainmentEList<InternationalTextType>(InternationalTextType.class, this, IbisCommonPackage.DISPLAY_CONTENT__ADDITIONAL_INFORMATION3);
		}
	...
	public EList<InternationalTextType> getAdditionalInformation4() {
		if (additionalInformation4 == null) {
			additionalInformation4 = new EObjectContainmentEList<InternationalTextType>(InternationalTextType.class, this, IbisCommonPackage.DISPLAY_CONTENT__ADDITIONAL_INFORMATION4);
		}
	...
	public EList<InternationalTextType> getAdditionalInformation5() {
		if (additionalInformation5 == null) {
			additionalInformation5 = new EObjectContainmentEList<InternationalTextType>(InternationalTextType.class, this, IbisCommonPackage.DISPLAY_CONTENT__ADDITIONAL_INFORMATION5);
		}
	...
	public EList<InternationalTextType> getAdditionalInformation6() {
		if (additionalInformation6 == null) {
			additionalInformation6 = new EObjectContainmentEList<InternationalTextType>(InternationalTextType.class, this, IbisCommonPackage.DISPLAY_CONTENT__ADDITIONAL_INFORMATION6);
		}
	...
	public EList<InternationalTextType> getAdditionalInformation7() {
		if (additionalInformation7 == null) {
			additionalInformation7 = new EObjectContainmentEList<InternationalTextType>(InternationalTextType.class, this, IbisCommonPackage.DISPLAY_CONTENT__ADDITIONAL_INFORMATION7);
		}
	...
	public EList<InternationalTextType> getAdditionalInformation8() {
		if (additionalInformation8 == null) {
			additionalInformation8 = new EObjectContainmentEList<InternationalTextType>(InternationalTextType.class, this, IbisCommonPackage.DISPLAY_CONTENT__ADDITIONAL_INFORMATION8);
		}
	...
	public EList<InternationalTextType> getAdditionalInformation9() {
		if (additionalInformation9 == null) {
			additionalInformation9 = new EObjectContainmentEList<InternationalTextType>(InternationalTextType.class, this, IbisCommonPackage.DISPLAY_CONTENT__ADDITIONAL_INFORMATION9);
		}
	...
	public NotificationChain basicSetRunNumber(IBISIPInt newRunNumber, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisCommonPackage.DISPLAY_CONTENT__RUN_NUMBER, oldRunNumber, newRunNumber);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setRunNumber(IBISIPInt newRunNumber) {
		if (newRunNumber != runNumber) {
			NotificationChain msgs = null;
			if (runNumber != null)
				msgs = ((InternalEObject)runNumber).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.DISPLAY_CONTENT__RUN_NUMBER, null, msgs);
			if (newRunNumber != null)
				msgs = ((InternalEObject)newRunNumber).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.DISPLAY_CONTENT__RUN_NUMBER, null, msgs);
			msgs = basicSetRunNumber(newRunNumber, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCommonPackage.DISPLAY_CONTENT__RUN_NUMBER, newRunNumber, newRunNumber));
	}
	...
	public NotificationChain basicSetPriority(IBISIPNonNegativeInteger newPriority, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisCommonPackage.DISPLAY_CONTENT__PRIORITY, oldPriority, newPriority);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setPriority(IBISIPNonNegativeInteger newPriority) {
		if (newPriority != priority) {
			NotificationChain msgs = null;
			if (priority != null)
				msgs = ((InternalEObject)priority).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.DISPLAY_CONTENT__PRIORITY, null, msgs);
			if (newPriority != null)
				msgs = ((InternalEObject)newPriority).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.DISPLAY_CONTENT__PRIORITY, null, msgs);
			msgs = basicSetPriority(newPriority, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCommonPackage.DISPLAY_CONTENT__PRIORITY, newPriority, newPriority));
	}
	...
	public NotificationChain basicSetPeriodDuration(IBISIPDuration newPeriodDuration, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisCommonPackage.DISPLAY_CONTENT__PERIOD_DURATION, oldPeriodDuration, newPeriodDuration);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setPeriodDuration(IBISIPDuration newPeriodDuration) {
		if (newPeriodDuration != periodDuration) {
			...
			if (periodDuration != null)
				msgs = ((InternalEObject)periodDuration).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.DISPLAY_CONTENT__PERIOD_DURATION, null, msgs);
			if (newPeriodDuration != null)
				msgs = ((InternalEObject)newPeriodDuration).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.DISPLAY_CONTENT__PERIOD_DURATION, null, msgs);
			msgs = basicSetPeriodDuration(newPeriodDuration, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCommonPackage.DISPLAY_CONTENT__PERIOD_DURATION, newPeriodDuration, newPeriodDuration));
	}
	...
	public NotificationChain basicSetDuration(IBISIPDuration newDuration, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisCommonPackage.DISPLAY_CONTENT__DURATION, oldDuration, newDuration);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setDuration(IBISIPDuration newDuration) {
		if (newDuration != duration) {
			NotificationChain msgs = null;
			if (duration != null)
				msgs = ((InternalEObject)duration).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.DISPLAY_CONTENT__DURATION, null, msgs);
			if (newDuration != null)
				msgs = ((InternalEObject)newDuration).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.DISPLAY_CONTENT__DURATION, null, msgs);
			msgs = basicSetDuration(newDuration, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCommonPackage.DISPLAY_CONTENT__DURATION, newDuration, newDuration));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case IbisCommonPackage.DISPLAY_CONTENT__DISPLAY_CONTENT_REF:
				return basicSetDisplayContentRef(null, msgs);
			case IbisCommonPackage.DISPLAY_CONTENT__LINE_INFORMATION:
				return basicSetLineInformation(null, msgs);
			case IbisCommonPackage.DISPLAY_CONTENT__DESTINATION:
				return basicSetDestination(null, msgs);
			case IbisCommonPackage.DISPLAY_CONTENT__VIA_POINT:
				return ((InternalEList<?>)getViaPoint()).basicRemove(otherEnd, msgs);
			case IbisCommonPackage.DISPLAY_CONTENT__ADDITIONAL_INFORMATION:
				return ((InternalEList<?>)getAdditionalInformation()).basicRemove(otherEnd, msgs);
			case IbisCommonPackage.DISPLAY_CONTENT__ADDITIONAL_INFORMATION1:
				return ((InternalEList<?>)getAdditionalInformation1()).basicRemove(otherEnd, msgs);
			case IbisCommonPackage.DISPLAY_CONTENT__ADDITIONAL_INFORMATION2:
				return ((InternalEList<?>)getAdditionalInformation2()).basicRemove(otherEnd, msgs);
			case IbisCommonPackage.DISPLAY_CONTENT__ADDITIONAL_INFORMATION3:
				return ((InternalEList<?>)getAdditionalInformation3()).basicRemove(otherEnd, msgs);
			case IbisCommonPackage.DISPLAY_CONTENT__ADDITIONAL_INFORMATION4:
				return ((InternalEList<?>)getAdditionalInformation4()).basicRemove(otherEnd, msgs);
			case IbisCommonPackage.DISPLAY_CONTENT__ADDITIONAL_INFORMATION5:
				return ((InternalEList<?>)getAdditionalInformation5()).basicRemove(otherEnd, msgs);
			case IbisCommonPackage.DISPLAY_CONTENT__ADDITIONAL_INFORMATION6:
				return ((InternalEList<?>)getAdditionalInformation6()).basicRemove(otherEnd, msgs);
			case IbisCommonPackage.DISPLAY_CONTENT__ADDITIONAL_INFORMATION7:
				return ((InternalEList<?>)getAdditionalInformation7()).basicRemove(otherEnd, msgs);
			case IbisCommonPackage.DISPLAY_CONTENT__ADDITIONAL_INFORMATION8:
				return ((InternalEList<?>)getAdditionalInformation8()).basicRemove(otherEnd, msgs);
			case IbisCommonPackage.DISPLAY_CONTENT__ADDITIONAL_INFORMATION9:
				return ((InternalEList<?>)getAdditionalInformation9()).basicRemove(otherEnd, msgs);
			case IbisCommonPackage.DISPLAY_CONTENT__RUN_NUMBER:
				return basicSetRunNumber(null, msgs);
			case IbisCommonPackage.DISPLAY_CONTENT__PRIORITY:
				return basicSetPriority(null, msgs);
			case IbisCommonPackage.DISPLAY_CONTENT__PERIOD_DURATION:
				return basicSetPeriodDuration(null, msgs);
			case IbisCommonPackage.DISPLAY_CONTENT__DURATION:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case IbisCommonPackage.DISPLAY_CONTENT__DISPLAY_CONTENT_REF:
				...
				return;
			case IbisCommonPackage.DISPLAY_CONTENT__LINE_INFORMATION:
				setLineInformation((LineInformation)newValue);
				return;
			case IbisCommonPackage.DISPLAY_CONTENT__DESTINATION:
			...
			case IbisCommonPackage.DISPLAY_CONTENT__VIA_POINT:
				getViaPoint().clear();
				getViaPoint().addAll((Collection<? extends ViaPoint>)newValue);
				return;
			case IbisCommonPackage.DISPLAY_CONTENT__ADDITIONAL_INFORMATION:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case IbisCommonPackage.DISPLAY_CONTENT__DISPLAY_CONTENT_REF:
				...
				return;
			case IbisCommonPackage.DISPLAY_CONTENT__LINE_INFORMATION:
				setLineInformation((LineInformation)null);
				return;
			case IbisCommonPackage.DISPLAY_CONTENT__DESTINATION:
