...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Service Identification With State</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.ServiceIdentificationWithStateImpl#getServiceIdentification <em>Service Identification</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.ServiceIdentificationWithStateImpl#getServiceState <em>Service State</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ServiceIdentificationWithStateImpl extends MinimalEObjectImpl.Container implements ServiceIdentificationWithState {
	 ...
	 * @generated
	 */
	protected ServiceIdentificationWithStateImpl() {
		super();
	}
	...
	public NotificationChain basicSetServiceIdentification(ServiceIdentification newServiceIdentification, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisCommonPackage.SERVICE_IDENTIFICATION_WITH_STATE__SERVICE_IDENTIFICATION, oldServiceIdentification, newServiceIdentification);
	...
	public void setServiceIdentification(ServiceIdentification newServiceIdentification) {
		if (newServiceIdentification != serviceIdentification) {
			...
			if (serviceIdentification != null)
				msgs = ((InternalEObject)serviceIdentification).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.SERVICE_IDENTIFICATION_WITH_STATE__SERVICE_IDENTIFICATION, null, msgs);
			if (newServiceIdentification != null)
				msgs = ((InternalEObject)newServiceIdentification).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.SERVICE_IDENTIFICATION_WITH_STATE__SERVICE_IDENTIFICATION, null, msgs);
			msgs = basicSetServiceIdentification(newServiceIdentification, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCommonPackage.SERVICE_IDENTIFICATION_WITH_STATE__SERVICE_IDENTIFICATION, newServiceIdentification, newServiceIdentification));
	}
	...
	public void setServiceState(ServiceStateEnumeration newServiceState) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCommonPackage.SERVICE_IDENTIFICATION_WITH_STATE__SERVICE_STATE, oldServiceState, serviceState, !oldServiceStateESet));
	}
	...
	public void unsetServiceState() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, IbisCommonPackage.SERVICE_IDENTIFICATION_WITH_STATE__SERVICE_STATE, oldServiceState, SERVICE_STATE_EDEFAULT, oldServiceStateESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case IbisCommonPackage.SERVICE_IDENTIFICATION_WITH_STATE__SERVICE_IDENTIFICATION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case IbisCommonPackage.SERVICE_IDENTIFICATION_WITH_STATE__SERVICE_STATE:
...
} //ServiceIdentificationWithStateImpl
