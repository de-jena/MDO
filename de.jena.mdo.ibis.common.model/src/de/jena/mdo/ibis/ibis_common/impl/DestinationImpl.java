 ...
 * </p>
 * <ul>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.DestinationImpl#getDestinationRef <em>Destination Ref</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.DestinationImpl#getDestinationName <em>Destination Name</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.DestinationImpl#getDestinationShortName <em>Destination Short Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DestinationImpl extends MinimalEObjectImpl.Container implements Destination {
	...
	protected EClass eStaticClass() {
		return IbisCommonPackage.Literals.DESTINATION;
	}
	...
	public NotificationChain basicSetDestinationRef(IBISIPNMTOKEN newDestinationRef, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisCommonPackage.DESTINATION__DESTINATION_REF, oldDestinationRef, newDestinationRef);
	...
	public void setDestinationRef(IBISIPNMTOKEN newDestinationRef) {
		if (newDestinationRef != destinationRef) {
			...
			if (destinationRef != null)
				msgs = ((InternalEObject)destinationRef).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.DESTINATION__DESTINATION_REF, null, msgs);
			if (newDestinationRef != null)
				msgs = ((InternalEObject)newDestinationRef).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.DESTINATION__DESTINATION_REF, null, msgs);
			msgs = basicSetDestinationRef(newDestinationRef, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCommonPackage.DESTINATION__DESTINATION_REF, newDestinationRef, newDestinationRef));
	}
	...
	public EList<InternationalTextType> getDestinationName() {
		if (destinationName == null) {
			destinationName = new EObjectContainmentEList<InternationalTextType>(InternationalTextType.class, this, IbisCommonPackage.DESTINATION__DESTINATION_NAME);
		}
	...
	public EList<InternationalTextType> getDestinationShortName() {
		if (destinationShortName == null) {
			destinationShortName = new EObjectContainmentEList<InternationalTextType>(InternationalTextType.class, this, IbisCommonPackage.DESTINATION__DESTINATION_SHORT_NAME);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case IbisCommonPackage.DESTINATION__DESTINATION_REF:
				return basicSetDestinationRef(null, msgs);
			case IbisCommonPackage.DESTINATION__DESTINATION_NAME:
				return ((InternalEList<?>)getDestinationName()).basicRemove(otherEnd, msgs);
			case IbisCommonPackage.DESTINATION__DESTINATION_SHORT_NAME:
