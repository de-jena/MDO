...
import de.jena.mdo.ibis.ibis_enumerations.LocationStateEnumeration;
import de.jena.mdo.ibis.ibis_enumerations.RouteDirectionEnumeration;
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Trip Information</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.TripInformationImpl#getTripRef <em>Trip Ref</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.TripInformationImpl#getStopSequence <em>Stop Sequence</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.TripInformationImpl#getLocationState <em>Location State</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.TripInformationImpl#getTimetableDelay <em>Timetable Delay</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.TripInformationImpl#getAdditionalTextMessage <em>Additional Text Message</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.TripInformationImpl#getAdditionalTextMessage1 <em>Additional Text Message1</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.TripInformationImpl#getAdditionalTextMessage2 <em>Additional Text Message2</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.TripInformationImpl#getAdditionalTextMessage3 <em>Additional Text Message3</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.TripInformationImpl#getAdditionalTextMessage4 <em>Additional Text Message4</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.TripInformationImpl#getAdditionalTextMessage5 <em>Additional Text Message5</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.TripInformationImpl#getAdditionalTextMessage6 <em>Additional Text Message6</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.TripInformationImpl#getAdditionalTextMessage7 <em>Additional Text Message7</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.TripInformationImpl#getAdditionalTextMessage8 <em>Additional Text Message8</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.TripInformationImpl#getAdditionalTextMessage9 <em>Additional Text Message9</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.TripInformationImpl#getAdditionalAnnouncement <em>Additional Announcement</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.TripInformationImpl#getRouteDirection <em>Route Direction</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.TripInformationImpl#getRunNumber <em>Run Number</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.TripInformationImpl#getPatternNumber <em>Pattern Number</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.TripInformationImpl#getPathDestinationNumber <em>Path Destination Number</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TripInformationImpl extends MinimalEObjectImpl.Container implements TripInformation {
	...
	public NotificationChain basicSetTripRef(IBISIPNMTOKEN newTripRef, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisCommonPackage.TRIP_INFORMATION__TRIP_REF, oldTripRef, newTripRef);
	...
	public void setTripRef(IBISIPNMTOKEN newTripRef) {
		if (newTripRef != tripRef) {
			...
			if (tripRef != null)
				msgs = ((InternalEObject)tripRef).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.TRIP_INFORMATION__TRIP_REF, null, msgs);
			if (newTripRef != null)
				msgs = ((InternalEObject)newTripRef).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.TRIP_INFORMATION__TRIP_REF, null, msgs);
			msgs = basicSetTripRef(newTripRef, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCommonPackage.TRIP_INFORMATION__TRIP_REF, newTripRef, newTripRef));
	}
	...
	public NotificationChain basicSetStopSequence(StopSequence newStopSequence, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisCommonPackage.TRIP_INFORMATION__STOP_SEQUENCE, oldStopSequence, newStopSequence);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setStopSequence(StopSequence newStopSequence) {
		if (newStopSequence != stopSequence) {
			...
			if (stopSequence != null)
				msgs = ((InternalEObject)stopSequence).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.TRIP_INFORMATION__STOP_SEQUENCE, null, msgs);
			if (newStopSequence != null)
				msgs = ((InternalEObject)newStopSequence).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.TRIP_INFORMATION__STOP_SEQUENCE, null, msgs);
			msgs = basicSetStopSequence(newStopSequence, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCommonPackage.TRIP_INFORMATION__STOP_SEQUENCE, newStopSequence, newStopSequence));
	}
	...
	public void setLocationState(LocationStateEnumeration newLocationState) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCommonPackage.TRIP_INFORMATION__LOCATION_STATE, oldLocationState, locationState, !oldLocationStateESet));
	}
	...
	public void unsetLocationState() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, IbisCommonPackage.TRIP_INFORMATION__LOCATION_STATE, oldLocationState, LOCATION_STATE_EDEFAULT, oldLocationStateESet));
	}
	...
	public NotificationChain basicSetTimetableDelay(IBISIPInt newTimetableDelay, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisCommonPackage.TRIP_INFORMATION__TIMETABLE_DELAY, oldTimetableDelay, newTimetableDelay);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTimetableDelay(IBISIPInt newTimetableDelay) {
		if (newTimetableDelay != timetableDelay) {
			...
			if (timetableDelay != null)
				msgs = ((InternalEObject)timetableDelay).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.TRIP_INFORMATION__TIMETABLE_DELAY, null, msgs);
			if (newTimetableDelay != null)
				msgs = ((InternalEObject)newTimetableDelay).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.TRIP_INFORMATION__TIMETABLE_DELAY, null, msgs);
			msgs = basicSetTimetableDelay(newTimetableDelay, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCommonPackage.TRIP_INFORMATION__TIMETABLE_DELAY, newTimetableDelay, newTimetableDelay));
	}
	...
	public NotificationChain basicSetAdditionalTextMessage(InternationalTextType newAdditionalTextMessage, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisCommonPackage.TRIP_INFORMATION__ADDITIONAL_TEXT_MESSAGE, oldAdditionalTextMessage, newAdditionalTextMessage);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setAdditionalTextMessage(InternationalTextType newAdditionalTextMessage) {
		if (newAdditionalTextMessage != additionalTextMessage) {
			...
			if (additionalTextMessage != null)
				msgs = ((InternalEObject)additionalTextMessage).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.TRIP_INFORMATION__ADDITIONAL_TEXT_MESSAGE, null, msgs);
			if (newAdditionalTextMessage != null)
				msgs = ((InternalEObject)newAdditionalTextMessage).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.TRIP_INFORMATION__ADDITIONAL_TEXT_MESSAGE, null, msgs);
			msgs = basicSetAdditionalTextMessage(newAdditionalTextMessage, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCommonPackage.TRIP_INFORMATION__ADDITIONAL_TEXT_MESSAGE, newAdditionalTextMessage, newAdditionalTextMessage));
	}
	...
	public NotificationChain basicSetAdditionalTextMessage1(InternationalTextType newAdditionalTextMessage1, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisCommonPackage.TRIP_INFORMATION__ADDITIONAL_TEXT_MESSAGE1, oldAdditionalTextMessage1, newAdditionalTextMessage1);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setAdditionalTextMessage1(InternationalTextType newAdditionalTextMessage1) {
		if (newAdditionalTextMessage1 != additionalTextMessage1) {
			...
			if (additionalTextMessage1 != null)
				msgs = ((InternalEObject)additionalTextMessage1).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.TRIP_INFORMATION__ADDITIONAL_TEXT_MESSAGE1, null, msgs);
			if (newAdditionalTextMessage1 != null)
				msgs = ((InternalEObject)newAdditionalTextMessage1).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.TRIP_INFORMATION__ADDITIONAL_TEXT_MESSAGE1, null, msgs);
			msgs = basicSetAdditionalTextMessage1(newAdditionalTextMessage1, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCommonPackage.TRIP_INFORMATION__ADDITIONAL_TEXT_MESSAGE1, newAdditionalTextMessage1, newAdditionalTextMessage1));
	}
	...
	public NotificationChain basicSetAdditionalTextMessage2(InternationalTextType newAdditionalTextMessage2, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisCommonPackage.TRIP_INFORMATION__ADDITIONAL_TEXT_MESSAGE2, oldAdditionalTextMessage2, newAdditionalTextMessage2);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setAdditionalTextMessage2(InternationalTextType newAdditionalTextMessage2) {
		if (newAdditionalTextMessage2 != additionalTextMessage2) {
			...
			if (additionalTextMessage2 != null)
				msgs = ((InternalEObject)additionalTextMessage2).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.TRIP_INFORMATION__ADDITIONAL_TEXT_MESSAGE2, null, msgs);
			if (newAdditionalTextMessage2 != null)
				msgs = ((InternalEObject)newAdditionalTextMessage2).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.TRIP_INFORMATION__ADDITIONAL_TEXT_MESSAGE2, null, msgs);
			msgs = basicSetAdditionalTextMessage2(newAdditionalTextMessage2, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCommonPackage.TRIP_INFORMATION__ADDITIONAL_TEXT_MESSAGE2, newAdditionalTextMessage2, newAdditionalTextMessage2));
	}
	...
	public NotificationChain basicSetAdditionalTextMessage3(InternationalTextType newAdditionalTextMessage3, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisCommonPackage.TRIP_INFORMATION__ADDITIONAL_TEXT_MESSAGE3, oldAdditionalTextMessage3, newAdditionalTextMessage3);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setAdditionalTextMessage3(InternationalTextType newAdditionalTextMessage3) {
		if (newAdditionalTextMessage3 != additionalTextMessage3) {
			...
			if (additionalTextMessage3 != null)
				msgs = ((InternalEObject)additionalTextMessage3).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.TRIP_INFORMATION__ADDITIONAL_TEXT_MESSAGE3, null, msgs);
			if (newAdditionalTextMessage3 != null)
				msgs = ((InternalEObject)newAdditionalTextMessage3).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.TRIP_INFORMATION__ADDITIONAL_TEXT_MESSAGE3, null, msgs);
			msgs = basicSetAdditionalTextMessage3(newAdditionalTextMessage3, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCommonPackage.TRIP_INFORMATION__ADDITIONAL_TEXT_MESSAGE3, newAdditionalTextMessage3, newAdditionalTextMessage3));
	}
	...
	public NotificationChain basicSetAdditionalTextMessage4(InternationalTextType newAdditionalTextMessage4, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisCommonPackage.TRIP_INFORMATION__ADDITIONAL_TEXT_MESSAGE4, oldAdditionalTextMessage4, newAdditionalTextMessage4);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setAdditionalTextMessage4(InternationalTextType newAdditionalTextMessage4) {
		if (newAdditionalTextMessage4 != additionalTextMessage4) {
			...
			if (additionalTextMessage4 != null)
				msgs = ((InternalEObject)additionalTextMessage4).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.TRIP_INFORMATION__ADDITIONAL_TEXT_MESSAGE4, null, msgs);
			if (newAdditionalTextMessage4 != null)
				msgs = ((InternalEObject)newAdditionalTextMessage4).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.TRIP_INFORMATION__ADDITIONAL_TEXT_MESSAGE4, null, msgs);
			msgs = basicSetAdditionalTextMessage4(newAdditionalTextMessage4, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCommonPackage.TRIP_INFORMATION__ADDITIONAL_TEXT_MESSAGE4, newAdditionalTextMessage4, newAdditionalTextMessage4));
	}
	...
	public NotificationChain basicSetAdditionalTextMessage5(InternationalTextType newAdditionalTextMessage5, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisCommonPackage.TRIP_INFORMATION__ADDITIONAL_TEXT_MESSAGE5, oldAdditionalTextMessage5, newAdditionalTextMessage5);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setAdditionalTextMessage5(InternationalTextType newAdditionalTextMessage5) {
		if (newAdditionalTextMessage5 != additionalTextMessage5) {
			...
			if (additionalTextMessage5 != null)
				msgs = ((InternalEObject)additionalTextMessage5).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.TRIP_INFORMATION__ADDITIONAL_TEXT_MESSAGE5, null, msgs);
			if (newAdditionalTextMessage5 != null)
				msgs = ((InternalEObject)newAdditionalTextMessage5).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.TRIP_INFORMATION__ADDITIONAL_TEXT_MESSAGE5, null, msgs);
			msgs = basicSetAdditionalTextMessage5(newAdditionalTextMessage5, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCommonPackage.TRIP_INFORMATION__ADDITIONAL_TEXT_MESSAGE5, newAdditionalTextMessage5, newAdditionalTextMessage5));
	}
	...
	public NotificationChain basicSetAdditionalTextMessage6(InternationalTextType newAdditionalTextMessage6, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisCommonPackage.TRIP_INFORMATION__ADDITIONAL_TEXT_MESSAGE6, oldAdditionalTextMessage6, newAdditionalTextMessage6);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setAdditionalTextMessage6(InternationalTextType newAdditionalTextMessage6) {
		if (newAdditionalTextMessage6 != additionalTextMessage6) {
			...
			if (additionalTextMessage6 != null)
				msgs = ((InternalEObject)additionalTextMessage6).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.TRIP_INFORMATION__ADDITIONAL_TEXT_MESSAGE6, null, msgs);
			if (newAdditionalTextMessage6 != null)
				msgs = ((InternalEObject)newAdditionalTextMessage6).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.TRIP_INFORMATION__ADDITIONAL_TEXT_MESSAGE6, null, msgs);
			msgs = basicSetAdditionalTextMessage6(newAdditionalTextMessage6, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCommonPackage.TRIP_INFORMATION__ADDITIONAL_TEXT_MESSAGE6, newAdditionalTextMessage6, newAdditionalTextMessage6));
	}
	...
	public NotificationChain basicSetAdditionalTextMessage7(InternationalTextType newAdditionalTextMessage7, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisCommonPackage.TRIP_INFORMATION__ADDITIONAL_TEXT_MESSAGE7, oldAdditionalTextMessage7, newAdditionalTextMessage7);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setAdditionalTextMessage7(InternationalTextType newAdditionalTextMessage7) {
		if (newAdditionalTextMessage7 != additionalTextMessage7) {
			...
			if (additionalTextMessage7 != null)
				msgs = ((InternalEObject)additionalTextMessage7).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.TRIP_INFORMATION__ADDITIONAL_TEXT_MESSAGE7, null, msgs);
			if (newAdditionalTextMessage7 != null)
				msgs = ((InternalEObject)newAdditionalTextMessage7).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.TRIP_INFORMATION__ADDITIONAL_TEXT_MESSAGE7, null, msgs);
			msgs = basicSetAdditionalTextMessage7(newAdditionalTextMessage7, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCommonPackage.TRIP_INFORMATION__ADDITIONAL_TEXT_MESSAGE7, newAdditionalTextMessage7, newAdditionalTextMessage7));
	}
	...
	public NotificationChain basicSetAdditionalTextMessage8(InternationalTextType newAdditionalTextMessage8, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisCommonPackage.TRIP_INFORMATION__ADDITIONAL_TEXT_MESSAGE8, oldAdditionalTextMessage8, newAdditionalTextMessage8);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setAdditionalTextMessage8(InternationalTextType newAdditionalTextMessage8) {
		if (newAdditionalTextMessage8 != additionalTextMessage8) {
			...
			if (additionalTextMessage8 != null)
				msgs = ((InternalEObject)additionalTextMessage8).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.TRIP_INFORMATION__ADDITIONAL_TEXT_MESSAGE8, null, msgs);
			if (newAdditionalTextMessage8 != null)
				msgs = ((InternalEObject)newAdditionalTextMessage8).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.TRIP_INFORMATION__ADDITIONAL_TEXT_MESSAGE8, null, msgs);
			msgs = basicSetAdditionalTextMessage8(newAdditionalTextMessage8, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCommonPackage.TRIP_INFORMATION__ADDITIONAL_TEXT_MESSAGE8, newAdditionalTextMessage8, newAdditionalTextMessage8));
	}
	...
	public NotificationChain basicSetAdditionalTextMessage9(InternationalTextType newAdditionalTextMessage9, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisCommonPackage.TRIP_INFORMATION__ADDITIONAL_TEXT_MESSAGE9, oldAdditionalTextMessage9, newAdditionalTextMessage9);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setAdditionalTextMessage9(InternationalTextType newAdditionalTextMessage9) {
		if (newAdditionalTextMessage9 != additionalTextMessage9) {
			...
			if (additionalTextMessage9 != null)
				msgs = ((InternalEObject)additionalTextMessage9).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.TRIP_INFORMATION__ADDITIONAL_TEXT_MESSAGE9, null, msgs);
			if (newAdditionalTextMessage9 != null)
				msgs = ((InternalEObject)newAdditionalTextMessage9).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.TRIP_INFORMATION__ADDITIONAL_TEXT_MESSAGE9, null, msgs);
			msgs = basicSetAdditionalTextMessage9(newAdditionalTextMessage9, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCommonPackage.TRIP_INFORMATION__ADDITIONAL_TEXT_MESSAGE9, newAdditionalTextMessage9, newAdditionalTextMessage9));
	}
	...
	public EList<AdditionalAnnouncement> getAdditionalAnnouncement() {
		if (additionalAnnouncement == null) {
			additionalAnnouncement = new EObjectContainmentEList<AdditionalAnnouncement>(AdditionalAnnouncement.class, this, IbisCommonPackage.TRIP_INFORMATION__ADDITIONAL_ANNOUNCEMENT);
		}
	...
	public void setRouteDirection(RouteDirectionEnumeration newRouteDirection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCommonPackage.TRIP_INFORMATION__ROUTE_DIRECTION, oldRouteDirection, routeDirection, !oldRouteDirectionESet));
	}
	...
	public void unsetRouteDirection() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, IbisCommonPackage.TRIP_INFORMATION__ROUTE_DIRECTION, oldRouteDirection, ROUTE_DIRECTION_EDEFAULT, oldRouteDirectionESet));
	}
	...
	public NotificationChain basicSetRunNumber(IBISIPInt newRunNumber, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisCommonPackage.TRIP_INFORMATION__RUN_NUMBER, oldRunNumber, newRunNumber);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setRunNumber(IBISIPInt newRunNumber) {
		if (newRunNumber != runNumber) {
			NotificationChain msgs = null;
			if (runNumber != null)
				msgs = ((InternalEObject)runNumber).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.TRIP_INFORMATION__RUN_NUMBER, null, msgs);
			if (newRunNumber != null)
				msgs = ((InternalEObject)newRunNumber).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.TRIP_INFORMATION__RUN_NUMBER, null, msgs);
			msgs = basicSetRunNumber(newRunNumber, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCommonPackage.TRIP_INFORMATION__RUN_NUMBER, newRunNumber, newRunNumber));
	}
	...
	public NotificationChain basicSetPatternNumber(IBISIPInt newPatternNumber, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisCommonPackage.TRIP_INFORMATION__PATTERN_NUMBER, oldPatternNumber, newPatternNumber);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setPatternNumber(IBISIPInt newPatternNumber) {
		if (newPatternNumber != patternNumber) {
			...
			if (patternNumber != null)
				msgs = ((InternalEObject)patternNumber).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.TRIP_INFORMATION__PATTERN_NUMBER, null, msgs);
			if (newPatternNumber != null)
				msgs = ((InternalEObject)newPatternNumber).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.TRIP_INFORMATION__PATTERN_NUMBER, null, msgs);
			msgs = basicSetPatternNumber(newPatternNumber, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCommonPackage.TRIP_INFORMATION__PATTERN_NUMBER, newPatternNumber, newPatternNumber));
	}
	...
	public NotificationChain basicSetPathDestinationNumber(IBISIPInt newPathDestinationNumber, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisCommonPackage.TRIP_INFORMATION__PATH_DESTINATION_NUMBER, oldPathDestinationNumber, newPathDestinationNumber);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setPathDestinationNumber(IBISIPInt newPathDestinationNumber) {
		if (newPathDestinationNumber != pathDestinationNumber) {
			...
			if (pathDestinationNumber != null)
				msgs = ((InternalEObject)pathDestinationNumber).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.TRIP_INFORMATION__PATH_DESTINATION_NUMBER, null, msgs);
			if (newPathDestinationNumber != null)
				msgs = ((InternalEObject)newPathDestinationNumber).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.TRIP_INFORMATION__PATH_DESTINATION_NUMBER, null, msgs);
			msgs = basicSetPathDestinationNumber(newPathDestinationNumber, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCommonPackage.TRIP_INFORMATION__PATH_DESTINATION_NUMBER, newPathDestinationNumber, newPathDestinationNumber));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case IbisCommonPackage.TRIP_INFORMATION__TRIP_REF:
				return basicSetTripRef(null, msgs);
			case IbisCommonPackage.TRIP_INFORMATION__STOP_SEQUENCE:
				return basicSetStopSequence(null, msgs);
			case IbisCommonPackage.TRIP_INFORMATION__TIMETABLE_DELAY:
				return basicSetTimetableDelay(null, msgs);
			case IbisCommonPackage.TRIP_INFORMATION__ADDITIONAL_TEXT_MESSAGE:
				return basicSetAdditionalTextMessage(null, msgs);
			case IbisCommonPackage.TRIP_INFORMATION__ADDITIONAL_TEXT_MESSAGE1:
				return basicSetAdditionalTextMessage1(null, msgs);
			case IbisCommonPackage.TRIP_INFORMATION__ADDITIONAL_TEXT_MESSAGE2:
				return basicSetAdditionalTextMessage2(null, msgs);
			case IbisCommonPackage.TRIP_INFORMATION__ADDITIONAL_TEXT_MESSAGE3:
				return basicSetAdditionalTextMessage3(null, msgs);
			case IbisCommonPackage.TRIP_INFORMATION__ADDITIONAL_TEXT_MESSAGE4:
				return basicSetAdditionalTextMessage4(null, msgs);
			case IbisCommonPackage.TRIP_INFORMATION__ADDITIONAL_TEXT_MESSAGE5:
				return basicSetAdditionalTextMessage5(null, msgs);
			case IbisCommonPackage.TRIP_INFORMATION__ADDITIONAL_TEXT_MESSAGE6:
				return basicSetAdditionalTextMessage6(null, msgs);
			case IbisCommonPackage.TRIP_INFORMATION__ADDITIONAL_TEXT_MESSAGE7:
				return basicSetAdditionalTextMessage7(null, msgs);
			case IbisCommonPackage.TRIP_INFORMATION__ADDITIONAL_TEXT_MESSAGE8:
				return basicSetAdditionalTextMessage8(null, msgs);
			case IbisCommonPackage.TRIP_INFORMATION__ADDITIONAL_TEXT_MESSAGE9:
				return basicSetAdditionalTextMessage9(null, msgs);
			case IbisCommonPackage.TRIP_INFORMATION__ADDITIONAL_ANNOUNCEMENT:
				return ((InternalEList<?>)getAdditionalAnnouncement()).basicRemove(otherEnd, msgs);
			case IbisCommonPackage.TRIP_INFORMATION__RUN_NUMBER:
				return basicSetRunNumber(null, msgs);
			case IbisCommonPackage.TRIP_INFORMATION__PATTERN_NUMBER:
				return basicSetPatternNumber(null, msgs);
			case IbisCommonPackage.TRIP_INFORMATION__PATH_DESTINATION_NUMBER:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case IbisCommonPackage.TRIP_INFORMATION__LOCATION_STATE:
			...
			case IbisCommonPackage.TRIP_INFORMATION__ROUTE_DIRECTION:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case IbisCommonPackage.TRIP_INFORMATION__ADDITIONAL_ANNOUNCEMENT:
				...
				getAdditionalAnnouncement().addAll((Collection<? extends AdditionalAnnouncement>)newValue);
				return;
			case IbisCommonPackage.TRIP_INFORMATION__ROUTE_DIRECTION:
