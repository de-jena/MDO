...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Via Point</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.ViaPointImpl#getViaPointRef <em>Via Point Ref</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.ViaPointImpl#getPlaceRef <em>Place Ref</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.ViaPointImpl#getPlaceName <em>Place Name</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.ViaPointImpl#getPlaceShortName <em>Place Short Name</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.ViaPointImpl#getViaPointDisplayPriority <em>Via Point Display Priority</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ViaPointImpl extends MinimalEObjectImpl.Container implements ViaPoint {
	...
	public NotificationChain basicSetViaPointRef(IBISIPNMTOKEN newViaPointRef, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisCommonPackage.VIA_POINT__VIA_POINT_REF, oldViaPointRef, newViaPointRef);
	...
	public void setViaPointRef(IBISIPNMTOKEN newViaPointRef) {
		if (newViaPointRef != viaPointRef) {
			...
			if (viaPointRef != null)
				msgs = ((InternalEObject)viaPointRef).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.VIA_POINT__VIA_POINT_REF, null, msgs);
			if (newViaPointRef != null)
				msgs = ((InternalEObject)newViaPointRef).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.VIA_POINT__VIA_POINT_REF, null, msgs);
			msgs = basicSetViaPointRef(newViaPointRef, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCommonPackage.VIA_POINT__VIA_POINT_REF, newViaPointRef, newViaPointRef));
	}
	...
	public NotificationChain basicSetPlaceRef(IBISIPNMTOKEN newPlaceRef, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisCommonPackage.VIA_POINT__PLACE_REF, oldPlaceRef, newPlaceRef);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setPlaceRef(IBISIPNMTOKEN newPlaceRef) {
		if (newPlaceRef != placeRef) {
			NotificationChain msgs = null;
			if (placeRef != null)
				msgs = ((InternalEObject)placeRef).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.VIA_POINT__PLACE_REF, null, msgs);
			if (newPlaceRef != null)
				msgs = ((InternalEObject)newPlaceRef).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.VIA_POINT__PLACE_REF, null, msgs);
			msgs = basicSetPlaceRef(newPlaceRef, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCommonPackage.VIA_POINT__PLACE_REF, newPlaceRef, newPlaceRef));
	}
	...
	public EList<InternationalTextType> getPlaceName() {
		if (placeName == null) {
			placeName = new EObjectContainmentEList<InternationalTextType>(InternationalTextType.class, this, IbisCommonPackage.VIA_POINT__PLACE_NAME);
		}
		return placeName;
	}
	...
	public EList<InternationalTextType> getPlaceShortName() {
		if (placeShortName == null) {
			placeShortName = new EObjectContainmentEList<InternationalTextType>(InternationalTextType.class, this, IbisCommonPackage.VIA_POINT__PLACE_SHORT_NAME);
		}
	...
	public NotificationChain basicSetViaPointDisplayPriority(IBISIPInt newViaPointDisplayPriority, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisCommonPackage.VIA_POINT__VIA_POINT_DISPLAY_PRIORITY, oldViaPointDisplayPriority, newViaPointDisplayPriority);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setViaPointDisplayPriority(IBISIPInt newViaPointDisplayPriority) {
		if (newViaPointDisplayPriority != viaPointDisplayPriority) {
			...
			if (viaPointDisplayPriority != null)
				msgs = ((InternalEObject)viaPointDisplayPriority).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.VIA_POINT__VIA_POINT_DISPLAY_PRIORITY, null, msgs);
			if (newViaPointDisplayPriority != null)
				msgs = ((InternalEObject)newViaPointDisplayPriority).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.VIA_POINT__VIA_POINT_DISPLAY_PRIORITY, null, msgs);
			msgs = basicSetViaPointDisplayPriority(newViaPointDisplayPriority, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCommonPackage.VIA_POINT__VIA_POINT_DISPLAY_PRIORITY, newViaPointDisplayPriority, newViaPointDisplayPriority));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case IbisCommonPackage.VIA_POINT__VIA_POINT_REF:
				return basicSetViaPointRef(null, msgs);
			case IbisCommonPackage.VIA_POINT__PLACE_REF:
				return basicSetPlaceRef(null, msgs);
			case IbisCommonPackage.VIA_POINT__PLACE_NAME:
				return ((InternalEList<?>)getPlaceName()).basicRemove(otherEnd, msgs);
			case IbisCommonPackage.VIA_POINT__PLACE_SHORT_NAME:
				return ((InternalEList<?>)getPlaceShortName()).basicRemove(otherEnd, msgs);
			case IbisCommonPackage.VIA_POINT__VIA_POINT_DISPLAY_PRIORITY:
