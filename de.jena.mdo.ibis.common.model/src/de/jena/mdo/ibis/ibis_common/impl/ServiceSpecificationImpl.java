 ...
 * </p>
 * <ul>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.ServiceSpecificationImpl#getServiceName <em>Service Name</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.ServiceSpecificationImpl#getIBISIPVersion <em>IBISIP Version</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ServiceSpecificationImpl extends MinimalEObjectImpl.Container implements ServiceSpecification {
	...
	public void setServiceName(ServiceNameEnumeration newServiceName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCommonPackage.SERVICE_SPECIFICATION__SERVICE_NAME, oldServiceName, serviceName, !oldServiceNameESet));
	}
	...
	public void unsetServiceName() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, IbisCommonPackage.SERVICE_SPECIFICATION__SERVICE_NAME, oldServiceName, SERVICE_NAME_EDEFAULT, oldServiceNameESet));
	}
	...
	public NotificationChain basicSetIBISIPVersion(IBISIPNMTOKEN newIBISIPVersion, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisCommonPackage.SERVICE_SPECIFICATION__IBISIP_VERSION, oldIBISIPVersion, newIBISIPVersion);
	...
	public void setIBISIPVersion(IBISIPNMTOKEN newIBISIPVersion) {
		if (newIBISIPVersion != iBISIPVersion) {
			...
			if (iBISIPVersion != null)
				msgs = ((InternalEObject)iBISIPVersion).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.SERVICE_SPECIFICATION__IBISIP_VERSION, null, msgs);
			if (newIBISIPVersion != null)
				msgs = ((InternalEObject)newIBISIPVersion).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.SERVICE_SPECIFICATION__IBISIP_VERSION, null, msgs);
			msgs = basicSetIBISIPVersion(newIBISIPVersion, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCommonPackage.SERVICE_SPECIFICATION__IBISIP_VERSION, newIBISIPVersion, newIBISIPVersion));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case IbisCommonPackage.SERVICE_SPECIFICATION__IBISIP_VERSION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IbisCommonPackage.SERVICE_SPECIFICATION__SERVICE_NAME:
