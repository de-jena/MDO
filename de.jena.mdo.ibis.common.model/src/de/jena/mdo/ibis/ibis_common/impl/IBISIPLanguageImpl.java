...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>IBISIP Language</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.IBISIPLanguageImpl#getValue <em>Value</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.IBISIPLanguageImpl#getErrorCode <em>Error Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IBISIPLanguageImpl extends MinimalEObjectImpl.Container implements IBISIPLanguage {
	/**
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCommonPackage.IBISIP_LANGUAGE__VALUE, oldValue, value));
	}
	...
	public void setErrorCode(ErrorCodeEnumeration newErrorCode) {
		...
		errorCodeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCommonPackage.IBISIP_LANGUAGE__ERROR_CODE, oldErrorCode, errorCode, !oldErrorCodeESet));
	}
	...
	public void unsetErrorCode() {
		...
		errorCodeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, IbisCommonPackage.IBISIP_LANGUAGE__ERROR_CODE, oldErrorCode, ERROR_CODE_EDEFAULT, oldErrorCodeESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IbisCommonPackage.IBISIP_LANGUAGE__VALUE:
				return getValue();
			case IbisCommonPackage.IBISIP_LANGUAGE__ERROR_CODE:
				return getErrorCode();
		}
