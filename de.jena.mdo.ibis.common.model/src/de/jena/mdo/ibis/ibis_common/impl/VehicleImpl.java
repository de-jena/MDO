 ...
 * </p>
 * <ul>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.VehicleImpl#getVehicleTypeRef <em>Vehicle Type Ref</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.VehicleImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VehicleImpl extends MinimalEObjectImpl.Container implements Vehicle {
	...
	public NotificationChain basicSetVehicleTypeRef(IBISIPNMTOKEN newVehicleTypeRef, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisCommonPackage.VEHICLE__VEHICLE_TYPE_REF, oldVehicleTypeRef, newVehicleTypeRef);
	...
	public void setVehicleTypeRef(IBISIPNMTOKEN newVehicleTypeRef) {
		if (newVehicleTypeRef != vehicleTypeRef) {
			...
			if (vehicleTypeRef != null)
				msgs = ((InternalEObject)vehicleTypeRef).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.VEHICLE__VEHICLE_TYPE_REF, null, msgs);
			if (newVehicleTypeRef != null)
				msgs = ((InternalEObject)newVehicleTypeRef).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.VEHICLE__VEHICLE_TYPE_REF, null, msgs);
			msgs = basicSetVehicleTypeRef(newVehicleTypeRef, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCommonPackage.VEHICLE__VEHICLE_TYPE_REF, newVehicleTypeRef, newVehicleTypeRef));
	}
	...
	public EList<InternationalTextType> getName() {
		if (name == null) {
			name = new EObjectContainmentEList<InternationalTextType>(InternationalTextType.class, this, IbisCommonPackage.VEHICLE__NAME);
		}
		return name;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case IbisCommonPackage.VEHICLE__VEHICLE_TYPE_REF:
				return basicSetVehicleTypeRef(null, msgs);
			case IbisCommonPackage.VEHICLE__NAME:
