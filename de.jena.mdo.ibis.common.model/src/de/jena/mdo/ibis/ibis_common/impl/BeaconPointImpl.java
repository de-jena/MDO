...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Beacon Point</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.BeaconPointImpl#getPointRef <em>Point Ref</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.BeaconPointImpl#getBeaconCode <em>Beacon Code</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.BeaconPointImpl#getShortName <em>Short Name</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.BeaconPointImpl#getDesciption <em>Desciption</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BeaconPointImpl extends MinimalEObjectImpl.Container implements BeaconPoint {
	/**
	...
	protected EClass eStaticClass() {
		return IbisCommonPackage.Literals.BEACON_POINT;
	}
	...
	public NotificationChain basicSetPointRef(IBISIPNMTOKEN newPointRef, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisCommonPackage.BEACON_POINT__POINT_REF, oldPointRef, newPointRef);
	...
	public void setPointRef(IBISIPNMTOKEN newPointRef) {
		if (newPointRef != pointRef) {
			...
			if (pointRef != null)
				msgs = ((InternalEObject)pointRef).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.BEACON_POINT__POINT_REF, null, msgs);
			if (newPointRef != null)
				msgs = ((InternalEObject)newPointRef).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.BEACON_POINT__POINT_REF, null, msgs);
			msgs = basicSetPointRef(newPointRef, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCommonPackage.BEACON_POINT__POINT_REF, newPointRef, newPointRef));
	}
	...
	public NotificationChain basicSetBeaconCode(IBISIPNMTOKEN newBeaconCode, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisCommonPackage.BEACON_POINT__BEACON_CODE, oldBeaconCode, newBeaconCode);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setBeaconCode(IBISIPNMTOKEN newBeaconCode) {
		if (newBeaconCode != beaconCode) {
			NotificationChain msgs = null;
			if (beaconCode != null)
				msgs = ((InternalEObject)beaconCode).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.BEACON_POINT__BEACON_CODE, null, msgs);
			if (newBeaconCode != null)
				msgs = ((InternalEObject)newBeaconCode).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.BEACON_POINT__BEACON_CODE, null, msgs);
			msgs = basicSetBeaconCode(newBeaconCode, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCommonPackage.BEACON_POINT__BEACON_CODE, newBeaconCode, newBeaconCode));
	}
	...
	public EList<InternationalTextType> getShortName() {
		if (shortName == null) {
			shortName = new EObjectContainmentEList<InternationalTextType>(InternationalTextType.class, this, IbisCommonPackage.BEACON_POINT__SHORT_NAME);
		}
		return shortName;
	}
	...
	public EList<InternationalTextType> getDesciption() {
		if (desciption == null) {
			desciption = new EObjectContainmentEList<InternationalTextType>(InternationalTextType.class, this, IbisCommonPackage.BEACON_POINT__DESCIPTION);
		}
		return desciption;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case IbisCommonPackage.BEACON_POINT__POINT_REF:
				return basicSetPointRef(null, msgs);
			case IbisCommonPackage.BEACON_POINT__BEACON_CODE:
				return basicSetBeaconCode(null, msgs);
			case IbisCommonPackage.BEACON_POINT__SHORT_NAME:
				return ((InternalEList<?>)getShortName()).basicRemove(otherEnd, msgs);
			case IbisCommonPackage.BEACON_POINT__DESCIPTION:
