...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Device Specification</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.DeviceSpecificationImpl#getDeviceClass <em>Device Class</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.DeviceSpecificationImpl#getDeviceID <em>Device ID</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DeviceSpecificationImpl extends MinimalEObjectImpl.Container implements DeviceSpecification {
	 ...
	 * @generated
	 */
	protected DeviceSpecificationImpl() {
		super();
	}
	...
	public void setDeviceClass(DeviceClassEnumeration newDeviceClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCommonPackage.DEVICE_SPECIFICATION__DEVICE_CLASS, oldDeviceClass, deviceClass, !oldDeviceClassESet));
	}
	...
	public void unsetDeviceClass() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, IbisCommonPackage.DEVICE_SPECIFICATION__DEVICE_CLASS, oldDeviceClass, DEVICE_CLASS_EDEFAULT, oldDeviceClassESet));
	}
	...
	public NotificationChain basicSetDeviceID(IBISIPNMTOKEN newDeviceID, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisCommonPackage.DEVICE_SPECIFICATION__DEVICE_ID, oldDeviceID, newDeviceID);
	...
	public void setDeviceID(IBISIPNMTOKEN newDeviceID) {
		if (newDeviceID != deviceID) {
			...
			if (deviceID != null)
				msgs = ((InternalEObject)deviceID).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.DEVICE_SPECIFICATION__DEVICE_ID, null, msgs);
			if (newDeviceID != null)
				msgs = ((InternalEObject)newDeviceID).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.DEVICE_SPECIFICATION__DEVICE_ID, null, msgs);
			msgs = basicSetDeviceID(newDeviceID, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCommonPackage.DEVICE_SPECIFICATION__DEVICE_ID, newDeviceID, newDeviceID));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case IbisCommonPackage.DEVICE_SPECIFICATION__DEVICE_ID:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IbisCommonPackage.DEVICE_SPECIFICATION__DEVICE_CLASS:
