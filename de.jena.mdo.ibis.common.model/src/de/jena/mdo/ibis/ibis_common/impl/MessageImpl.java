 ...
 * </p>
 * <ul>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.MessageImpl#getMessageID <em>Message ID</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.MessageImpl#getTimeStamp <em>Time Stamp</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.MessageImpl#getMessageType <em>Message Type</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.impl.MessageImpl#getMessageText <em>Message Text</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MessageImpl extends MinimalEObjectImpl.Container implements Message {
	...
	protected EClass eStaticClass() {
		return IbisCommonPackage.Literals.MESSAGE;
	}
	...
	public NotificationChain basicSetMessageID(IBISIPInt newMessageID, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisCommonPackage.MESSAGE__MESSAGE_ID, oldMessageID, newMessageID);
	...
	public void setMessageID(IBISIPInt newMessageID) {
		if (newMessageID != messageID) {
			...
			if (messageID != null)
				msgs = ((InternalEObject)messageID).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.MESSAGE__MESSAGE_ID, null, msgs);
			if (newMessageID != null)
				msgs = ((InternalEObject)newMessageID).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.MESSAGE__MESSAGE_ID, null, msgs);
			msgs = basicSetMessageID(newMessageID, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCommonPackage.MESSAGE__MESSAGE_ID, newMessageID, newMessageID));
	}
	...
	public NotificationChain basicSetTimeStamp(IBISIPDateTime newTimeStamp, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisCommonPackage.MESSAGE__TIME_STAMP, oldTimeStamp, newTimeStamp);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTimeStamp(IBISIPDateTime newTimeStamp) {
		if (newTimeStamp != timeStamp) {
			NotificationChain msgs = null;
			if (timeStamp != null)
				msgs = ((InternalEObject)timeStamp).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.MESSAGE__TIME_STAMP, null, msgs);
			if (newTimeStamp != null)
				msgs = ((InternalEObject)newTimeStamp).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.MESSAGE__TIME_STAMP, null, msgs);
			msgs = basicSetTimeStamp(newTimeStamp, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCommonPackage.MESSAGE__TIME_STAMP, newTimeStamp, newTimeStamp));
	}
	...
	public void setMessageType(MessageTypeEnumeration newMessageType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCommonPackage.MESSAGE__MESSAGE_TYPE, oldMessageType, messageType, !oldMessageTypeESet));
	}
	...
	public void unsetMessageType() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, IbisCommonPackage.MESSAGE__MESSAGE_TYPE, oldMessageType, MESSAGE_TYPE_EDEFAULT, oldMessageTypeESet));
	}
	...
	public NotificationChain basicSetMessageText(IBISIPString newMessageText, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IbisCommonPackage.MESSAGE__MESSAGE_TEXT, oldMessageText, newMessageText);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setMessageText(IBISIPString newMessageText) {
		if (newMessageText != messageText) {
			NotificationChain msgs = null;
			if (messageText != null)
				msgs = ((InternalEObject)messageText).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.MESSAGE__MESSAGE_TEXT, null, msgs);
			if (newMessageText != null)
				msgs = ((InternalEObject)newMessageText).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IbisCommonPackage.MESSAGE__MESSAGE_TEXT, null, msgs);
			msgs = basicSetMessageText(newMessageText, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisCommonPackage.MESSAGE__MESSAGE_TEXT, newMessageText, newMessageText));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case IbisCommonPackage.MESSAGE__MESSAGE_ID:
				return basicSetMessageID(null, msgs);
			case IbisCommonPackage.MESSAGE__TIME_STAMP:
				return basicSetTimeStamp(null, msgs);
			case IbisCommonPackage.MESSAGE__MESSAGE_TEXT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case IbisCommonPackage.MESSAGE__TIME_STAMP:
				return getTimeStamp();
			case IbisCommonPackage.MESSAGE__MESSAGE_TYPE:
