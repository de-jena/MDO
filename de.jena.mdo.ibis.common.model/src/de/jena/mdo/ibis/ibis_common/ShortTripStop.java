...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Short Trip Stop</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 ...
 * </p>
 * <ul>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.ShortTripStop#getJourneyStopInformation <em>Journey Stop Information</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.ShortTripStop#getFareZoneInformation <em>Fare Zone Information</em>}</li>
 * </ul>
 *
 * @see de.jena.mdo.ibis.ibis_common.IbisCommonPackage#getShortTripStop()
 * @model extendedMetaData="name='ShortTripStopStructure' kind='elementOnly'"
 * @generated
 */
@ProviderType
public interface ShortTripStop extends EObject {
	/**
	 ...
	 * @see de.jena.mdo.ibis.ibis_common.IbisCommonPackage#getShortTripStop_JourneyStopInformation()
	...
	/**
	 * Sets the value of the '{@link de.jena.mdo.ibis.ibis_common.ShortTripStop#getJourneyStopInformation <em>Journey Stop Information</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.jena.mdo.ibis.ibis_common.IbisCommonPackage#getShortTripStop_FareZoneInformation()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link de.jena.mdo.ibis.ibis_common.ShortTripStop#getFareZoneInformation <em>Fare Zone Information</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
