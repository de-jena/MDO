...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Subscribe Request</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 ...
 * </p>
 * <ul>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.SubscribeRequest#getClientIPAddress <em>Client IP Address</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.SubscribeRequest#getReplyPort <em>Reply Port</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.SubscribeRequest#getReplyPath <em>Reply Path</em>}</li>
 * </ul>
 *
 * @see de.jena.mdo.ibis.ibis_common.IbisCommonPackage#getSubscribeRequest()
 * @model extendedMetaData="name='SubscribeRequestStructure' kind='elementOnly'"
 * @generated
 */
@ProviderType
public interface SubscribeRequest extends EObject {
	/**
	 ...
	 * @see de.jena.mdo.ibis.ibis_common.IbisCommonPackage#getSubscribeRequest_ClientIPAddress()
	...
	/**
	 * Sets the value of the '{@link de.jena.mdo.ibis.ibis_common.SubscribeRequest#getClientIPAddress <em>Client IP Address</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.jena.mdo.ibis.ibis_common.IbisCommonPackage#getSubscribeRequest_ReplyPort()
	...
	/**
	 * Sets the value of the '{@link de.jena.mdo.ibis.ibis_common.SubscribeRequest#getReplyPort <em>Reply Port</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.jena.mdo.ibis.ibis_common.IbisCommonPackage#getSubscribeRequest_ReplyPath()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link de.jena.mdo.ibis.ibis_common.SubscribeRequest#getReplyPath <em>Reply Path</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
