...
public class IbisCommonEPackageConfigurator implements EPackageConfigurator {
	...
	protected IbisCommonEPackageConfigurator(IbisCommonPackage ePackage){
	...
	public void configureEPackage(org.eclipse.emf.ecore.EPackage.Registry registry) {
		registry.put(IbisCommonPackage.eNS_URI, ePackage);
	}
	...
	public Map<String, Object> getServiceProperties() {
		...
		properties.put(EMFNamespaces.EMF_MODEL_NSURI, IbisCommonPackage.eNS_URI);
		properties.put(EMFNamespaces.EMF_MODEL_FILE_EXT, "ibiscommon");
