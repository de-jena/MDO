...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Trip Sequence</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 ...
 * </p>
 * <ul>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.TripSequence#getTripRef <em>Trip Ref</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.TripSequence#getTripIndex <em>Trip Index</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.TripSequence#getTripStart <em>Trip Start</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.TripSequence#getCurrentStopIndex <em>Current Stop Index</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.TripSequence#getJourneyMode <em>Journey Mode</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.TripSequence#getPointSequence <em>Point Sequence</em>}</li>
 * </ul>
 *
 * @see de.jena.mdo.ibis.ibis_common.IbisCommonPackage#getTripSequence()
...
public interface TripSequence extends EObject {
	 ...
	 * @see de.jena.mdo.ibis.ibis_common.IbisCommonPackage#getTripSequence_TripRef()
	...
	/**
	 * Sets the value of the '{@link de.jena.mdo.ibis.ibis_common.TripSequence#getTripRef <em>Trip Ref</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.jena.mdo.ibis.ibis_common.IbisCommonPackage#getTripSequence_TripIndex()
	...
	/**
	 * Sets the value of the '{@link de.jena.mdo.ibis.ibis_common.TripSequence#getTripIndex <em>Trip Index</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.jena.mdo.ibis.ibis_common.IbisCommonPackage#getTripSequence_TripStart()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link de.jena.mdo.ibis.ibis_common.TripSequence#getTripStart <em>Trip Start</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.jena.mdo.ibis.ibis_common.IbisCommonPackage#getTripSequence_CurrentStopIndex()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link de.jena.mdo.ibis.ibis_common.TripSequence#getCurrentStopIndex <em>Current Stop Index</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The literals are from the enumeration {@link de.jena.mdo.ibis.ibis_enumerations.JourneyModeEnumeration}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.jena.mdo.ibis.ibis_common.IbisCommonPackage#getTripSequence_JourneyMode()
	...
	/**
	 * Sets the value of the '{@link de.jena.mdo.ibis.ibis_common.TripSequence#getJourneyMode <em>Journey Mode</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link de.jena.mdo.ibis.ibis_common.TripSequence#getJourneyMode <em>Journey Mode</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetJourneyMode()
	 * @see #getJourneyMode()
	...
	/**
	 * Returns whether the value of the '{@link de.jena.mdo.ibis.ibis_common.TripSequence#getJourneyMode <em>Journey Mode</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setPointSequence(PointSequence)
	 * @see de.jena.mdo.ibis.ibis_common.IbisCommonPackage#getTripSequence_PointSequence()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link de.jena.mdo.ibis.ibis_common.TripSequence#getPointSequence <em>Point Sequence</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	void setPointSequence(PointSequence value);
