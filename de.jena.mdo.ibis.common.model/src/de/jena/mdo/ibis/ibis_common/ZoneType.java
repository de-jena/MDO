 ...
 * </p>
 * <ul>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.ZoneType#getFarezoneTypeID <em>Farezone Type ID</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.ZoneType#getFareZoneTypeName <em>Fare Zone Type Name</em>}</li>
 * </ul>
 *
 * @see de.jena.mdo.ibis.ibis_common.IbisCommonPackage#getZoneType()
...
public interface ZoneType extends EObject {
	 ...
	 * @see de.jena.mdo.ibis.ibis_common.IbisCommonPackage#getZoneType_FarezoneTypeID()
	...
	/**
	 * Sets the value of the '{@link de.jena.mdo.ibis.ibis_common.ZoneType#getFarezoneTypeID <em>Farezone Type ID</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.jena.mdo.ibis.ibis_common.IbisCommonPackage#getZoneType_FareZoneTypeName()
