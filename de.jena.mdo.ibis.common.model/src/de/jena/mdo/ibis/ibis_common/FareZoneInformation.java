...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Fare Zone Information</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 ...
 * </p>
 * <ul>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.FareZoneInformation#getFareZoneID <em>Fare Zone ID</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.FareZoneInformation#getFareZoneType <em>Fare Zone Type</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.FareZoneInformation#getFareZoneLongName <em>Fare Zone Long Name</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.FareZoneInformation#getFareZoneShortName <em>Fare Zone Short Name</em>}</li>
 * </ul>
 *
 * @see de.jena.mdo.ibis.ibis_common.IbisCommonPackage#getFareZoneInformation()
 * @model extendedMetaData="name='FareZoneInformationStructure' kind='elementOnly'"
 * @generated
 */
@ProviderType
public interface FareZoneInformation extends EObject {
	/**
	 ...
	 * @see de.jena.mdo.ibis.ibis_common.IbisCommonPackage#getFareZoneInformation_FareZoneID()
	...
	/**
	 * Sets the value of the '{@link de.jena.mdo.ibis.ibis_common.FareZoneInformation#getFareZoneID <em>Fare Zone ID</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.jena.mdo.ibis.ibis_common.IbisCommonPackage#getFareZoneInformation_FareZoneType()
	...
	/**
	 * Sets the value of the '{@link de.jena.mdo.ibis.ibis_common.FareZoneInformation#getFareZoneType <em>Fare Zone Type</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.jena.mdo.ibis.ibis_common.IbisCommonPackage#getFareZoneInformation_FareZoneLongName()
	 * @model containment="true"
	 ...
	 * @see de.jena.mdo.ibis.ibis_common.IbisCommonPackage#getFareZoneInformation_FareZoneShortName()
	 * @model containment="true"
