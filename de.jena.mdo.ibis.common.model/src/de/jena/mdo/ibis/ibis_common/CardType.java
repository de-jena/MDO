 ...
 * </p>
 * <ul>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.CardType#getCardSerialNumber <em>Card Serial Number</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.CardType#getCardTypeID <em>Card Type ID</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_common.CardType#getCardTypeText <em>Card Type Text</em>}</li>
 * </ul>
 *
 * @see de.jena.mdo.ibis.ibis_common.IbisCommonPackage#getCardType()
...
public interface CardType extends EObject {
	 ...
	 * @see de.jena.mdo.ibis.ibis_common.IbisCommonPackage#getCardType_CardSerialNumber()
	...
	/**
	 * Sets the value of the '{@link de.jena.mdo.ibis.ibis_common.CardType#getCardSerialNumber <em>Card Serial Number</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.jena.mdo.ibis.ibis_common.IbisCommonPackage#getCardType_CardTypeID()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link de.jena.mdo.ibis.ibis_common.CardType#getCardTypeID <em>Card Type ID</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.jena.mdo.ibis.ibis_common.IbisCommonPackage#getCardType_CardTypeText()
