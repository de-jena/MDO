...
import de.jena.mdo.ibis.ibis_enumerations.DocumentRoot;
 ...
 * </p>
 * <ul>
 *   <li>{@link de.jena.mdo.ibis.ibis_enumerations.impl.DocumentRootImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_enumerations.impl.DocumentRootImpl#getXMLNSPrefixMap <em>XMLNS Prefix Map</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_enumerations.impl.DocumentRootImpl#getXSISchemaLocation <em>XSI Schema Location</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_enumerations.impl.DocumentRootImpl#getAirSubmode <em>Air Submode</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_enumerations.impl.DocumentRootImpl#getBusSubmode <em>Bus Submode</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_enumerations.impl.DocumentRootImpl#getCoachSubmode <em>Coach Submode</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_enumerations.impl.DocumentRootImpl#getFunicularSubmode <em>Funicular Submode</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_enumerations.impl.DocumentRootImpl#getMetroSubmode <em>Metro Submode</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_enumerations.impl.DocumentRootImpl#getRailSubmode <em>Rail Submode</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_enumerations.impl.DocumentRootImpl#getSelfDriveSubmode <em>Self Drive Submode</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_enumerations.impl.DocumentRootImpl#getTaxiSubmode <em>Taxi Submode</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_enumerations.impl.DocumentRootImpl#getTelecabinSubmode <em>Telecabin Submode</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_enumerations.impl.DocumentRootImpl#getTramSubmode <em>Tram Submode</em>}</li>
 *   <li>{@link de.jena.mdo.ibis.ibis_enumerations.impl.DocumentRootImpl#getWaterSubmode <em>Water Submode</em>}</li>
 * </ul>
 *
 * @generated
 */
