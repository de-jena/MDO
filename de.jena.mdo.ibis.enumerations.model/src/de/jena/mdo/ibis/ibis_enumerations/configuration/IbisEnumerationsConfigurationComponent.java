/*
 */
package de.jena.mdo.ibis.ibis_enumerations.configuration;
...
import de.jena.mdo.ibis.ibis_enumerations.impl.IbisEnumerationsPackageImpl;
...
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"de.jena.mdo.ibis.ibis_enumerations.IbisEnumerationsFactory, org.eclipse.emf.ecore.EFactory\"" , "uses:=org.eclipse.emf.ecore,de.jena.mdo.ibis.ibis_enumerations" })
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"de.jena.mdo.ibis.ibis_enumerations.IbisEnumerationsPackage, org.eclipse.emf.ecore.EPackage\"" , "uses:=org.eclipse.emf.ecore,de.jena.mdo.ibis.ibis_enumerations" })
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.gecko.emf.osgi.EPackageConfigurator\"" , "uses:=org.eclipse.emf.ecore,de.jena.mdo.ibis.ibis_enumerations" })
