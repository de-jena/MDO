...
@Component(service = DetectorUTMToDegreeBlackbox.class, immediate=true, 
	property = {ModelTransformationConstants.QVT_BLACKBOX + "=true", ModelTransformationConstants.BLACKBOX_MODULENAME + "=DetectorUTMToDegBB", ModelTransformationConstants.BLACKBOX_QUALIFIED_UNIT_NAME + "=de.mdo.jena.geo.DetectorUTMToDegBB"})
