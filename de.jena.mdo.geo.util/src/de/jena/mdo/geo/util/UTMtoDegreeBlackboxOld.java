 ...
 * @since 24.11.2022
 */
//@Component(service = UTMtoDegreeBlackboxOld.class, immediate=true, 
//  property = {ModelTransformationConstants.QVT_BLACKBOX + "=true", 
//		  ModelTransformationConstants.BLACKBOX_MODULENAME + "=UTMToDegBB", 
//		  ModelTransformationConstants.BLACKBOX_QUALIFIED_UNIT_NAME + "=de.mdo.jena.geo.UTMToDegBB"})
//@Module(packageURIs={DbtreePackage.eNS_URI})
public class UTMtoDegreeBlackboxOld {
